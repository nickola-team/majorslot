				                ...
				                <div class="form-group table-responsive">
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:3px;"><input type="text" name="sports_deal_percent" id="sports_deal_percent" class="form-control" value="{{$user->sports_deal_percent??0}}" {{$user->id==auth()->user()->id?'disabled':''}}></td>
