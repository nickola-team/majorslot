            ...
            <ul class="navbar-nav">
                <!-- <li class="nav-item">
                    <a class="nav-link" href="{{ route('home') }}">
                        <i class="ni ni-tv-2 text-primary"></i> <span class="nav-link-text text-blue">{{ __('Dashboard') }}</span>
                    </a>
                </li> -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#navbar-examples1" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples1">
                        ...
                        <span class="nav-link-text text-blue">{{ __(\App\Models\User::ROLE_NAMES[auth()->user()->role_id]) }}</span>
                    </a>

                    <div class="collapse show" id="navbar-examples1">
                        <ul class="nav nav-sm flex-column">
                      
                            @for ($role=\App\Models\User::ROLE_ADMIN-1;$role>=\App\Models\User::ROLE_OPERATOR;$role--)
                                @if (auth()->user()->role_id > $role)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('partners.list', $role) }}">
                                        {{ __(\App\Models\User::ROLE_NAMES[$role]) }}
                                    </a>
                                </li>
                                @endif
                            @endfor
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('partners.history') }}">
                                    {{ __('Transfer History') }}
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="navbar-examples2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('players.list') }}">
                                    {{ __('Player List') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('players.gamestat') }}">
                                    {{ __('Game History') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('players.history') }}">
                                    {{ __('Balance Transfer') }}
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="navbar-examples3">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('summary.daily') }}">
                                    {{ __('Daily Summary') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('summary.rate') }}">
                                    {{ __('Rate Summary') }}
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('api.doc') }}">
