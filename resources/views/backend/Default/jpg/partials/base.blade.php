<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="@lang('app.name')" required value="{{ $edit ? $jackpot->name : '' }}" disabled >
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        <label>당첨금액(VT)</label>
        <input type="text" class="form-control" id="pay_sum_new" name="pay_sum_new" placeholder="@lang('app.pay_sum')" required value="{{ $edit ? $jackpot->pay_sum_new : '' }}">
    </div>
</div>
