                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($users))
                            @foreach ($users as $user)
                                @include('backend.Default.user.partials.row', ['show_shop' => true])
                            @endforeach
                        @else
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($pay_stats))
                            @foreach ($pay_stats as $stat)
                                @include('backend.Default.stat.partials.row_stat', ['show_shop' => true])
                            @endforeach
                        @else
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($game_stats))
                            @foreach ($game_stats as $stat)
                                @include('backend.Default.games.partials.row_stat', ['show_shop' => true])
                            @endforeach
                        @else
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($bank_stats))
                            @foreach ($bank_stats as $stat)
                                @include('backend.Default.stat.partials.row_bank_stat', ['show_shop' => true])
                            @endforeach
                        @else
                            <tr><td colspan="7">@lang('app.no_data')</td></tr>
                        @endif
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($shop_stats))
                            @foreach ($shop_stats as $stat)
                                @include('backend.Default.stat.partials.row_shop_stat', ['show_shop' => true])
                            @endforeach
                        @else
                            <tr><td colspan="5">@lang('app.no_data')</td></tr>
                        @endif
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @if (count($shift_stats))
                            @foreach ($shift_stats as $num=>$stat)
                                @include('backend.Default.stat.partials.row_shift_stat', ['show_shop' => true])
                            @endforeach
                        @else
