...
<head>
    ...
    <link rel="icon" href="/back/img/1.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="/back/dist/css/skins/_all-skins.css">
...
<body class="hold-transition skin-purple sidebar-mini @if(isset($_COOKIE['sidebar-collapse']) && $_COOKIE['sidebar-collapse'] == 'true') sidebar-collapse @endif">
<div class="wrapper">

    @include('backend.Default.partials.Left.navbar')
    @include('backend.Default.partials.Left.sidebar')
