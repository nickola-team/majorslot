...
<head>
	...
	<script type="text/javascript" src="/frontend/lotto/js/jquery-1.12.3.min.js"></script>
	<script type="text/javascript" src="/frontend/lotto/js/jquery-ui.js"></script>
	<script type="text/javascript" src="/frontend/lotto/js/TINYbox.js"></script>
	<script type="text/javascript" src="/frontend/lotto/js/jquery.vticker.min.js"></script>
	<script type="text/javascript" src="/frontend/lotto/js/jquery.bxslider.min.js"></script>

	<link rel="stylesheet" type="text/css" href="/frontend/lotto/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="/frontend/lotto/css/main.css?ver=6038" />
	<link rel="stylesheet" type="text/css" href="/frontend/lotto/css/all.css">
	<link rel="stylesheet" type="text/css" href="/frontend/lotto/css/Style_sub.css" />

    <script type="text/javascript" src="/frontend/lotto/count/jquery.counter.js"></script>

	<script type='text/javascript' src="/frontend/lotto/js/game.js?ver=5210"></script>
	<script type='text/javascript' src='/frontend/lotto/js/menu.js?ver=3007'></script>
	<script type='text/javascript' src='/frontend/lotto/js/main.js?ver=6959'></script>
	<script type='text/javascript' src='/frontend/lotto/js/fund.js?ver=5645'></script>
	<script type='text/javascript' src='/frontend/lotto/js/common.js?ver=7896'></script>
...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/lotto/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/lotto/img/logo.png?5"/></div>
		<font>Copyright® 로또 CASINO. ALL RIGHT RESERVED</font>
	</footer>
