...
<head>
    ...
    <link rel="manifest" href="/cq9history/manifest.json" />
    <link rel="icon" href="/cq9history/define.png" >
    <style>
        a,
        abbr,
        acronym,
    ...
    <title>Player Betting Research</title>
</head>

<body><noscript id="BODY_GA_NO_SCRIPT"></noscript>
    <div id="root"></div>
    <script>
        ! function (e) {
            function r(r) {
            ...
            var i = this.webpackJsonpmegalon = this.webpackJsonpmegalon || [],
                c = i.push.bind(i);
            i.push = r, i = i.slice();
