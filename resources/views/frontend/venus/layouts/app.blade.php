...
<div class="wrapper">
  ...
  <div class="nav-main">
		<div class="center">
			<a href="{{url('/')}}" class="gs-logo">
				<div class="container">
					<img src="/frontend/venus/img/logo.png">
				</div>
			</a>
  ...
  <div class="banner-main" style="background-image: url(/frontend/venus/img/banner/banner-bg.jpg) !important;">
  ...
  <div class="page-content">
    ...
    <div style="margin-top:25px;height:50px;">
      <span class="a_style">비너스 GAMES</span>
    </div>
  ...
  <div class="footer-main">
    ...
    <div class="copyright-cont">
        <span>ⓒ COPYRIGHT  비너스  2022~2023 ALL RIGHTS RESERVED</span>
    </div>
	</div>
