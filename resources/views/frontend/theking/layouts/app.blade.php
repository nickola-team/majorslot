...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/theking/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/theking/img/logo.png?5"/></div>
		<font>Copyright&copy; TheKing. ALL RIGHT RESERVED</font>
	</footer>
