@extends('frontend.theking.layouts.app')
...
<div class="main_slide" style="height : 450px !important;">
	<div class="video_bg" style="height : 450px !important;">
		<video loop autoplay muted preload="auto" id="login_video_b">
			<source src="/frontend/thezone/img/bg_movie2.mov" type="video/mp4">
			Your browser does not support the video tag.
		</video>
	</div>
	<div class="slide_wrap" style="height : 450px !important;">
		<div class="slider">
			<ul class="bxslider">
				<li><img src="/frontend/punch/img/slide_img0.png?5" /></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="main_game">
	...
	<div class="main_board">
		<ul>
			<li class="cs_center">
				<dl>
					<dd class="txt"> 고객센터 안내<span>언제 어디서나 무엇이든 물어보세요!</span></dd>
