...
<head>
		...
		<link rel="shortcut icon" href="/frontend/kingsl/images/favicon/favicon.html" type="image/x-icon">

		<link rel="stylesheet" type="text/css" href="/frontend/kingsl/tutu/css/common.css">
		<link rel="stylesheet" type="text/css" href="/frontend/kingsl/tutu/css/basic.css">
		<link rel="stylesheet" type="text/css" href="/frontend/kingsl/tutu/css/layoutb04c.css?v=31234">
		<link rel="stylesheet" type="text/css" href="/frontend/kingsl/tutu/css/animations.css">
		<link rel="stylesheet" type="text/css" href="/frontend/kingsl/css/odometer-theme-default.css">

		<script type="text/javascript" src="/frontend/kingsl/tutu/js/showid.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/jquery-1.8.3.min.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/tutu/jq/sk_popup/sk_popup.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/tutu/js/sk_tab.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/sweetalert.min.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/ajax_utf_8.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/playd7cf.js?v=xxx1.2"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/swiper.min.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/script3860.js?v=1"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/paging.min.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/jsRolling.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/numeric.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/odometer.min.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/js/action.js"></script>
		<script type="text/javascript" src="/frontend/kingsl/tutu/jq/common/common.js"></script><!-- script -->
	</head>
	...
	<script type="text/javascript">
		...
		function toggleRealtime(e) {
			if(e == 'deposit'){
				...
				$("#dp_list_btn").attr("src", "/frontend/kingsl/images/main_con3_1_title_on.html");
				$("#wd_list_btn").attr("src", "/frontend/kingsl/images/main_con3_2_title.html");
				...
				$("#dp_list_btn").attr("src", "/frontend/kingsl/images/main_con3_1_title.html");
				$("#wd_list_btn").attr("src", "/frontend/kingsl/images/main_con3_2_title_on.html");
	...
	<body class="overflow-x:hidden;" style="background-color: #0967c4">
		...
		<div id="casino_1" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="casino_1_close"><img src="/frontend/kingsl/tutu/images/popup_close.png"></a></div>
		...
		<div id="sub_pop1" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="sub_pop1_close"><img src="/frontend/kingsl/tutu/images/popup_close.png"></a></div>
				<div class="popupbox">
		...
		<div id="sub_pop2" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="sub_pop2_close"><img src="/frontend/kingsl/tutu/images/popup_close.png"></a></div>
				<div class="popupbox">            
					<div class="popup_tab_wrap">
		...
		<div id="wrap">
			<div id="header_wrap">
				<div class="header_box">
					<div class="logo">
						<a href="/"><img src="/frontend/kingsl/tutu/images/logoae52.png?v=5" style="width:250px;"></a>
					</div>
					<div class="gnb">						
						
						<ul>
						@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
							<li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab1','charge');" data-popup-ordinal="0" id="open_34483963"><img src="/frontend/kingsl/tutu/images/gnb1.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb1over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab2','excharge');" data-popup-ordinal="1" id="open_80823455"><img src="/frontend/kingsl/tutu/images/gnb2.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb2over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab3','inoutList');" data-popup-ordinal="2" id="open_9185439"><img src="/frontend/kingsl/tutu/images/gnb11.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb11over.png" style="display: none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab4','letterList');" data-popup-ordinal="3" id="open_59824731"><img src="/frontend/kingsl/tutu/images/gnb9.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb9over.png" style="display: none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab5','chatList');" data-popup-ordinal="4" id="open_81567995"><img src="/frontend/kingsl/tutu/images/gnb8.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb8over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab6','noticeList');" data-popup-ordinal="5" id="open_37017382"><img src="/frontend/kingsl/tutu/images/gnb7.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/gnb7over.png" style="display: none;" class="mouseover3"></a></li>
							
						@else							
							<li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb1.png"><img src="/frontend/kingsl/tutu/images/gnb1over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb2.png"><img src="/frontend/kingsl/tutu/images/gnb2over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb11.png"><img src="/frontend/kingsl/tutu/images/gnb11over.png" style="display:none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb9.png"><img src="/frontend/kingsl/tutu/images/gnb9over.png" style="display:none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb8.png"><img src="/frontend/kingsl/tutu/images/gnb8over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/gnb7.png"><img src="/frontend/kingsl/tutu/images/gnb7over.png" style="display:none;" class="mouseover3"></a></li>
						@endif
						</ul>
			...
			<div class="login_wrap">
				...
				@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
					<ul>
                        ...
                        <li style="color:#222"><img src="/frontend/kingsl/tutu/images/5UNZI____.png" width="20">&nbsp;{{ Auth::user()->username }}님 환영합니다.</li>
                        <li style="color:#222"><img src="/frontend/kingsl/tutu/images/coin.png" width="20">&nbsp;&nbsp;<span id="lnOwnMoney">{{ number_format(Auth::user()->balance) }}</span> 원</li>
			...
			<!-- ▼slideshow6▼ -->
			<script src="/frontend/kingsl/tutu/jq/slideshow6/flux.js" type="text/javascript" charset="utf-8"></script>
			...
			<div style="position:relative; height:660px; overflow:hidden; clear:both;">
				<div style="position:absolute; width:1920px; left:50%; margin-left:-960px;">   
					<div id="slider">
												<img src="/frontend/kingsl/tutu/images/slideshow1.jpg">
																	</div>
				</div>
			</div>
			<!-- ▲slideshow6▲ -->
			<script type="text/javascript" src="/frontend/kingsl/tutu/js/sk_table.js"></script><!-- sk_실시간입출금현황 롤링 -->
			...
			<div class="main_game_wrap">
				<div class="main_game_box">
					<div class="main_game">
						<ul>
							...
							<li><a href="#" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionPop('','subSlot');" class="casino_1_open" data-popup-ordinal="0" id="open_64663418"><img src="/frontend/kingsl/tutu/images/main_game1.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/main_game1.png" class="mouseover1" style="display: none;"></a></li>
                            <li><a href="#" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="javascript:swal('준비중입니다.');return false;"><img src="/frontend/kingsl/tutu/images/main_game2.png" style="display: inline;"><img src="/frontend/kingsl/tutu/images/main_game2.png" class="mouseover1" style="display: none;"></a></li>                
                                                                             
							@else
							<li><a href="#" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/main_game1.png"><img src="/frontend/kingsl/tutu/images/main_game1.png" class="mouseover1" style="display:none;"></a></li>
							<li><a href="#" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/kingsl/tutu/images/main_game2.png"><img src="/frontend/kingsl/tutu/images/main_game2.png" class="mouseover1" style="display:none;"></a></li>                
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="main_best_box">
					<div class="main_best_title"><span class="main_best_title_jackpot"><img src="/frontend/kingsl/tutu/images/jackpot.png"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<iframe src="/frontend/kingsl/common/jackpot.html" frameborder="0" width="900px" height="80" scrolling="auto" style="position:absolute;margin-left:-900px;margin-top:-33px"></iframe>
					</span></div>
					<div class="game_list_wrap">
						...
						@if ($categories && count($categories))
							@foreach($categories AS $index=>$category)
								...
								<li>
									...
									@if ($category->title == 'VirtualTech')
										<img src="/frontend/kingsl/tutu/images/slot-icon/{{ $category->title.'.gif' }}" style="width: 252px;height: 230px;border-radius:30px">
									@else
										<img src="/frontend/kingsl/tutu/images/slot-icon/{{ $category->title.'.png' }}" style="width: 252px;height: 230px;border-radius:30px">
									@endif
										<img src="/frontend/kingsl/tutu/images/best_over01.png" class="mouseover2" style="display:none;width: 252px;">
									</a>     
								</li>
							...
							<li>
								<a href="#" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;">
									<img src="/frontend/kingsl/tutu/images/slot-icon/coming_soon.png" style="width: 252px;height: 230px;border-radius:30px">
									<img src="/frontend/kingsl/tutu/images/best_over01.png" class="mouseover2" style="display:none;width: 252px;">
								</a>
							</li>
							@endfor
		...
		<script type="text/javascript">
			...
			function tabActionPop(obj, pid) {
				...
				if(pid == "register"){
					...
					data =`<div class="game_tit"><img src="/frontend/kingsl/tutu/images/casino_title3.png"></div><div class="game_list_wrap"><ul>`;
					@if ($categories && count($categories))
						@foreach($categories AS $index=>$category)
							@if($category->title != "Hot" && $category->title != "Card" && $category->title != "Bingo" && $category->title != "Roulette" 
							&& $category->title != "Novomatic" && $category->title != "Keno" && $category->title != "Vision" && $category->title != "Wazdan" && $category->title != "New" 
							...
							data += `<li>`;
								...
								@endif										
								@if ($category->title == 'VirtualTech')
								data += `<img src="/frontend/kingsl/tutu/images/slot/{{ $category->title.'.gif' }}" style="width: 297px;height: 114px;  display: inline;">`;
								@else
								data += `<img src="/frontend/kingsl/tutu/images/slot/{{ $category->title.'.png' }}" style="width: 297px;height: 114px;  display: inline;">`;
								@endif
								data += `<img src="/frontend/kingsl/tutu/images/over01.png" class="mouseover2" style="display: none; height: 114px; width: 297px;">`;
								data += `</a>`;     
								data += `</li>`;
							@endif
						@endforeach
					...
					data = `<div id="sk_tab_con_01_1" class="sk_tab_con_01">
								...
								<div class="con_box10">
									<div class="money">
										<ul>`
										@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
											data+= `<li style="width:250px; text-align:left;"><img src="/frontend/kingsl/tutu/images/ww_icon.png" height="26"> 지갑머니 : <span class="font05" id="lnMoney">{{ number_format(Auth::user()->balance) }}원</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>`;
										@endif	
										data+= `</ul>
									</div>
								</div>
