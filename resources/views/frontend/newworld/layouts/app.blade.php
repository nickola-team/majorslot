...
<body>
	...
	<div id="wrap">
		...
		@endif
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.newworld.layouts.partials.m.header')
			@include('frontend.kdior.layouts.partials.m.content')
		@else
			@include('frontend.newworld.layouts.partials.header')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.newworld.layouts.partials.m.aside')
		@endif
