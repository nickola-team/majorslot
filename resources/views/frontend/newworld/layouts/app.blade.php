...
<head>
    ...
    <link rel="icon" href="/frontend/newworld/favicon.ico" >
    <meta
      name="viewport"
    ...
    <!-- <link rel="apple-touch-icon" href="/frontend/newworld/logo192.png" /> -->
    <!-- <link rel="manifest" href="https://www.newworld33.com/manifest.json" /> -->
    <script src="/frontend/newworld/js/jquery-1.12.3.min.js"></script>
    <script src="/frontend/newworld/js/TweenMax.min.js"></script>
    <script src="/frontend/newworld/js/common.js"></script>
    <script src="/frontend/newworld/js/fund.js"></script>
  	<script src="/frontend/newworld/js/action.js"></script>
    ...
    <script type="text/javascript">
      ...
      if (isMobile()) {
        ...
        ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/newworld/css/common.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/newworld/css/layout.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/newworld/css/animations.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/newworld/css/slot.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/newworld/css/custom.css"),
          (link.media = "all"),
          head.appendChild(link),
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/newworld/css/common.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/frontend/newworld/css/layout.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/newworld/css/animations.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/newworld/css/slot.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/newworld/css/custom.css" media="all" />
    <script type="text/javascript" src="/frontend/newworld/jq/slideshow5/jquery.cycle2.min.js" ></script>
    <script type="text/javascript" src="/frontend/newworld/jq/slideshow5/jquery.cycle2.carousel.min.js" ></script>
    <script type="text/javascript" src="/frontend/newworld/js/common.js" ></script>
    <script type="text/javascript" src="/frontend/newworld/js/jquery.newsTicker.js" ></script>
    <script type="text/javascript" src="/frontend/newworld/js/showid.js" ></script>
    <link rel="stylesheet" href="/frontend/newworld/css/logo.css" />
      ...
      <div>
        <div>
          <div id="header_wrap">
            <div class="util_wrap">
              <div class="header_box">
                <div class="util_left">
                  <img
                    src="/frontend/newworld/images/top_icon.png"
                ...
                <a
                  ...
                  class="bs-logo"
                  style="display: block"
                  ><img src="/frontend/newworld/images/logo_02.png"
                /></a>
                  ...
                  <div class="my_a">
                    <div style="margin: 0px 0px 10px; display: inline-block; float:right;color:black;">
                      <span style="
                          ...
                          font-weight: bold;
                          font-size: 15px;">
                        <img src="/frontend/newworld/images/icon4_1.png" style="width: 24px" />
                      </span>
                      &nbsp;&nbsp;
                ...
                @else
                  <div class="my">
                    <a class="fade_2_open" data-popup-ordinal="0" onclick="showLoginPopup()"><img src="/frontend/newworld/images/top_btn_001.png"></a>
                    <a class="fade_3_open" data-popup-ordinal="0" onclick="showRegisterPopup()"><img src="/frontend/newworld/images/top_btn_002.png"></a>
                  </div>
                @endif
            ...
            <div class="gnb_wrap">
              <div class="gnb">
                <ul>
                  <li>
                    <a onclick="showDepositPopup();"><img src="/frontend/newworld/images/gnb01.png" /> 입금신청</a>
                  </li>
                  <li>
                    <a onclick="showWithdrawPopup();"><img src="/frontend/newworld/images/gnb02.png" /> 출금신청</a>
                  </li>
                  <li>
                    <a onclick="showNotificationPopup();"><img src="/frontend/newworld/images/gnb07.png" /> 공지사항</a>
                  </li>
                  <li>
                    <a onclick="showContactPopup();"><img src="/frontend/newworld/images/gnb05.png" /> 고객센터</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          @if(!(isset ($errors) && count($errors) > 0) && !Session::get('success', false))
					...
					<a class="slot-btn gl-title-click" onclick="showGamesPopup('{{ $category->trans->trans_title }}', '{{ $category->href }}', 0)">
						...
						<img
							class="slot-bg"
							src="/frontend/newworld/images/slot-bg.png"
							style="opacity: 100"
						/>
						 <div class="hover-bg">
						 ...
						 <div class="slot-cont">
							<img class="slot-img" src="/frontend/newworld/images/slots/{{ $category->title.'.png' }}" />
						</div> 
						</div>
					</a>
        ...
        <a class="slot-btn gl-title-click" onclick="alert('준비중입니다.');">
						...
						/>
						 ...
						 <div class="slot-cont">
							<img class="slot-img" src="/frontend/newworld/images/slots/coming_soon.png" />
						</div> 
						</div>
					</a>
        @endfor
