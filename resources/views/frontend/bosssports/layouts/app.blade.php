...
@endif
  <body class="ng-scope bg-main">
    <div class="wrapper">
      @if( $detect->isMobile() || $detect->isTablet() ) 
      @else
      @include('frontend.bosssports.layouts.partials.header')
      @endif
      ...
      <div ng-view="" class="ng-scope">
        <main-page class="ng-scope">
          <div class="main-page">
            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.bosssports.layouts.partials.m.banner')
            @else
            @include('frontend.bosssports.layouts.partials.banner')
            @endif

            @include('frontend.bosssports.layouts.partials.linenotice')

            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.bosssports.layouts.partials.m.content')
            @else
            <div class="main-container games">
                <div class="content">
                @include('frontend.bosssports.layouts.partials.category')
                @include('frontend.bosssports.layouts.partials.notice')
                @include('frontend.bosssports.layouts.partials.footer')
                </div>
              </div>
            @endif
    ...
    @include('frontend.bosssports.modals.common')
    @if (!Auth::check())    
      @include('frontend.bosssports.modals.login')
      @include('frontend.bosssports.modals.register')
    @else
      @if( $detect->isMobile() || $detect->isTablet() ) 
        @include('frontend.bosssports.modals.m.myinfo')
      @endif
      @include('frontend.bosssports.modals.page')      
      @include('frontend.bosssports.modals.msg')      
      @include('frontend.bosssports.modals.casino')
      @include('frontend.bosssports.modals.slot')
      @include('frontend.bosssports.modals.minis')
      
    @endif
    @foreach ($noticelist as $ntc)
      @if ($ntc->popup == 'popup')
        @include('frontend.bosssports.modals.popup',  ['notice' => $ntc])
        <script>
