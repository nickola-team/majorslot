...
?>
  style="position:fixed; left:5vw; top:5vh; z-index:200; width:100vw;height:100vh; visibility:visible; display:table;border: 2px solid #d5a451;" 
@else
<?php
...
<form name="notice_formpop{{$notice->id}}">
  ...
  <tbody>
    ...
    <tr>
      ...
      <input type="checkbox" name="chkbox" value="checkbox" id="notice_chk{{$notice->id}}" onclick="closeWinpopDay({{$notice->id}})"><b>하루 동안 이 창을 열지 않음</b> <a href="javascript:closeWinpop({{$notice->id}});"><span class="navi_name" style="font-size:18px;">[닫기]</span></a>&nbsp;
      </td>
    </tr>
  </tbody>
  </table>
