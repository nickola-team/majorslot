...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.casino.layouts.partials.m.header', ['logo' => 'casino'])
			@include('frontend.kdior.layouts.partials.m.content1')
		@else
			@include('frontend.casino.layouts.partials.header', ['logo' => 'casino'])
			@include('frontend.kdior.layouts.partials.banner')
			<div class="main_contents_wrap">
				<div class="main_contents_box">
					@include('frontend.casino.layouts.partials.category')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.casino.layouts.partials.m.aside', ['logo' => 'casino'])
		@endif
	</div><!-- wrap -->
	@yield('content')
	@auth()
