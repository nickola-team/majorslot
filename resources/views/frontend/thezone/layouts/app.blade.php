...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/thezone/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/thezone/img/logo.png?5"/></div>
		<font>Copyright&copy; THEZONE. ALL RIGHT RESERVED</font>
	</footer>
