    ...
    <div class="top_menu">
        <ul>
            ...
            @else
                class="casino_1_open"
            @endif
            ><img src="/frontend/aladin/images/m_main_game1.png?v=202302021619" width="100%"></a></li>
            <li><a href="#" class="casino_3_open"><img src="/frontend/aladin/images/m_main_game3.png?v=202302021619" width="100%"></a></li> 
