...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="/frontend/aladin/V/main1.css">
...
@if( $detect->isMobile() || $detect->isTablet() ) 
  <link rel="stylesheet" href="/frontend/aladin/V/app-mobile.css">
@endif
    ...
    <div class="wrapper">
      ...
      <div ng-view="" class="ng-scope">
        <main-page class="ng-scope">
          <div class="main-page">
            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.aladin.layouts.partials.m.banner')
            @else
            @include('frontend.aladin.layouts.partials.banner')
            @endif

            @include('frontend.boss.layouts.partials.linenotice')

            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.cowboy.layouts.partials.m.content')
            @else
            <div class="main-container games">
                <div class="content">
                @include('frontend.cowboy.layouts.partials.category')
