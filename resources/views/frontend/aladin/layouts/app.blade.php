...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.aladin.layouts.partials.m.header')
			@include('frontend.aladin.layouts.partials.m.content')
		@else
			@include('frontend.aladin.layouts.partials.header')
			@include('frontend.aladin.layouts.partials.banner')
			<div class="main_contents_wrap">
				<div class="main_contents_box">
					@include('frontend.aladin.layouts.partials.category')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.aladin.layouts.partials.m.aside')
		@endif
