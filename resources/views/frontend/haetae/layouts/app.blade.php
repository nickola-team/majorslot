...
@endif
  <body class="ng-scope bg-main">
    <div class="wrapper">
      @if( $detect->isMobile() || $detect->isTablet() ) 
      @else
      @include('frontend.haetae.layouts.partials.header')
      @endif
      ...
      <div ng-view="" class="ng-scope">
        <main-page class="ng-scope">
          <div class="main-page">
            ...
            @else
            @include('frontend.haetae.layouts.partials.banner')
            @endif

            @include('frontend.nine.layouts.partials.linenotice')

            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.haetae.layouts.partials.m.content')
            @else
            <div class="main-container games">
                <div class="content">
                @include('frontend.haetae.layouts.partials.category')
