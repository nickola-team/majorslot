...
<gamebutton-page>
    <div class="gamebuttons-page">
        ...
        <div ng-repeat="gamebutton in gamebuttons" class="game-buttons casino-open" onclick=@auth "navClick('casino-popup')" @else "navClick('login-popup')" @endif>
            
        </div>
        <div id="halfwidth" ng-repeat="gamebutton in gamebuttons" ng-if="gamebutton.category == 'casino' " class="game-buttons casino-open" onclick=@auth "navClick('casino-popup')" @else "navClick('login-popup')" @endif>
            <img class="gamebutton__img" ng-src="/frontend/newheaven/mobile/common/images/main/mobile-game-button-6.jpg" src="/frontend/newheaven/mobile/common/images/main/mobile-game-button-6.jpg">
        </div>
