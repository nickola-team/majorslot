...
<head>
    ...
    <link rel="icon" href="/frontend/Kakao/favicon.ico" >
    <meta
      name="viewport"
    ...
    <!-- <link rel="apple-touch-icon" href="/frontend/Kakao/logo192.png" /> -->
    <!-- <link rel="manifest" href="https://www.kakao33.com/manifest.json" /> -->
    <script src="/frontend/Kakao/js/jquery-1.12.3.min.js"></script>
    <script src="/frontend/Kakao/js/TweenMax.min.js"></script>
    <script src="/frontend/Kakao/js/common.js"></script>
    <script src="/frontend/Kakao/js/fund.js"></script>
  	<script src="/frontend/Kakao/js/action.js"></script>
    ...
    <script type="text/javascript">
      ...
      if (isMobile()) {
        ...
        ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/Kakao/css/common.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/Kakao/css/layout.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/Kakao/css/animations.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/Kakao/css/slot.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/Kakao/css/custom.css"),
          (link.media = "all"),
          head.appendChild(link),
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/Kakao/css/common.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/frontend/Kakao/css/layout.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/Kakao/css/animations.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/Kakao/css/slot.css" media="all" />
    <link id="undefined" rel="stylesheet" type="text/css" href="/frontend/Kakao/css/custom.css" media="all" />
    <script type="text/javascript" src="/frontend/Kakao/jq/slideshow5/jquery.cycle2.min.js" ></script>
    <script type="text/javascript" src="/frontend/Kakao/jq/slideshow5/jquery.cycle2.carousel.min.js" ></script>
          ...
          <div id="header_wrap">
            <div class="util_wrap">
              <div class="header_box">
                <div class="util_left">
                  <img
                    src="/frontend/Kakao/images/top_icon.png"
                ...
                <a
                  ...
                  class="bs-logo"
                  style="display: block"
                  ><img src="/frontend/Kakao/images/logo_02.png"
                /></a>
                  ...
                  <div class="my_a">
                    <span style="margin: 0px 0px 10px; display: inline-block">
                      <span style="
                          ...
                          font-weight: bold;
                          font-size: 15px;">
                        <img src="/frontend/Kakao/images/icon4_1.png" style="width: 24px" />
                      </span>
                      &nbsp;&nbsp;
                      <span class="font07">{{ Auth::user()->username }}</span>
                      님&nbsp;&nbsp;지갑 :
                      <span class="font05" id="myWallet">{{ number_format(Auth::user()->balance,2) }} 원</span>
                      <a onclick="getBalance();"><img src="/frontend/Kakao//images/icon_re.png" class="icon_re"></a>
                    ...
                    <a class="fade_1_open" data-popup-ordinal="6" id="open_75076113" onclick="showProfilePopup();">
                      <img src="/frontend/Kakao/images/top_btn_003.png" />
                    </a>
                    <a class="fade_3_open" data-popup-ordinal="0" id="open_55563334" onclick="showProfileEditorPopup();">
                      <img src="/frontend/Kakao/images/top_btn_005.png" />
                    </a>
                    <a onclick="goLogout();"><img src="/frontend/Kakao/images/top_btn_004.png" /></a>
                  </div>
                @else
                  <div class="my">
                    <a class="fade_2_open" data-popup-ordinal="0" onclick="showLoginPopup()"><img src="/frontend/Kakao/images/top_btn_001.png"></a>
                    <a class="fade_3_open" data-popup-ordinal="0" onclick="showRegisterPopup()"><img src="/frontend/Kakao/images/top_btn_002.png"></a>
                  </div>
                @endif
            ...
            <div class="gnb_wrap">
              <div class="gnb">
                <ul>
                  <li>
                    <a onclick="showDepositPopup();"><img src="/frontend/Kakao/images/gnb01.png" /> 입금신청</a>
                  </li>
                  <li>
                    <a onclick="showWithdrawPopup();"><img src="/frontend/Kakao/images/gnb02.png" /> 출금신청</a>
                  </li>
                  <li>
                    <a onclick="showNotificationPopup();"><img src="/frontend/Kakao/images/gnb07.png" /> 공지사항</a>
                  </li>
                  <li>
                    <a onclick="showContactPopup();"><img src="/frontend/Kakao/images/gnb05.png" /> 고객센터</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          @if(!(isset ($errors) && count($errors) > 0) && !Session::get('success', false))
					...
					<a class="slot-btn gl-title-click" onclick="showGamesPopup('{{ $category->trans->trans_title }}', '{{ $category->href }}', 0)">
						...
						/>
						 ...
						 <div class="slot-cont">
							<img class="slot-img" src="/frontend/Kakao/images/slots/{{ $category->title.'.png' }}" />
						</div> 
						</div>
					</a>
