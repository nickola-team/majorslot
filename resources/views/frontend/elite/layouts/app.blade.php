...
<head>
    ...
    <link rel="icon" href="/frontend/elite/images/logo_02.png" >
    <meta
      name="viewport"
  ...
  <input type="hidden" value="<?= csrf_token() ?>" name="_token" id="_token">
      <div>
        <div id="wrap">
            ...
            <div class="util_wrap">
              <div class="header_box">
                ...
                <a
                  ...
                  class="bs-logo"
                  style="display: block"
                  ><img src="/frontend/elite/images/logo_02.png" style="left: -110px;!important;"/></a>
          ...
          <div class="visual_wrap" style="background: url(/frontend/elite/images/visual_bg.jpg) center top no-repeat;!important;">
        ...
        @endfor
          ...
          <div id="footer">
            ...
            2022~2023 Elite  All rights reserved.
          </div>
         </div>
         <div>
