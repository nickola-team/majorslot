...
<div id="html5content">
    ...
    <iframe id='gameframe' src='/games/XocDiaGP/game/XocDia/{{$platform}}/?lang={{$pagelang?($pagelang=="ko"?"ko-kr":"vi-vn"):"ko-kr"}}&mode=True&t={{auth()->user()->api_token}}' frameborder="0"></iframe>
</div>
