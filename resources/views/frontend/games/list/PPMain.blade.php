...
<html>
    <head>
        ...
        <script>
            ...
            Loader.LoadGame = function() {
                ...
                var script = Loader.LoadScript(UHT_CONFIG.GAME_URL + "bootstrap.js" + "?key=" + "c38b4", Loader.LoadGameCallback, function() {
        ...
        <script type="text/javascript" src="/games/_{{preg_replace('/^[_]/', '', $game->name)}}/common/js/html5-script-external.js"></script>
    ...
    <body class="CLIENT EXTERNAL HTML5">
        ...
        <?php include public_path() . '/games/_'. preg_replace('/^[_]/', '', $game->name) .'/openGame.do'; ?>
    </body>
</html>
