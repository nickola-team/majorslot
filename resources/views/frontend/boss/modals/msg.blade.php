        ...
        <div class="ngdialog-content" role="document">
          <div class="ngdialog-customer-page ngdialog-main-default-page ng-scope" ng-controller="CustomerController" ng-init="setTab(selectCustomerTab)">
            <div class="ngdialog__heading">
              <h4 class="ngdialog__title text-left ng-scope" translate="">고객센터</h4>
            </div>
            <ul class="ngdialog-main-nav list-inline clearfix">
              <li onclick="setTab('notice-set',this)">
                <span class="main-nav__label ng-scope">공지사항</span>
              </li>
              <li onclick="setTab('event-set',this)">
                <span class="main-nav__label ng-scope">이벤트</span>
              </li>
              <li onclick="setTab('customer-set',this);getCustomerPage()">
            ...
            <div id="notice-set" class="ngdialog-main-default__content announcement ng-hide">
              <!-- ngIf: readTitle != '' -->
            ...
            <div id="customer-set" class="ngdialog-main-default__content ng-hide">
              <div class="cc-list">
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-theme btn-yellow no-border border-radius btn-send">
              ...
              <form class="ng-pristine ng-valid ng-valid-maxlength cc-from ng-hide">
                <fieldset class="back-button">
                  <button type="button" class="btn pull-right cc-back">
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-theme btn-yellow ng-scope" onclick="send_text()">작성 완료</button>
                </div>
              </form>
            </div>
