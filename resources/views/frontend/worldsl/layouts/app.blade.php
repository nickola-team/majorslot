...
<head>
		...
		<link rel="shortcut icon" href="/frontend/worldsl/images/favicon/favicon.html" type="image/x-icon">

		<link rel="stylesheet" type="text/css" href="/frontend/worldsl/tutu/css/common.css">
		<link rel="stylesheet" type="text/css" href="/frontend/worldsl/tutu/css/basic.css">
		<link rel="stylesheet" type="text/css" href="/frontend/worldsl/tutu/css/layoutb04c.css?v=31234">
		<link rel="stylesheet" type="text/css" href="/frontend/worldsl/tutu/css/animations.css">
		<link rel="stylesheet" type="text/css" href="/frontend/worldsl/css/odometer-theme-default.css">

		<script type="text/javascript" src="/frontend/worldsl/tutu/js/showid.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/jquery-1.8.3.min.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/tutu/jq/sk_popup/sk_popup.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/tutu/js/sk_tab.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/sweetalert.min.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/ajax_utf_8.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/playd7cf.js?v=xxx1.2"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/swiper.min.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/script3860.js?v=1"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/paging.min.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/jsRolling.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/numeric.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/odometer.min.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/js/action.js"></script>
		<script type="text/javascript" src="/frontend/worldsl/tutu/jq/common/common.js"></script><!-- script -->
	</head>
	...
	<script type="text/javascript">
		...
		function toggleRealtime(e) {
			if(e == 'deposit'){
				...
				$("#dp_list_btn").attr("src", "/frontend/worldsl/images/main_con3_1_title_on.html");
				$("#wd_list_btn").attr("src", "/frontend/worldsl/images/main_con3_2_title.html");
				...
				$("#dp_list_btn").attr("src", "/frontend/worldsl/images/main_con3_1_title.html");
				$("#wd_list_btn").attr("src", "/frontend/worldsl/images/main_con3_2_title_on.html");
	...
	<body class="overflow-x:hidden;" style="background-color: #0967c4">
		...
		<div id="casino_1" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="casino_1_close"><img src="/frontend/worldsl/tutu/images/popup_close.png"></a></div>
		...
		<div id="sub_pop1" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="sub_pop1_close"><img src="/frontend/worldsl/tutu/images/popup_close.png"></a></div>
				<div class="popupbox">
		...
		<div id="sub_pop2" class="popup_style02 popup_none">
			<div class="popup_wrap">
				<div class="close_box"><a href="#" class="sub_pop2_close"><img src="/frontend/worldsl/tutu/images/popup_close.png"></a></div>
				<div class="popupbox">            
					<div class="popup_tab_wrap">
		...
		<div id="wrap">
			<div id="header_wrap">
				<div class="header_box">
					<div class="logo">
						<a href="/"><img src="/frontend/worldsl/tutu/images/logoae52.png?v=5" style="width:250px;"></a>
					</div>
					<div class="gnb">						
						
						<ul>
						@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
							<li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab1','charge');" data-popup-ordinal="0" id="open_34483963"><img src="/frontend/worldsl/tutu/images/gnb1.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb1over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab2','excharge');" data-popup-ordinal="1" id="open_80823455"><img src="/frontend/worldsl/tutu/images/gnb2.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb2over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab3','inoutList');" data-popup-ordinal="2" id="open_9185439"><img src="/frontend/worldsl/tutu/images/gnb11.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb11over.png" style="display: none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab4','letterList');" data-popup-ordinal="3" id="open_59824731"><img src="/frontend/worldsl/tutu/images/gnb9.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb9over.png" style="display: none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab5','chatList');" data-popup-ordinal="4" id="open_81567995"><img src="/frontend/worldsl/tutu/images/gnb8.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb8over.png" style="display: none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onmouseover="show_over(this);" onmouseout="show_out(this);" onclick="tabActionProc('tab6','noticeList');" data-popup-ordinal="5" id="open_37017382"><img src="/frontend/worldsl/tutu/images/gnb7.png" style="display: inline;"><img src="/frontend/worldsl/tutu/images/gnb7over.png" style="display: none;" class="mouseover3"></a></li>
							
						@else							
							<li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb1.png"><img src="/frontend/worldsl/tutu/images/gnb1over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb2.png"><img src="/frontend/worldsl/tutu/images/gnb2over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb11.png"><img src="/frontend/worldsl/tutu/images/gnb11over.png" style="display:none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb9.png"><img src="/frontend/worldsl/tutu/images/gnb9over.png" style="display:none;" class="mouseover3"></a></li>
                            <li style="margin-left: 10px;"><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb8.png"><img src="/frontend/worldsl/tutu/images/gnb8over.png" style="display:none;" class="mouseover3"></a></li>
                            <li><a href="#" class="sub_pop1_open" onMouseOver="show_over(this);" onMouseOut="show_out(this);" onclick="javascript:swal('로그인 하여 주세요.');return false;"><img src="/frontend/worldsl/tutu/images/gnb7.png"><img src="/frontend/worldsl/tutu/images/gnb7over.png" style="display:none;" class="mouseover3"></a></li>
						@endif
						</ul>
			...
			<!-- ▼slideshow6▼ -->
			<script src="/frontend/worldsl/tutu/jq/slideshow6/flux.js" type="text/javascript" charset="utf-8"></script>
		...
		<script type="text/javascript">
			...
			function tabActionPop(obj, pid) {
				...
				if(pid == "register"){
					...
					data =`<div class="game_tit"><img src="/frontend/worldsl/tutu/images/casino_title3.png"></div><div class="game_list_wrap"><ul>`;
					@if ($categories && count($categories))
						@foreach($categories AS $index=>$category)
