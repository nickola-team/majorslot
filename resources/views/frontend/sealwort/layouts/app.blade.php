...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.sealwort.layouts.partials.m.header', ['logo' => 'sealwort'])
			@include('frontend.kdior.layouts.partials.m.content1')
		@else
			@include('frontend.sealwort.layouts.partials.header', ['logo' => 'sealwort'])
			@include('frontend.kdior.layouts.partials.banner')
			<div class="main_contents_wrap">
				<div class="main_contents_box">
					@include('frontend.sealwort.layouts.partials.category')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.sealwort.layouts.partials.m.aside', ['logo' => 'sealwort'])
		@endif
	</div><!-- wrap -->
	@yield('content')
	@auth()
