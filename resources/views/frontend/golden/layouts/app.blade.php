  ...
  <input type="hidden" value="<?= csrf_token() ?>" name="_token" id="_token">
      <div>
        <div id="wrap">
            ...
            <div class="util_wrap">
              <div class="header_box">
                ...
                <a
                  ...
                  class="bs-logo"
                  style="display: block"
                  ><img src="/frontend/golden/images/logo_02.png"
                /></a>
                ...
                @else
                  <div class="my">
                    <a class="fade_2_open" data-popup-ordinal="0" onclick="showLoginPopup('golden')"><img src="/frontend/jungle/images/top_btn_001.png"></a>
          ...
          <div class="visual_wrap" style="background: url(/frontend/golden/images/visual_bg.jpg) center top no-repeat;!important;">
