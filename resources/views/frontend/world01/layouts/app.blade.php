...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.kdior.layouts.partials.m.header', ['logo' => 'world01'])
			@include('frontend.kdior.layouts.partials.m.content')
		@else
			@include('frontend.kdior.layouts.partials.header', ['logo' => 'world01'])
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.kdior.layouts.partials.m.aside', ['logo' => 'world01'])
		@endif
