...
<head>
    ...
    <link rel="icon" href="/frontend/sinbad/img/favicon.ico" >
    <meta
      name="viewport"
      content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=0"
    />
    <meta name="theme-color" content="#000000" />
      <script type="text/javascript" src="/frontend/sinbad/js/app.js"></script>
    <script type="text/javascript" src="/frontend/sinbad/js/jquery.number.min.js"></script>
    <script type="text/javascript" src="/frontend/sinbad/js/parsley.min.js"></script>
    <script type="text/javascript" src="/frontend/sinbad/js/parsley.remote.min.js"></script>
    <script type="text/javascript" src="/frontend/sinbad/js/lazyload.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      if (isMobile()) {
        ...
        ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/sinbad/css/style7d93.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/sinbad/css/galaxy5358.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/sinbad/css/font-icon.css"),
          (link.media = "all"),
          head.appendChild(link),
          ((link = document.createElement("link")).id = cssId),
          (link.rel = "stylesheet"),
          (link.type = "text/css"),
          (link.href = "/frontend/sinbad/css/themes/default.min.css"),
          (link.media = "all"),
          head.appendChild(link),
    ...
    <link rel="stylesheet" href="/frontend/sinbad/css/font-icon.css">
    <link rel="stylesheet" href="/frontend/sinbad/css/app.css">
    <link rel="stylesheet" href="/frontend/sinbad/css/style7d93.css?v=2368">
    <link rel="stylesheet" href="/frontend/sinbad/css/galaxy5358.css?v=1540">
    <link rel="stylesheet" href="/frontend/sinbad/css/themes/default.min.css">


    <!-- Sweet-Alert  -->
    <script type="text/javascript" src="/frontend/sinbad/js/sweetalert/sweetalert.min.js"></script>
    <script type="text/javascript" src="/frontend/sinbad/js/sweetalert/jquery.sweet-alert.custom.js"></script>
    <link rel="stylesheet" href="/frontend/sinbad/js/sweetalert/sweetalert.css" type="text/css">

    <script type="text/javascript" src="/frontend/sinbad/js/menuafee.js?v=9337"></script>
	<script type="text/javascript" src="/frontend/sinbad/js/maina5e0.js?v=3289"></script>
	<script type="text/javascript" src="/frontend/sinbad/js/script838b.js?v=1433"></script>
...
<div class="wrapper">
  ...
  <div class="nav-main">
		<div class="center">
			<a href="{{url('/')}}" class="gs-logo">
				<div class="container">
					<img src="/frontend/sinbad/img/logo.png">
				</div>
			</a>
      ...
      <div class="nav-cont">
        <div class="link-main">
          <ul class="bs-ul">
            ...
            @endif
                <div class="icon-cont">
                  <img src="/frontend/sinbad/img/icon/deposit.png">
                </div>
                <span>입금신청</span>
              </a>
            </li>
            ...
            @endif
                <div class="icon-cont">
                  <img src="/frontend/sinbad/img/icon/withdraw.png">
                </div>
                <span>출금신청</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/sinbad/img/icon/event.png">
                </div>
                <span>이벤트</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/sinbad/img/icon/notice.png">
                </div>
                <span>공지사항</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/sinbad/img/icon/mypage.png">
                </div>
                <span>마이페이지</span>
              </a>
            </li>
  ...
  <div class="banner-main">
    <div class="banner-deco">
      ...
      <img class="fireball-orange" src="/frontend/sinbad/img/banner/fireball-orange.png">
      ...
      <img class="king" src="/frontend/sinbad/img/banner/char-1eccb.png?3">
      ...
      <img class="coins" src="/frontend/sinbad/img/banner/coins.png">
      <!-- <img class="girl" src="img/banner/girl.png"> -->
      <img class="rich-man" src="/frontend/sinbad/img/banner/char-2c81e.png?2">
  ...
  <div class="page-content">
    ...
    <div style="margin-top:25px;height:50px;">
      <span class="a_style">신밧드 SLOT</span>
    </div>
    ...
    @if ($categories && count($categories))
          ...
          @endif
            <div class="sb-inner">
              <div class="main-cont">
                <div class="inner">
                  <img class="main-img" src="/frontend/sinbad/img/slot/{{ $category->title.'.jpg' }}">
              ...
              <img class="plate" src="/frontend/sinbad/img/bg/slot-plate.png">
            </div>
            <div class="icon-cont">
              <img src="/frontend/sinbad/img/slot-icon2/{{ $category->title }}.png" />
            </div>
          </a>     
  ...
  <div class="footer-main">
      ...
      <div class="center">
        <img src="/frontend/sinbad/img/slot-icon/Blueprint.png">
        <img src="/frontend/sinbad/img/slot-icon/Booongo.png">
        <img src="/frontend/sinbad/img/slot-icon/Endorphina.png">
        <img src="/frontend/sinbad/img/slot-icon/GameArt.png">
        <img src="/frontend/sinbad/img/slot-icon/Habanero.png">
        <img src="/frontend/sinbad/img/slot-icon/Micro.png">
        <img src="/frontend/sinbad/img/slot-icon/Platipus.png">
        <img src="/frontend/sinbad/img/slot-icon/Playson.png">
        <img src="/frontend/sinbad/img/slot-icon/Pragmatic.png">
        <img src="/frontend/sinbad/img/slot-icon/RedRake.png">
        <img src="/frontend/sinbad/img/slot-icon/Spinmatic.png">
        <img src="/frontend/sinbad/img/slot-icon/Spinomenal.png">
        <img src="/frontend/sinbad/img/slot-icon/Thunderkick.png">
      </div>
    </div>
    <div class="copyright-cont">
        <span>ⓒ COPYRIGHT  SINBAD  2021 ALL RIGHTS RECEIVE.</span>
    </div>
	</div>
	...
	<div class="bs-modal modal-dialog">
		<div class="bsm-cont">
			...
			<div class="bsm-inner">
				...
				<div class="modal-body">
					<div class="tab-mdl active">
						<form id="joinForm" action="javascript:goJoin()" method="post" data-parsley-validate="" novalidate="">
							<div class="form-container">
								<div class="form-group">
									<div class="labels">
										<p>아이디(3자이상 7자이하 영문, 숫자만 가능)</p>
									</div>
									<div class="infos">
										<input class="form-control " id="memberid" data-parsley-trigger="change" data-parsley-pattern="/^[a-z]+[a-z0-9]{3,12}$/g" data-parsley-pattern-message="유효하지 않은 값입니다." maxlength="7" data-parsley-required="true" data-parsley-required-message="필수입력 항목입니다." data-parsley-minlength="3" data-parsley-minlength-message="3 자 이상 입력하세요." data-parsley-maxlength="7" data-parsley-maxlength-message="7 자 이하로 입력하세요." data-parsley-remote="/user/idcheck_proc.asp" data-parsley-remote-message="이미 사용 중입니다." data-parsley-remote-validator="reverse" autocomplete="off" name="memberid" type="text" value="" data-parsley-id="0350"><ul class="parsley-errors-list" id="parsley-id-0350"></ul>
									</div>
								</div>
								<div class="form-group">
									<div class="labels">
...
<div class="subpgModal modal fade in" role="dialog" style="display: none; padding-right: 17px;">
	<div class="bs-modal modal-dialog">
		<div class="bsm-cont sub-page">
          ...
          <form action="javascript:goDeposit()" method="post" id="depoFrm" name="depoFrm" data-parsley-validate="" novalidate="">            
            <div class="form-container">
              <div class="form-group">
                <div class="labels">
                  <p>회원정보</p>
              ...
              <div class="form-group">
                ...
                <div class="infos">
                  <input class="form-control " data-parsley-trigger="change" data-parsley-required="true" data-parsley-required-message="필수입력 항목입니다." name="refundname" type="text" value="" data-parsley-id="0017"><ul class="parsley-errors-list" id="parsley-id-0017"></ul>
                </div>
              </div>
              <div class="form-group">
                <div class="labels">
    ...
    <div class="tab-mdl withdraw">
      <form action="javascript:goWithdraw()" method="post" id="withFrm" name="withFrm" data-parsley-validate="" novalidate="">
        ...
        <div class="form-container">
          ...
          <div class="form-group">
            ...
            <div class="infos">
              <label>
                <select id="_rsbank" class="form-control " data-parsley-required="true" data-parsley-required-message="필수입력 항목입니다." name="_rsbank" data-parsley-id="7298">
                  <option value="">--은행 선택--</option>
                  @foreach(\VanguardLTE\User::$values["banks"] AS $val)
                    @if($val != "")
                      <option value="{{$val}}">{{$val}}</option>
          ...
          <div class="form-group">
            ...
            <div class="infos">
              <input class="form-control " name="_rsa_name" type="text" value="" data-parsley-id="6338"><ul class="parsley-errors-list" id="parsley-id-6338"></ul>
            </div>
          </div>
          <div class="form-group">
            <div class="labels">
            ...
            <div class="infos">
              <input class="form-control " name="refundpassword" type="text" value="" data-parsley-id="1347"><ul class="parsley-errors-list" id="parsley-id-1347"></ul>
            </div>
          </div>
