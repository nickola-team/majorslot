...
<div class="wrapper">
  ...
  <div class="nav-main">
		<div class="center">
			<a href="{{url('/')}}" class="gs-logo">
				<div class="container">
					<img src="/frontend/kingdom01/img/logo.png">
				</div>
			</a>
  ...
  <div class="banner-main" style="background-image: url(/frontend/kingdom01/img/banner/banner-bg.jpg) !important;">
    <div class="banner-deco">
      ...
      <img class="fireball-orange" src="/frontend/winners/img/banner/fireball-orange.png">
      ...
      <img class="king" src="/frontend/winners/img/banner/char-1eccb.png?3">
      ...
      <img class="coins" src="/frontend/winners/img/banner/coins.png">
      <!-- <img class="girl" src="img/banner/girl.png"> -->
      <img class="rich-man" src="/frontend/winners/img/banner/char-2c81e.png?2">
  ...
  <div class="page-content">
    ...
    <div style="margin-top:25px;height:50px;">
      <span class="a_style">킹덤카지노 GAMES</span>
    </div>
  ...
  <div class="footer-main">
    ...
    <div class="copyright-cont">
        <span>ⓒ COPYRIGHT  킹덤카지노  2022~2023 ALL RIGHTS RESERVED</span>
    </div>
	</div>
