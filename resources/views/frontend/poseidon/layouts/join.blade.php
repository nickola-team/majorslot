...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/poseidon/img/join_title.png" /></div>
	<div id="data_box">
	<div class="txt"><span class="txt_style02"><b>- 중복 회원가입 방지를 위해 아이디는 중복확인을 해주십시오. 회원가입에 필요한 정보를 입력해주세요.<b></span></div>
				...
				<tr>
					...
					<td class="line3">
						<div class="txt_area2">
							...
							<a href="#" onclick="javascript:checkid();"><img src="/frontend/poseidon/img/double_btn.gif" width="60" height="22" border="0" align="absmiddle" /></a>
		...
		<div class="btn"><a href="#" onClick="Regist(frmRegist);"><img src="/frontend/poseidon/img/join_btn.png" border="0" /></a></div>
	</div>
</div>
</form>
</div>
