...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/poseidon/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/poseidon/img/logo.png?5"/></div>
		<font>Copyright® 포세이돈. ALL RIGHT RESERVED</font>
	</footer>
