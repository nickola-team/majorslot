<div class="banner-container">
    ...
    <div class="main-banner-slider">
        ...
        <div>
            <img src="/frontend/cowboy/V/slider-mobile-1.png" style="width:100%">
        </div>
        <div>
            <img src="/frontend/cowboy/V/slider-mobile-2.png" style="width:100%">
        </div>
        <div>
            <img src="/frontend/cowboy/V/slider-mobile-3.png" style="width:100%">
        </div>
