...
<div class="game-buttons ng-scope live" onclick=
@auth
...
<div class="customercenter-container">
    ...
    "navClick('login-popup')"
    @else
    "navClick('msg-popup');setTab('notice-set','#msg-popup > div.ngdialog-content > div.ngdialog-customer-page.ngdialog-main-default-page.ng-scope > ul > li:nth-child(1)');"
    @endif
    >
    ...
    "navClick('login-popup')"
    @else
    "navClick('msg-popup');setTab('event-set','#msg-popup &gt; div.ngdialog-content &gt; div.ngdialog-customer-page.ngdialog-main-default-page.ng-scope &gt; ul &gt; li:nth-child(2)')"
    @endif
    >
    ...
    "navClick('login-popup')"
    @else
    "navClick('msg-popup');setTab('customer-set','#msg-popup &gt; div.ngdialog-content &gt; div.ngdialog-customer-page.ngdialog-main-default-page.ng-scope &gt; ul &gt; li:nth-child(3)');getCustomerPage();"
    @endif
    >
