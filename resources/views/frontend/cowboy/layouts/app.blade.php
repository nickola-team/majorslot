...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="/frontend/cowboy/V/main1.css">
...
@if( $detect->isMobile() || $detect->isTablet() ) 
  <link rel="stylesheet" href="/frontend/cowboy/V/app-mobile.css">
@endif
    ...
    <div class="wrapper">
      ...
      <div ng-view="" class="ng-scope">
        <main-page class="ng-scope">
          <div class="main-page">
            @if( $detect->isMobile() || $detect->isTablet() ) 
              @include('frontend.cowboy.layouts.partials.m.banner')
            @else
            @include('frontend.cowboy.layouts.partials.banner')
            @endif
