...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/bently/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/bently/img/logo.png?5"/></div>
		<font>Copyright&copy; Bently. ALL RIGHT RESERVED</font>
	</footer>
