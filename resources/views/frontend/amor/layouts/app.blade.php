...
<body>
	...
	<div id="wrap">
		...
		@endif
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.amor.layouts.partials.m.header')
			@include('frontend.amor.layouts.partials.m.content')
		@else
			@include('frontend.venus.layouts.partials.header')
			@include('frontend.amor.layouts.partials.banner')
			<div class="main_contents_wrap">
				<div class="main_contents_box">
					@include('frontend.amor.layouts.partials.category')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.amor.layouts.partials.m.aside')
		@endif
	</div><!-- wrap -->
