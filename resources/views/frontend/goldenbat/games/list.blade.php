@extends('frontend.goldenbat.layouts.app')
...
<script type='text/javascript'>
	...
	var HTTP_HOST='goldenbat777.com';
...
<div class="main_slide">
	<div class="video_bg">
		<video loop autoplay muted preload="auto" id="login_video_b">
			<source src="/frontend/goldenbat/img/bg_movie2.mov" type="video/mp4">
	...
	<div class="slide_wrap">
		<div class="slider">
			<ul class="bxslider">
				<li><img src="/frontend/goldenbat/img/slide_img0.png?5" /></li>
				<li><img src="/frontend/goldenbat/img/slide_img1.png?5" /></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="main_game">
		...
		@if ($categories && count($categories))
				...
				@if(!(isset ($errors) && count($errors) > 0) && !Session::get('success', false))
					<a href="javascript:void(0);" class="slot-btn" onclick="goSlot('{{ $category->title }}', '{{ $category->href }}', 0)">
						<div class="inner-cont">
							<div class="main-cont">
								<img class="main-img" src="/frontend/goldenbat/img/slot/{{ $category->title.'.jpg' }}">
								<div class="hover">
									<div class="center">
										<button class="play-btn">게임시작</button>
										<img src="/frontend/goldenbat/img/slot-icon/{{ $category->title.'.png' }}">
									</div>
								</div>
								<div class="logo-cont">
									<img src="/frontend/goldenbat/img/slot-icon/{{ $category->title.'.png' }}">
			...
			@for ($i=0;$i<$comingSoon;$i++)
				<a href="javascript:void(0);" class="slot-btn" onclick="alert('준비중입니다.');">
						<div class="inner-cont">
							<div class="main-cont">
								<img class="main-img" src="/frontend/goldenbat/img/slot/coming_soon.jpg">
								<div class="hover">
									<div class="center">
										<img src="/frontend/goldenbat/img/slot-icon/coming_soon.png">
									</div>
								</div>
								<div class="logo-cont">
									<img src="/frontend/goldenbat/img/slot-icon/coming_soon.png">
	...
	<div class="main_board">
		<ul>
			<li class="cs_center">
				<dl>
					<dd class="txt"><img src="/frontend/goldenbat/img/logo_layer.png?5" /> 고객센터 안내<span>언제 어디서나 무엇이든 물어보세요!</span></dd>
