...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/goldenbat/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/goldenbat/img/logo.png?5"/></div>
		<font>Copyright® 황금박쥐. ALL RIGHT RESERVED</font>
	</footer>
