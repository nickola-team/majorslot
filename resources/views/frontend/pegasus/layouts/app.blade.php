...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/pegasus/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/pegasus/img/logo.png?5"/></div>
		<font>Copyright&copy; 페가수스. ALL RIGHT RESERVED</font>
	</footer>
