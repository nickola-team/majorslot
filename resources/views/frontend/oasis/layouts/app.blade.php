...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.bolton.layouts.partials.m.header', ['logo' => 'oasis'])
			@include('frontend.kdior.layouts.partials.m.content')
		@else
			@include('frontend.kdior.layouts.partials.header', ['logo' => 'oasis'])
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.kdior.layouts.partials.m.aside', ['logo' => 'oasis'])
		@endif
	</div><!-- wrap -->
