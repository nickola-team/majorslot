@extends('frontend.bank.layouts.app')
...
{{-- <div class="quick1_wrap">
    <div class="quick1_box">
        <div class="quick1_title"><img src="/frontend/bank/bank/images/today_withdraw.png"></div>
        <div class="quick1">
...
<div class="quick2_wrap">
    <div class="quick2_box">
        <div class="quick2_title"><img src="/frontend/bank/bank/images/today_deposit.png"></div>
        <div class="quick2">
...
<div class="slideshow2_wrap">
    <div class="slideshow2_wrap_center">
        <div id="number_slideshow" class="number_slideshow">
            <ul>
                <li><a><img src="/frontend/bank/bank/images/slideshow1.jpg"></a></li>
                <li><a><img src="/frontend/bank/bank/images/slideshow1.jpg"></a></li>
<!--                <li><a><img src="/frontend/bank/bank/images/slideshow2.png"></a></li> -->
            </ul>
                        ...
                        <div class="inner">
                            <div class="category">
                                ...
                                <div class="gameborder">
                                    <img width="100%" height="100%" src="/frontend/bank/bank/images/border.png" />
                                </div>
                            </div>
...
<div id="join_pop" class="fadeIn222 popup_none">
    <div class="popup_wrap">
        <div class="close_box"><a href="#" class="join_pop_close"><img src="/frontend/bank/bank/images/popup_close.png"></a></div>
        <div class="popupbox">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="write_title_top">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="write_td"></td>
                                    <td class="write_basic"><input class="input1" name="membername" type="text" id="membername" onblur="Checbankgul(this);"><span> ( 입금과 출금시 사용하시는 실제 예금주명으로 기입하여 주시기 바랍니다 )</span></td>
                                </tr>
                                <tr>
...
@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
    ...
    <div id="menu_pop" class="fadeIn222 popup_none">
        <div class="popup_wrap">
            <div class="close_box"><a href="#" class="menu_pop_close"><img src="/frontend/bank/bank/images/popup_close.png"></a></div>
            <div class="popupbox">
    ...
    <div id="slot_pop" class="fadeIn222 popup_none">
        <div class="popup_wrap">
            <div class="close_box"><a href="#" class="slot_pop_close"><img src="/frontend/bank/bank/images/popup_close.png"></a></div>
            <div class="popupbox">
                <div class="popup_tab_wrap">
                    <ul class="popup_tab">
                        @if ($categories && count($categories))
