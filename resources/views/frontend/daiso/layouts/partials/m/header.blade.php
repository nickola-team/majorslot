    ...
    <div class="top_menu">
        <ul>
            ...
            @else
                class="casino_1_open"
            @endif
            ><img src="/frontend/daiso/images/m_main_game1.png?v=202302021619" width="100%"></a></li>
            <li><a href="#" class="casino_3_open"><img src="/frontend/daiso/images/m_main_game3.png?v=202302021619" width="100%"></a></li>     
            @if ($logo != 'dorosi')
            <li><a href="#" 
            ...
            @else
                class="casino_2_open"
            @endif
            ><img src="/frontend/daiso/images/m_main_game2.png?v=202302021619" width="100%"></a></li>               
            <li><a href="#" 
            ...
            @else
                class="casino_4_open"
            @endif
            ><img src="/frontend/daiso/images/m_main_game4.png?v=202302021619" width="100%"></a></li>
            @endif
        </ul>
    </div>       
</div><!-- header_wrap -->