...
<body>
	...
	<div id="wrap">
		...
		@endif
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.unique.layouts.partials.m.header')
			@include('frontend.kdior.layouts.partials.m.content')
		@else
			@include('frontend.unique.layouts.partials.header')
			@include('frontend.kdior.layouts.partials.banner')
			<div class="main_contents_wrap">
				<div class="main_contents_box">
					@include('frontend.unique.layouts.partials.category')
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.unique.layouts.partials.m.aside')
		@endif
