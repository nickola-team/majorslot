...
<head>
	...
	<script type="text/javascript" src="/frontend/onyx/js/jquery-1.12.3.min.js"></script>
	<script type="text/javascript" src="/frontend/onyx/js/jquery-ui.js"></script>
	<script type="text/javascript" src="/frontend/onyx/js/TINYbox.js"></script>
	<script type="text/javascript" src="/frontend/onyx/js/jquery.vticker.min.js"></script>
	<script type="text/javascript" src="/frontend/onyx/js/jquery.bxslider.min.js"></script>

	<link rel="stylesheet" type="text/css" href="/frontend/onyx/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="/frontend/onyx/css/main.css?ver=6038" />
	<link rel="stylesheet" type="text/css" href="/frontend/onyx/css/all.css">
	<link rel="stylesheet" type="text/css" href="/frontend/onyx/css/Style_sub.css" />

    <script type="text/javascript" src="/frontend/onyx/count/jquery.counter.js"></script>

	<script type='text/javascript' src="/frontend/onyx/js/game.js?ver=5210"></script>
	<script type='text/javascript' src='/frontend/onyx/js/menu.js?ver=3007'></script>
	<script type='text/javascript' src='/frontend/onyx/js/main.js?ver=6959'></script>
	<script type='text/javascript' src='/frontend/onyx/js/fund.js?ver=5645'></script>
	<script type='text/javascript' src='/frontend/onyx/js/common.js?ver=7896'></script>


	<!-- Sweet-Alert  -->
	<script type="text/javascript" src="/frontend/onyx/js/sweetalert/sweetalert.min.js"></script>
	<script type="text/javascript" src="/frontend/onyx/js/sweetalert/jquery.sweet-alert.custom.js"></script>
	<link rel="stylesheet" href="/frontend/onyx/js/sweetalert/sweetalert.css" type="text/css">
</head>
...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/onyx/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/onyx/img/logo.png?5"/></div>
		<font>Copyright® 오닉스 CASINO. ALL RIGHT RESERVED</font>
	</footer>
