...
<head>
    ...
    <link rel="icon" href="/frontend/lucky/img/favicon.ico" >
    <meta
      name="viewport"
      content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=0"
    />
    <meta name="theme-color" content="#000000" />
      <script type="text/javascript" src="/frontend/lucky/js/app.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/jquery.number.min.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/parsley.min.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/parsley.remote.min.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/lazyload.min.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/action.js"></script>

    <script src="/frontend/lucky/js/TweenMax.min.js"></script>
    ...
    <link rel="stylesheet" href="/frontend/lucky/css/font-icon.css">
    <link rel="stylesheet" href="/frontend/lucky/css/app.css">
    <link rel="stylesheet" href="/frontend/lucky/css/style7d93.css?v=2368">
    <link rel="stylesheet" href="/frontend/lucky/css/galaxy5358.css?v=1540">
    <link rel="stylesheet" href="/frontend/lucky/css/themes/default.min.css">


    <!-- Sweet-Alert  -->
    <script type="text/javascript" src="/frontend/lucky/js/sweetalert/sweetalert.min.js"></script>
    <script type="text/javascript" src="/frontend/lucky/js/sweetalert/jquery.sweet-alert.custom.js"></script>
    <link rel="stylesheet" href="/frontend/lucky/js/sweetalert/sweetalert.css" type="text/css">

    <script type="text/javascript" src="/frontend/lucky/js/menuafee.js?v=9337"></script>
	<script type="text/javascript" src="/frontend/lucky/js/maina5e0.js?v=3289"></script>
	<script type="text/javascript" src="/frontend/lucky/js/script838b.js?v=1433"></script>
...
<div class="wrapper">
  ...
  <div class="nav-main">
		<div class="center">
			<a href="{{url('/')}}" class="gs-logo">
				<div class="container">
					<img src="/frontend/lucky/img/logo.png">
				</div>
			</a>
      ...
      <div class="nav-cont">
        <div class="link-main">
          <ul class="bs-ul">
            ...
            @endif
                <div class="icon-cont">
                  <img src="/frontend/lucky/img/icon/deposit.png">
                </div>
                <span>입금신청</span>
              </a>
            </li>
            ...
            @endif
                <div class="icon-cont">
                  <img src="/frontend/lucky/img/icon/withdraw.png">
                </div>
                <span>출금신청</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/lucky/img/icon/event.png">
                </div>
                <span>이벤트</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/lucky/img/icon/notice.png">
                </div>
                <span>공지사항</span>
              </a>
            </li>
              ...
              @endif
                <div class="icon-cont">
                  <img src="/frontend/lucky/img/icon/mypage.png">
                </div>
                <span>마이페이지</span>
              </a>
            </li>
  ...
  <div class="banner-main">
    <div class="banner-deco">
      ...
      <img class="fireball-orange" src="/frontend/lucky/img/banner/fireball-orange.png">
      ...
      <img class="king" src="/frontend/lucky/img/banner/char-1eccb.png?3">
      ...
      <img class="coins" src="/frontend/lucky/img/banner/coins.png">
      <!-- <img class="girl" src="img/banner/girl.png"> -->
      <img class="rich-man" src="/frontend/lucky/img/banner/char-2c81e.png?2">
  ...
  <div class="page-content">
    ...
    <div style="margin-top:25px;height:50px;">
      <span class="a_style">럭키 SLOT</span>
    </div>
    ...
    @if ($categories && count($categories))
          ...
          @endif
            <div class="sb-inner">
              <div class="main-cont">
                <div class="inner">
                  <img class="main-img" src="/frontend/lucky/img/slot/{{ $category->title.'.jpg' }}">
              ...
              <img class="plate" src="/frontend/lucky/img/bg/slot-plate.png">
            </div>
            <div class="icon-cont">
              <img src="/frontend/lucky/img/slot-icon2/{{ $category->title }}.png" />
            </div>
          </a>     
  ...
  <div class="footer-main">
      ...
      <div class="center">
        <img src="/frontend/lucky/img/slot-icon/Blueprint.png">
        <img src="/frontend/lucky/img/slot-icon/Booongo.png">
        <img src="/frontend/lucky/img/slot-icon/Endorphina.png">
        <img src="/frontend/lucky/img/slot-icon/GameArt.png">
        <img src="/frontend/lucky/img/slot-icon/Habanero.png">
        <img src="/frontend/lucky/img/slot-icon/Micro.png">
        <img src="/frontend/lucky/img/slot-icon/Platipus.png">
        <img src="/frontend/lucky/img/slot-icon/Playson.png">
        <img src="/frontend/lucky/img/slot-icon/Pragmatic.png">
        <img src="/frontend/lucky/img/slot-icon/RedRake.png">
        <img src="/frontend/lucky/img/slot-icon/Spinmatic.png">
        <img src="/frontend/lucky/img/slot-icon/Spinomenal.png">
        <img src="/frontend/lucky/img/slot-icon/Thunderkick.png">
      </div>
    </div>
    <div class="copyright-cont">
        <span>ⓒ COPYRIGHT  럭키  2021 ALL RIGHTS RESERVED</span>
    </div>
	</div>
