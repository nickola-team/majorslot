...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/BH/img/logo.png?5" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/BH/img/logo.png?5"/></div>
		<font>Copyright&copy; BH. ALL RIGHT RESERVED</font>
	</footer>
