...
<header>
	<ul class="nav">
		<li class="logo" onclick="goHome()"><img src="/frontend/castle/img/logo.png" alt="" /></li>
...
<footer>
		...
		<div><img src="/frontend/castle/img/logo.png"/></div>
		<font>Copyright&copy; CASTLE. ALL RIGHT RESERVED</font>
	</footer>
