@extends('frontend.crown.layouts.app')
...
{{-- <div class="quick1_wrap">
    <div class="quick1_box">
        <div class="quick1_title"><img src="/frontend/crown/crown/images/today_withdraw.png"></div>
        <div class="quick1">
...
<div class="quick2_wrap">
    <div class="quick2_box">
        <div class="quick2_title"><img src="/frontend/crown/crown/images/today_deposit.png"></div>
        <div class="quick2">
...
<div class="jackpot_left_wrap">
    <div class="crown_jackpot_box">
        <p class="jackpot_sum" id="crownjp">10,000,000</p>
    </div>
...
<div class="slideshow2_wrap">
    <div class="slideshow2_wrap_center">
        <div id="number_slideshow" class="number_slideshow">
            <ul>
                <li><a><img src="/frontend/crown/crown/images/slideshow1.jpg"></a></li>
                <li><a><img src="/frontend/crown/crown/images/slideshow1.jpg"></a></li>
<!--                <li><a><img src="/frontend/crown/crown/images/slideshow2.png"></a></li> -->
            </ul>
        ...
        @foreach($categories AS $index=>$category)
                ...
                <a href="javascript:;" onclick="openGroup('tab{{ $category->id }}', '{{ $category->href }}');" class="slot_pop_open slot-btn">
                        <div class="inner">
                            <div class="category">
                                <div class="gameicon">
                                    <img width="100%" height="76%" src="/frontend/crown/categories/{{ $category->title.'.jpg' }}" />
                                ...
                                <div class="gameborder">
                                    <img width="100%" height="100%" src="/frontend/crown/crown/images/border.png" />
                                </div>
                            </div>
        ...
        @for ($i=0;$i<$comingSoon;$i++)
            <a href="#none" onclick="Swal.fire('준비중입니다.');" class="slot-btn">
                <div class="inner">
                    <div class="category">
                        <div class="gameicon">
                            <img width="100%" height="76%" src="/frontend/crown/categories/coming_soon.png" />
                            <div style="background:black;">
                                <span style="font-size:20px;">
                                    준비중
                                </span>
...
<div id="join_pop" class="fadeIn222 popup_none">
    <div class="popup_wrap">
        <div class="close_box"><a href="#" class="join_pop_close"><img src="/frontend/crown/crown/images/popup_close.png"></a></div>
        <div class="popupbox">
...
@if((!(isset ($errors) && count($errors) > 0) && !Session::get('success', false) && Auth::check()))
    ...
    <div id="menu_pop" class="fadeIn222 popup_none">
        <div class="popup_wrap">
            <div class="close_box"><a href="#" class="menu_pop_close"><img src="/frontend/crown/crown/images/popup_close.png"></a></div>
            <div class="popupbox">
    ...
    <div id="slot_pop" class="fadeIn222 popup_none">
        <div class="popup_wrap">
            <div class="close_box"><a href="#" class="slot_pop_close"><img src="/frontend/crown/crown/images/popup_close.png"></a></div>
            <div class="popupbox">
                <div class="popup_tab_wrap">
                    <ul class="popup_tab">
                        @if ($categories && count($categories))
...
@endif
    <script>
        $( document ).ready(function() {
            ...
            console.log( "ready!" );
            var odometers = [ "#minijp", "#minorjp", "#majorjp", "#crownjp"];
            var updateTime = 1000;
