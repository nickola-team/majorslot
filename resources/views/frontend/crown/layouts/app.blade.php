...
<body>
	...
	<div id="wrap">
		@if( $detect->isMobile() || $detect->isTablet() ) 
			@include('frontend.kdior.layouts.partials.m.header', ['logo' => 'crown'])
			@include('frontend.kdior.layouts.partials.m.content')
		@else
			@include('frontend.kdior.layouts.partials.header', ['logo' => 'crown'])
		...
		@if( ($detect->isMobile() || $detect->isTablet() ) && Auth::check()) 
			@include('frontend.kdior.layouts.partials.m.aside', ['logo' => 'crown'])
		@endif
