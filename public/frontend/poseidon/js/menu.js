...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/poseidon/img/casino_title.png" /></div>
	<div id="data_box">
		<div class="dbox2">
			<div id="weekly_item2">
...
function goRemote() {
    if (loginYN == "Y") {
        ...
        <div class="subcontent">
<div id="sub_box">
<div id="sub_title"><img src="/frontend/poseidon/img/remote_title.png" /></div>
<div id="data_box">
    <div class="dbox2">
        ...
        <div class="remote_area2">
            ...
            <tr>
                <td>
                    <a href="http://download.teamviewer.com/download/TeamViewer_Setup_ko.exe" target="_blank"><img src="/frontend/poseidon/img/remote.gif" border="0" /></a><br />
...
function goRule(type) {
    if (loginYN == "Y") {
        TINY.box.show({
            iframe: "http://poseidon777.com/etc/rule/" + type + ".asp",
            width: 955,
            height: 600,
        });
    } else {
...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/poseidon/img/pay_title.png" /></div>
	<div id="data_box">
...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/poseidon/img/paypay_title.png" /></div>
	<div id="data_box">
		...
		<div class="btn"><a href="#" onClick="withdraw();"><img src="/frontend/poseidon/img/out_btn.png" border="0" /></a></div>
	</div>
</div>
</form></div>`;
...
function goBoardList(type) {
	...
	<div id="sub_box">
		<div id="sub_title">
			<img src="/frontend/poseidon/img/${type}_title.png" />
		</div>
		<div id="data_box" style="padding-top: 10px;">
			<div class="dbox1">
				<div id="line_gray">
					<table class="table100_txtwhite" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="3" align="center"><img src="/frontend/poseidon/img/line.gif" /></td>
			...
			<table class="table100" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="line">
						<img src='/frontend/poseidon/img/icon_prev01.png' border=0 align=absmiddle>&nbsp;<img src='/frontend/poseidon/img/icon_next01.png' border=0 align=absmiddle>
					</td>
				</tr>
			</table>
		</div>
