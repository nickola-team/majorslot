...
//	document.cookie = "AuthId" + "= " + "; expires=" + expireDate.toGMTString() + "; path=/";
//	document.cookie = "AuthSession" + "= " + "; expires=" + expireDate.toGMTString() + "; path=/";	
//	document.cookie = "AuthName" + "= " + "; expires=" + expireDate.toGMTString() + "; path=/";		
...
function idOnClick(objid){
	if(objid.value == ''){
		objid.style.backgroundImage='';
	}
}
function pwOnClick(objpw){
	if(objpw.value == ''){
		objpw.style.backgroundImage='';
	}
}
//function SetCookie(StrName, expiredays) {
//	var todayDate = new Date();
//	todayDate.setDate(todayDate.getDate()+expiredays);
//	document.cookie = StrName+"=1; path=/; Expires="+todayDate.toGMTString()+";";
//}
function PopCookie(LayerId,CookieName,CookieTime) {
	SetCookie(CookieName, CookieTime);
	LayerId.style.display = 'none';
}
function PopCookieCheck(FrmName,LayerId,CookieName,CookieTime) {
	if (document.forms[FrmName].chbox.checked) {
		SetCookie(CookieName, CookieTime);
	}
	LayerId.style.display = 'none';
}
