...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/lotto/img/casino_title.png" /></div>
	<div id="data_box">
		<div class="dbox2">
			<div id="weekly_item2">
...
function goRemote() {
    if (loginYN == "Y") {
        ...
        <div class="subcontent">
<div id="sub_box">
<div id="sub_title"><img src="/frontend/lotto/img/remote_title.png" /></div>
<div id="data_box">
    <div class="dbox2">
        ...
        <div class="remote_area2">
            ...
            <tr>
                <td>
                    <a href="http://download.teamviewer.com/download/TeamViewer_Setup_ko.exe" target="_blank"><img src="/frontend/lotto/img/remote.gif" border="0" /></a><br />
...
function goRule(type) {
    if (loginYN == "Y") {
        TINY.box.show({
            iframe: "http://lo-slot.com//etc/rule/" + type + ".asp",
            width: 955,
            height: 600,
        });
    } else {
...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/lotto/img/pay_title.png" /></div>
	<div id="data_box">
				...
				<tr>
					...
					<td class="line3">
						<div class="txt_area2">
							...
							<a href="javascript:money_count('50000');"><img src="/frontend/lotto/img/5man.gif" width="46" height="22" border="0" align="absmiddle" /></a>
							<a href="javascript:money_count('100000');"><img src="/frontend/lotto/img/10man.gif" width="46" height="22" border="0" align="absmiddle" /></a>
							<a href="javascript:money_count('300000');"><img src="/frontend/lotto/img/30man.gif" width="46" height="22" border="0" align="absmiddle" /></a>
							<a href="javascript:money_count('500000');"><img src="/frontend/lotto/img/50man.gif" width="46" height="22" border="0" align="absmiddle" /></a>
							<a href="javascript:money_count('1000000');"><img src="/frontend/lotto/img/100man.gif" width="46" height="22" border="0" align="absmiddle" /></a>
							<a href="javascript:money_count_hand();"><img src="/frontend/lotto/img/direct.gif" width="46" height="22" border="0" align="absmiddle" /></a>
						</div>
		...
		<div class="btn"><a href="#" onClick="deposit();"><img src="/frontend/lotto/img/in_btn.png" border="0" /></a></div>
	</div>
</div>
</form>
</div>`;
...
<div id="sub_box">
	<div id="sub_title"><img src="/frontend/lotto/img/paypay_title.png" /></div>
	<div id="data_box">
		...
		<div class="btn"><a href="#" onClick="withdraw();"><img src="/frontend/lotto/img/out_btn.png" border="0" /></a></div>
	</div>
</div>
</form></div>`;
...
function goMypage() {
	...
	<div id="sub_box">
		<div id="sub_title"><img src="/frontend/lotto/img/mypage_title.png" /></div>
		<div id="data_box">
			...
			<div class="btn"><a href="#" onclick="updateMyInfo();"><img src="/frontend/lotto/img/infochange_btn.gif" border="0" /></a></div>
		</div>
...
function goBoardList(type) {
	...
	<div id="sub_box">
		<div id="sub_title">
			<img src="/frontend/lotto/img/${type}_title.png" />
		</div>
		<div id="data_box" style="padding-top: 10px;">
			<div class="dbox1">
				<div id="line_gray">
					<table class="table100_txtwhite" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="3" align="center"><img src="/frontend/lotto/img/line.gif" /></td>
			...
			<table class="table100" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="line">
						<img src='/frontend/lotto/img/icon_prev01.png' border=0 align=absmiddle>&nbsp;<img src='/frontend/lotto/img/icon_next01.png' border=0 align=absmiddle>
					</td>
				</tr>
			</table>
		</div>
