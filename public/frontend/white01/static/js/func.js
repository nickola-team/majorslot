	   ...
	   success: function (data, status) {
		   ...
		   if (data.games.length > 0) {
                var subdata = {
                    ...
                    "title":"에볼루션",
                    "warning_ment":'<p><span style="font-size:24px"><strong>회원님은 라이브카지노 이용시 <span style="color:#00ffff">최대배팅가능금액은&nbsp;1000만원</span>까지 입니다.</strong></span></p><p><br><span style="font-size:24px"><strong>게임사들의 배팅리밋과 상관없이 자사의 운영방침이오니,&nbsp;꼭 배팅금액을 지켜주시기 바랍니다.</strong></span></p><p><span style="font-size:24px"><strong>당사는 바카라 게임만 라이선스 계약을 맺고 운영중입니다&nbsp;</strong></span></p><p><span style="font-size:24px"><strong>(코리안 스피드 바카라, 라이트닝, 배당게임, 블랙잭 ,룰렛 ,식보 ,용호,포커,메가볼 등등…<span style="color:#00ffff"> </span>)<span style="color:#ff0000">◁◀◁◀이용금지</span></strong></span></p><p><br><span style="font-size:24px"><strong>바카라를 제외한 게임사에서 제공하는 다른 게임을 이용시 불이익 받지 않도록 유의해주시길 바랍니다</strong></span></p><p><br><span style="font-size:24px"><strong><span style="color:#ff0000">바카라외 게임이용시 또는 배팅금액 초과해서 당첨시 해당건은 모두 취소처리 됩니다 (미적중시 결과처리)</span></strong></span></p><p><br><span style="font-size:24px"><strong><span style="color:#ff8c00">바카라 보너스 배팅시 (자동배팅포함) 최대 당첨금액= 2000만원 까지만 지급//초과된 금액은 모두 회수처리&nbsp;</span></strong></span></p><p><span style="font-size:24px"><strong>위 내용을 숙지하셨으면&nbsp;아래 동의버튼 체크해주시고 게임진행해주시면 감사하겠습니다.</strong></span></p>'
                }
