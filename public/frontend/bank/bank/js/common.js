        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.gamelist.length > 0) {
                    ...
                    strHtml += '<img src="/Scripts/bank/images/coming_soon.png" style="margin-top: 150px;">';
                    strHtml += '</div>';
                }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.games.length > 0) {
                ...
                strHtml += '<div style="text-align: center;">';
                strHtml += '<img src="/frontend/bank/bank/images/coming_soon.png" style="margin-top: 150px;">';
                strHtml += '</div>';
            }
