		...
		success: function (data, status) {
			...
			if (data.games.length > 0) {
				...
				for (i=0;i<data.games.length;i++)
				{
					...
					{
						htmldoc += `<a href="#" onclick="startGameByProvider('${data.games[i].provider}', '${data.games[i].gamecode}');" class="hg-btn"><div class="img-cont"><img class="main-img" src="${data.games[i].icon}" alt="" style="height: 202px;width: 232px;"></div><div class="foot"><p>${data.games[i].title}</p></div>`;
					}
					else
					{
						htmldoc += `<a href="#" onclick="startGameByProvider(null, '${data.games[i].name}');"  class="hg-btn"><div class="img-cont"><img class="main-img" src="/frontend/Default/ico/${data.games[i].name}.jpg" alt="" style="height: 202px;width: 232px;"></div><div class="foot"><p>${data.games[i].title}</p></div>`;
					}
