        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.gamelist.length > 0) {
                    ...
                    strHtml += '<img src="/Scripts/major/images/coming_soon.png" style="margin-top: 150px;">';
                    strHtml += '</div>';
                }
                ...
                for (var i = 0; i < data.games.length; i++) {
                    ...
                    if (data.games[i].provider)
                    {
                        ...
                        if(data.games[i].name != '')
                        {
                            ...
                            {
                                strHtml += '<img src="' + data.games[i].icon + '" style="width: 100%; height: 70%;" alt="' + data.games[i].title + '"></img>';
                            }
                            else {
