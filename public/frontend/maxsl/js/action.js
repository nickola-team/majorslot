                ...
                <div id="fade_2" class="slideDown popup_none popup_content" data-popup-initialized="true" aria-hidden="false" role="dialog" aria-labelledby="open_63141101" style="opacity: 1; visibility: visible; display: inline-block; outline: none; transition: all 0.3s ease 0s; text-align: left; position: relative; vertical-align: middle; overflow-y: auto;">
                    <div class="login_wrap">
                        <div class="login_close_box">
                            <a class="fade_2_close" onclick="closePopup();"><img src="/frontend/maxsl/images/popup_close.png"></a>
                        </div>
                        <div class="login_box_wrap">
                            <div class="login_tit">
                                <img src="/frontend/maxsl/images/in_login_logo.png">
                            </div>
                            <div class="login">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="login_td3" onclick="loginSubmit(mainLogin_form);">
                                                    <a><img src="/frontend/maxsl/images/login_btn.png"></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            >
                ...
                <div class="close_box">
                    <a class="fade_3_close" onclick="closePopup();"><img src="/frontend/maxsl/images/popup_close.png" /></a>
                </div>
...
function showProfilePopup() {
    ...
    <div class="popup-content" style="
        ...
        <div class="popup_wrap">
            <div class="close_box">
            <a href="#" class="fade_1_close" onclick="closePopup();"><img src="/frontend/maxsl/images/popup_close.png" /></a>
            </div>
            <div class="popupbox">
            <div class="popup_tab_wrap">
                <ul class="popup_tab">
                <li class="tab1" data-target="#popuptab_cont1">
                    <a onclick="showDepositPopup();"><span><img src="/frontend/maxsl/images/gnb01.png" /> 입금신청</span></a>
                </li>
                <li class="tab2" data-target="#popuptab_cont2">
                    <a onclick="showWithdrawPopup();"><span><img src="/frontend/maxsl/images/gnb02.png" /> 출금신청</span></a>
                </li>
                <li class="tab7" data-target="#popuptab_cont7">
                    <a onclick="showNotificationPopup();"><span><img src="/frontend/maxsl/images/gnb07.png" /> 공지사항</span></a>
                </li>
                <li class="tab8" data-target="#popuptab_cont8">
                    <a><span><img src="/frontend/maxsl/images/gnb08.png" /> 마이페이지</span></a>
                </li>
                <li class="tab9 popupactive" data-target="#popuptab_cont9">
                    <a onclick="showContactPopup();"><span><img src="/frontend/maxsl/images/gnb05.png" /> 고객센터</span></a>
                </li>
    ...
    var strHtml = `
        ...
        <div class="popup-content "
            ...
            <div id="fade_2" class="slideDown popup_none popup_content" data-popup-initialized="true" aria-hidden="false"
                ...
                style="opacity: 1; visibility: visible; display: inline-block; outline: none; transition: all 0.3s ease 0s; text-align: left; position: relative; vertical-align: middle; overflow-y: auto; height: 600px;">
                <div class="popup_wrap">
                    <div class="close_box" onclick="closePopup();"><a href="#" class="fade_1_close"><img src="/frontend/maxsl/images/popup_close.png"></a>
                    </div>
                    <div class="popupbox">
                        <div class="popup_tab_wrap">
                            <ul class="popup_tab">
                            <li class="tab1" data-target="#popuptab_cont1">
                                <a><span><img src="/frontend/maxsl/images/gnb01.png" /> 입금신청</span></a>
                            </li>
                            <li class="tab2" data-target="#popuptab_cont2">
                                <a onclick="showWithdrawPopup();"><span><img src="/frontend/maxsl/images/gnb02.png" /> 출금신청</span></a>
                            </li>
                            ...
                            <li class="tab8" data-target="#popuptab_cont8">
                                <a onclick="showProfilePopup();"><span><img src="/frontend/maxsl/images/gnb08.png" /> 마이페이지</span></a>
                            </li>
                            <li class="tab9 popupactive" data-target="#popuptab_cont9">
                                <a onclick="showContactPopup();"><span><img src="/frontend/maxsl/images/gnb05.png" /> 고객센터</span></a>
                            </li>
                ...
                <div class="popup_wrap">
                    ...
                    <div class="popupbox">
                        <div class="popup_tab_wrap">
                            ...
                            <li class="tab2" data-target="#popuptab_cont2">
                                <a><span><img src="/frontend/maxsl/images/gnb02.png" /> 출금신청</span></a>
                            </li>
                            <li class="tab7" data-target="#popuptab_cont7">
                                <a onclick="showNotificationPopup();"><span><img src="/frontend/maxsl/images/gnb07.png" /> 공지사항</span></a>
                            </li>
...
function showNotificationPopup() {
    ...
    <div class="popup-content "
        ...
        <div id="fade_2" class="slideDown popup_none popup_content" data-popup-initialized="true" aria-hidden="false"
            ...
            style="opacity: 1; visibility: visible; display: inline-block; outline: none; transition: all 0.3s ease 0s; text-align: left; position: relative; vertical-align: middle; overflow-y: auto; height: 600px;">
            <div class="popup_wrap">
                <div class="close_box"><a class="fade_1_close" onclick="closePopup();"><img src="/frontend/maxsl/images/popup_close.png"></a></div>
                <div class="popupbox">
                    <div class="popup_tab_wrap">
                            <ul class="popup_tab">
                            <li class="tab1" data-target="#popuptab_cont1">
                            ...
                            <li class="tab7" data-target="#popuptab_cont7">
                                <a><span><img src="/frontend/maxsl/images/gnb07.png" /> 공지사항</span></a>
                            </li>
                            <li class="tab8" data-target="#popuptab_cont8">
                                <a onclick="showProfilePopup();"><span><img src="/frontend/maxsl/images/gnb08.png" /> 마이페이지</span></a>
                            </li>
            ...
            <div class="popup_wrap">
                ...
                <div class="popupbox">
                     <div class="popup_tab_wrap">
                            ...
                            <li class="tab9 popupactive" data-target="#popuptab_cont9">
                                <a><span><img src="/frontend/maxsl/images/gnb05.png" /> 고객센터</span></a>
                            </li>
                            <li class="tab10" data-target="#popuptab_cont10"></li>
                            </ul>
                        </div>
