...
! function() {
    ...
    ! function(c) {
        ...
        ! function c(l, v) {
            ...
            "function" == typeof t.hooks.addPack ? t.hooks.addPack(l, h) : t.styles[l] = f({}, t.styles[l] || {}, h), "fas" === l && c("fa", v)
        }("fab", r)
    })
}(),
function() {
...
function() {
    ...
    var e = (l.navigator || {}).userAgent,
        ...
        t = z,
        r = !!m.document,
        M = !!f.documentElement && !!f.head && "function" == typeof f.addEventListener && "function" == typeof f.createElement,
        ...
        u = ["class", "data-prefix", "data-icon", "data-fa-transform", "data-fa-mask"],
        d = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(C.map(function(c) {
            return c + "x"
    ...
    function j(l) {
        var c = (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}).asNewDefault,
            h = void 0 !== c && c,
            v = Object.keys(O),
            z = h ? function(c) {
    ...
    var N = m || {};
    N[i] || (N[i] = {}), N[i].styles || (N[i].styles = {}), N[i].hooks || (N[i].hooks = {}), N[i].shims || (N[i].shims = []);
    var E = N[i],
        P = [],
        _ = !1;
    M && ((_ = (f.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(f.readyState)) || f.addEventListener("DOMContentLoaded", function c() {
        f.removeEventListener("DOMContentLoaded", c), _ = 1, P.map(function(c) {
            return c()
        })
    }));
    var T = function(c) {
    ...
    function R(c) {
        if (c && M) {
            ...
            for (var h = f.head.childNodes, v = null, z = h.length - 1; - 1 < z; z--) {
                var e = h[z],
                    a = (e.tagName || "").toUpperCase(); - 1 < ["STYLE", "LINK"].indexOf(a) && (v = e)
            }
        ...
        Z = function(c) {
            var l = c.children,
                ...
                M = {
                    ...
                    children: [{
                        tag: "path",
                        attributes: k({}, m.attributes, f.path, {
                            fill: "black"
                        })
                    }]
                },
    ...
    function hc(c) {
        ...
        r && (o.attributes[g] = ""), s && o.children.push({
            tag: "title",
            attributes: {
    ...
    var zc = function() {},
        ec = O.measurePerformance && t && t.mark && t.measure ? t : {
            mark: zc,
            measure: zc
        },
        ac = 'FA "5.0.10"',
        ...
        tc = function(c, l, h, v) {
            var z, e, a, m, s, t = Object.keys(c),
                f = t.length,
                r = void 0 !== v ? (m = l, s = v, function(c, l, h, v) {
    ...
    function gc(h, c) {
        ...
        0 === h.length ? v() : (m.requestAnimationFrame || function(c) {
            ...
            var c = !0 === O.autoReplaceSvg ? bc.replace : bc[O.autoReplaceSvg] || bc.replace,
                l = sc.begin("mutate");
            h.map(c), l(), v()
        })
    }
    ...
    var Sc = function(c) {
            var l, h, v, z, e = c.getAttribute("data-prefix"),
                ...
                s = Cc(X(c));
            return e && a && (s.prefix = e, s.iconName = a), s.prefix && 1 < m.length ? s.iconName = (v = s.prefix, z = c.innerText, ic[v][z]) : s.prefix && 1 === m.length && (s.iconName = (l = s.prefix, h = function(c) {
    ...
    function Xc(c) {
        var l, h, v, z, e, a, m, s, t, f, r, M, i, n, H, V, o, C, L, u = (h = Sc(l = c), v = h.iconName, z = h.prefix, e = h.rest, a = kc(l), m = Ac(l), s = qc(l), t = Oc(l), f = jc(l), {
            iconName: v,
        ...
        return ~u.extra.classes.indexOf(Rc) ? function(c, l) {
            var h = l.title,
                v = l.transform,
                z = l.extra,
                e = null,
        ...
        }(c, u) : (r = c, i = (M = u).iconName, n = M.title, H = M.prefix, V = M.transform, o = M.symbol, C = M.mask, L = M.extra, [r, hc({
            icons: {
                main: Dc(i, H),
                mask: Dc(C.iconName, C.prefix)
            },
            prefix: H,
            iconName: i,
            transform: V,
    ...
    function Uc(c) {
        if (M) {
            ...
            yc = !0,
                function() {
                    D(c.querySelectorAll("*")).forEach(function(a) {
                        [":before", ":after"].forEach(function(l) {
                            var c = m.getComputedStyle(a, l),
                                h = c.getPropertyValue("font-family").match(Wc),
                                v = D(a.children).filter(function(c) {
                                    return c.getAttribute(H) === l
                                })[0];
                            if (v && (v.nextSibling && -1 < v.nextSibling.textContent.indexOf(H) && Yc(v.nextSibling), Yc(v), v = null), h && !v) {
                                var z = c.getPropertyValue("content"),
                                    e = f.createElement("i");
                                e.setAttribute("class", "" + Bc[h[1]]), e.setAttribute(H, l), e.innerText = 3 === z.length ? z.substr(1, 1) : z, ":before" === l ? a.insertBefore(e, a.firstChild) : a.appendChild(e)
                            }
                        })
                    })
                }(), yc = !1, l()
    ...
    function Kc(c) {
        ...
        if (M) {
            var h = f.documentElement.classList,
                ...
                e = Object.keys(Ic),
                a = ["." + Rc + ":not([" + g + "])"].concat(e.map(function(c) {
                    return "." + c + ":not([" + g + "])"
                })).join(", ");
            if (0 !== a.length) {
        ...
        return w(c, [{
            ...
            value: function() {
                ...
                Object.keys(z).forEach(function(c) {
                    l.definitions[c] = k({}, l.definitions[c] || {}, z[c]),
                        function c(l, v) {
                            var h = Object.keys(v).reduce(function(c, l) {
                                var h = v[l];
                                return h.icon ? c[h.iconName] = h.icon : c[l] = h, c
                            }, {});
                            "function" == typeof E.hooks.addPack ? E.hooks.addPack(l, h) : E.styles[l] = k({}, E.styles[l] || {}, h), "fas" === l && c("fa", v)
                        }(c, z[c])
                })
            }
        }, {
                ...
                0 < Object.keys(E.styles).length && ml(), O.observeMutations && "function" == typeof MutationObserver && function(c) {
                    if (s) {
                        var z = c.treeCallback,
                            e = c.nodeCallback,
                            a = c.pseudoElementsCallback;
                        wc = new s(function(c) {
                            yc || D(c).forEach(function(c) {
                                if ("childList" === c.type && 0 < c.addedNodes.length && !pc(c.addedNodes[0]) && (O.searchPseudoElements && a(c.target), z(c.target)), "attributes" === c.type && c.target.parentNode && O.searchPseudoElements && a(c.target.parentNode), "attributes" === c.type && pc(c.target) && ~u.indexOf(c.attributeName))
                        ...
                        }), M && wc.observe(f.getElementsByTagName("body")[0], {
                            childList: !0,
                            attributes: !0,
                            characterData: !0,
                            subtree: !0
