...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function _background(snap, state) {
            ...
            } else if (this.details.context.bs_count === 15 || this.details.context.pearls_count === 15) {
                snap.rect(0, 0, this.width, this.height).attr({
                    'fill': '#6B8E23'
                })
            } else {
        ...
        value: function is_extra_snap(details) {
            return details.state == 'bonus' && (this.details.context.bs_count === 15 || this.details.context.pearls_count === 15) || details.state == 'freespins' && details.context.winscatters != undefined && details.context.winscatters.length > 0
        }
    }, {
        key: 'make_extra_snap',
        value: function make_extra_snap(details, combsGroup, margin, snap) {
            ...
            if (details.state == 'bonus' && (this.details.context.bs_count === 15 || this.details.context.pearls_count === 15)) {
                labelLeft = 'Jackpot !';
