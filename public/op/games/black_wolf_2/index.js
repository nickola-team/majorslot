...
var CONFIG = {
    ...
    states: (_states = {}, _defineProperty(_states, GAME.SPINS, [{
        condition: CONDITION.WIN_MYSTERY,
        pages: [PAGE.WIN_MYSTERY]
    }, {
        condition: CONDITION.WIN_ALL,
        pages: [PAGE.WIN_ALL]
    }, {
        condition: CONDITION.WIN_BOOST,
        pages: [PAGE.WIN_BOOST, PAGE.INFO_WIN_BOOST]
    }, {
        ...
        condition: CONDITION.NOWIN_BOOST,
        pages: [PAGE.NOWIN_BOOST]
    }, {
        ...
        condition: CONDITION.WIN_SCATTERS,
        pages: [PAGE.GAME_FREESPINS, PAGE.INFO_FREESPINS_ADDITIONAL]
    }, {
        condition: CONDITION.WIN_BONUS,
        pages: [PAGE.GAME_BONUS]
    }, {
        ...
        condition: CONDITION.BONUS_WIN_MYSTERY,
        pages: [PAGE.BONUS_WIN_MYSTERY, PAGE.BONUS_WIN_BONUS]
    }, {
        condition: CONDITION.BONUS_WIN_MYSTERY_AND_JACKPOT,
        pages: [PAGE.BONUS_WIN_MYSTERY]
    }, {
        condition: CONDITION.BONUS_WIN_BONUS,
        pages: [PAGE.BONUS_WIN_BONUS]
    }, {
        condition: CONDITION.BONUS_WIN_BOOST,
        pages: [PAGE.BONUS_WIN_BOOST, PAGE.INFO_WIN_BOOST]
    }, {
...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function make_snap(details) {
            ...
            this._calculateSizes(this.cols, this.rows);
            this.cellOffsetX = 3;
            this.boardMarginLeft = parseInt((this.width - (this.cellWidth + this.cellOffsetX) * this.cols) / 2, 10) + 2;
        ...
        value: function board(snap, _board) {
            var _this3 = this;
            var lines = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
            var isOpacity = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
            var group = snap.group();
            var imageUrl = void 0;
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(_j) {
                    ...
                    if (id === _this3.bonus_id) {
                        var isMoreX5 = _this3.symbolValueMoreX5(i, _j);
                        if (isMoreX5) id = 16
                    }
                    imageUrl = _this3.url("sym" + id + ".png");
                    var img = group.image(imageUrl, _this3.cellWidthSize * i, _this3.cellHeigthSize * _j, _this3.cellWidth, _this3.cellHeight);
                    if (!isOpacity) return "continue";
                    var find = lines && !!lines.find(function(line) {
                        return line.positions.find(function(pos) {
                            return pos[0] === +i && pos[1] === +_j
                        })
                    });
            ...
            if (typeof this.details.context.bs !== "undefined") {
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;
                try {
                    for (var _iterator = this.details.context.bs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var moon = _step.value;
                        var i = moon.reel;
                        var j = moon.position;
                        if (_board[i][j] != this.mystery_id) {
                            var value = void 0;
                            if (moon.value == this.mini_jp * round_bet) {
                                value = "mini"
                            } else if (moon.value == this.minor_jp * round_bet) {
                                value = "minor"
                            } else if (moon.value == this.major_jp * round_bet) {
                                value = "major"
                            } else {
                                value = (+moon.value / 100).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                            }
                            var rect_x = this.cellWidthSize * i + this.cellOffsetX * 0.5 + 0.5;
                            var rect_y = this.cellHeigthSize * j + this.cellHeight / 3;
                            var rect_width = this.cellWidth - this.cellOffsetX;
                            var text_x = rect_x + rect_width / 2;
                            var text_y = this.cellHeigthSize * j + this.cellHeight / 2;
                            group.rect(rect_x, rect_y, rect_width, this.cellHeight / 3).attr({
                                "fill": "white"
                            });
                            if (value == "mini") {
                                if (this.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MINI_65)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MINI_45)
                                }
                            } else if (value == "minor") {
                                if (this.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MINOR_65)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MINOR_45)
                                }
                            } else if (value == "major") {
                                if (this.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MAJOR_65)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.PEARL_MAJOR_45)
                                }
                            } else {
                                if (value < 100000) {
                                    if (this.width > 200) {
                                        group.text(text_x, text_y, value).attr(Drawer.PEARL_VALUE_52)
                                    } else {
        ...
        value: function drawe_border_win_symbols(snap, line) {
            ...
            for (var i = 0; i < line.positions.length; ++i) {
                var cell = line.positions[i];
                if (!isItemInArray(this.bordered_cells, cell)) {
                    group.rect(cell[0] * this.cellWidthSize - this.cellOffsetX * 0.5, cell[1] * this.cellHeigthSize, this.cellWidthSize, this.cellHeigthSize).attr(BaseDrawer.STYLE_LINE_SYMBOL);
                    this.bordered_cells.push(cell)
                }
            }
            return group
        ...
        value: function drawe_line_patern(snap, line) {
            ...
            if (typeof line["trigger"] === "undefined") {
                ...
                var posX = width * 0.5 - this.cellOffsetX * 0.5;
                var posY = height * 0.4 - this.cellOffsetY * 0.5;
                var path = "M" + posX + ",";
        ...
        value: function screenPassMethodGet(condition) {
            switch (condition) {
                ...
                case CONDITION.INFO_BONUS_TOTAL:
                    return this.passBonusTotalInfo.bind(this);
                ...
                case CONDITION.WIN_BONUS:
                    return this.passBonusScatterWin.bind(this);
        ...
        value: function passInfo(screenData) {
            ...
            var isInfo = action.indexOf("_init") >= 0 || action.indexOf("_stop") >= 0;
            return isInfo
        }
    }, {
        key: "passDefault",
        ...
        value: function passWinAll(screenData) {
            ...
            return isReel && win > 0 && (isWinlines || isWinline && boost_win > 0 || isWinline && isFreespins)
        }
    }, {
        key: "passScatterWin",
        ...
        key: "passBonusScatterWin",
        value: function passBonusScatterWin(screenData) {
            var _this6 = this;
            ...
            var isWinscatters = winscatters && winscatters.length > 0;
            var list = winscatters && winscatters.find(function(data) {
                return data.symbol === _this6.bonus_id && data.trigger === GAME.BONUS
            });
            var isBSScatters = isWinscatters && !!list;
            return isReel && !restore && !isInfo && isBSScatters
        }
    }, {
        key: "passMysteryWin",
        ...
        value: function passBonusTotalInfo(screenData) {
            ...
            var isInfo = this.passInfo(screenData);
            return isRespin && !restore && !isInfo && state === GAME.BONUS && rounds_left === 0
        }
    }, {
        key: "passBoost",
        ...
        value: function passBonusWin(screenData) {
            ...
            var new_bs = context.new_bs,
                tigers = context.tigers,
                boost_win = context.boost_win,
                bs_count = context.bs_count;
            var bsLength = new_bs ? new_bs.length : 0;
            var tigerLength = tigers ? tigers.length : 0;
            var isRespin = this.passRespinGameType(screenData);
            return isRespin && !restore && action === "respin" && bsLength > 0 && bs_count < 20 && tigerLength === 0 && !boost_win
        }
    }, {
        ...
        value: function passBonusJackpot(screenData) {
            ...
            var rounds_left = context.rounds_left,
                bs_count = context.bs_count;
            var isRespin = this.passRespinGameType(screenData);
            return isRespin && !restore && state === GAME.BONUS && bs_count >= 20 && rounds_left === 0
        }
    }, {
        ...
        value: function passBonusDefault(screenData) {
            ...
            var isRespin = this.passRespinGameType(screenData);
            var isInfo = this.passInfo(screenData);
            return isRespin && !isInfo && state === GAME.BONUS && bs_count < 20 && !boost_win && (bsLength === 0 || restore)
        }
    }, {
        key: "premodSet",
        ...
        value: function premodListGet(screenData) {
            ...
            Object.keys(config).map(function(name) {
                ...
                var methods = _this7.premodMethodGet(name);
        ...
        value: function pageListGet(screenData) {
            ...
            screenData.conditions.map(function(condition) {
                condition.pages.map(function(pageName) {
                    var pageData = _this10.pagesByNameGet({
                        pageName: pageName,
                        condition: condition,
        ...
        value: function pagesByNameGet(pageOptions) {
            ...
            switch (pageName) {
                ...
                case PAGE.WIN_BOOST:
                    return this.pageBoostWin(pageOptions);
                case PAGE.WIN_ALL:
                    return this.pageWinAll(pageOptions);
                case PAGE.WIN:
                    return this.pageWinList(pageOptions);
                case PAGE.NOWIN_BOOST:
                    return this.pageNoWinBoost(pageOptions);
        ...
        value: function pageDefault(pageOptions) {
            ...
            var tigers = screenData.context.tigers || [];
            var page = {
                current: 1,
                total: 1
            };
        ...
        value: function pageFreespinsWinInfo(pageOptions) {
            ...
            var left = context.rounds_left || 8;
            pageData.info.text = "+8 FreeSpins";
            return pageData
        }
    }, {
        key: "pageNoWinBoost",
        value: function pageNoWinBoost(pageOptions) {
            var screenData = pageOptions.screenData;
            var restore = screenData.restore;
            var pageData = this.pageDefault(pageOptions);
            var title = this.titleWinPrefixAdd(pageData.title, 0);
            pageData.title = restore ? pageData.title : title;
            return pageData
        }
    }, {
        ...
        value: function pageBonusTotalInfo(pageOptions) {
            ...
            if (total_win_state) sum = total_win_state;
            var texts = ["Total Win:", this.coins(sum)];
            delete info.text;
            info.texts = texts;
            return pageData
        }
        ...
        value: function pageWinAll(pageOptions) {
            ...
            if (boost_win) {
                var line = this.lineCreate(board, this.boost_id);
                var bonusLine = context.winscatters.concat([]);
                bonusLine[0].positions = bonusLine[0].positions.concat(line.positions);
        ...
        value: function pageWinList(pageOptions) {
            ...
            context.winlines.map(function(winline) {
                ...
                var title = _this11.titleWinPrefixAdd(pageData.title, win);
                var data = {
                    title: title,
                    name: name,
                    action: action,
        ...
        key: "pageBoostWin",
        value: function pageBoostWin(pageOptions) {
            var _this12 = this;
            var pageData = this.pageDefault(pageOptions);
            var screenData = pageOptions.screenData;
            var context = screenData.context;
            ...
            var bonusLine = context.winscatters.find(function(line) {
                return line.symbol === _this12.bonus_id
            });
        ...
        value: function pageFreespinsGameWin(pageOptions) {
            ...
            var line = context.winscatters.find(function(line) {
                return line.symbol === _this13.scat_id
            });
        ...
        value: function pageBonusGameWin(pageOptions) {
            ...
            var pageData = this.pageDefault(pageOptions);
            var line = context.winscatters.find(function(line) {
                return line.symbol === _this14.bonus_id
            });
        ...
        value: function pageBonusNoWin(pageOptions) {
            ...
            pageData.title = this.titleWinPrefixAdd(pageData.title, rounds_left === 0 ? total_win_state : 0);
            return pageData
        }
    }, {
        ...
        value: function pageBonusBoostWin(pageOptions) {
            ...
            var title = pageData.title,
                board = pageData.board;
            var bonusLine = context.winscatters.find(function(line) {
                return line.symbol === _this15.bonus_id
            });
            var boostLine = this.lineCreate(board, this.boost_id);
            pageData.title = this.titleWinPrefixAdd(title, boost_win);
            pageData.win = boost_win;
        ...
        value: function pageBonusJackpot(pageOptions) {
            ...
            var total_win_state = context.total_win_state;
            var pageData = this.pageDefault(pageOptions);
            var line = this.lineCreate(board, this.bonus_id);
            var calcWin = total_win_state ? total_win_state : win;
            pageData.lines = [line];
        ...
        value: function drawTitle(screenData, pageData) {
            ...
            var isBoostWithWinline = page.total === 1 && boost_win > 0 && winlines && winlines.length >= 1;
            var isFreespinsWithWinline = page.total === 1 && this.isFreespinsStarted(context) && winlines && winlines.length >= 1;
            var isPages = page && !page.screen && (page.total > 1 || isBoostWithWinline || isFreespinsWithWinline);
        ...
        value: function drawView(screenData, pageData) {
            ...
            group.transform("T" + this.boardMarginLeft + "," + (this.panelHeight + 6));
        ...
        value: function drawSymbols(group, screenData, pageData) {
            ...
            var isOpacity = name.indexOf("bonus") === -1 && !(name === "win_all" && lines.length > 1);
            var symbols = this.board(group, board, lines, isOpacity);
        ...
        value: function drawBorders(group, screenData, pageData) {
            ...
            lines.map(function(line) {
                return _this16.drawe_border_win_symbols(bordersGroup, line)
            });
        ...
        value: function drawLines(group, screenData, pageData) {
            ...
            lines.map(function(line) {
                return _this17.drawe_line_patern(linesGroup, line)
            });
        ...
        value: function title(screenData) {
            if (screenData.restore) {
                ...
                return "Bonus(" + screenData.context.rounds_left + ")"
            } else {
                return "Spin"
            }
        }
        ...
        key: "lineCreate",
        value: function lineCreate(board, symbolID) {
            var occurrences = 0;
            ...
            var positions = this.positionsSymbolFromBoardGet(board, symbolID);
            return {
                symbol: symbolID,
        ...
        value: function positionsSymbolFromBoardGet(board, symbolID) {
            var positions = [];
            board.map(function(column, columnIndex) {
                column.map(function(symbol, rowIndex) {
                    if (symbol !== symbolID) return;
