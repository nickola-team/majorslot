        ...
        value: function board(snap, _board) {
            ...
            var _loop = function _loop(_i2) {
                var _loop2 = function _loop2(_j) {
                    ...
                    } else if (_this3.details.state === 'bonus' && bonus_symbols.indexOf(_board[_i2][_j]) == -1) {
                        imageUrl = _this3.url('0.png')
                    } else if (_board[_i2][_j] === 11 && _this3.details.context.is_super_state && !sb_first_snap) {
                    ...
                    if (value != 0 && !show_mystery && (_board[_i2][_j] == 11 || _board[_i2][_j] == 12)) {
