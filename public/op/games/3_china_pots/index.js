    ...
    _createClass(Drawer, [{
        ...
        value: function make_spins(details) {
            ...
            if (this.get_pearls_count(this.details) >= 1 && ['spin', 'freespin'].includes(this.details.last_action) && this.details.context.bac_win == true) {
                ...
                for (var i in game_board) {
                    for (var j in game_board[i]) {
                        if ([].concat(BONUS_SYMBOLS).includes(game_board[i][j])) {
            ...
            if (combs.length > 1 || game_boards.length > 1) {
                for (var _i in combs) {
                    combGroup = this._comb(combsGroup, combs, combs[_i], details);
                    margin += this.width;
                    combGroup.transform('T' + margin + ',0')
                }
            }
        ...
        value: function board(snap, _board) {
            ...
            if (this.get_pearls_count(this.details) >= 1 && ['spin', 'freespin'].includes(this.details.last_action) && this.details.context.bac_win == true) {
                ...
                for (var i in _board) {
                    for (var j in _board[i]) {
                        if ([].concat(BONUS_SYMBOLS).includes(_board[i][j])) {
                            winbonus.positions.push([i, j])
                        }
                    }
                }
            ...
            if (this.details.state === 'bonus' && this.details.context.bonus_mechanic.includes(2)) {
                for (var _i3 in _board) {
                    scaled_bs_v[_i3] = this.details.context.bs_v_2[_i3].concat([0], this.details.context.bs_v[_i3])
                }
                if (this.details.context.bonus_mechanic.includes(3)) {
                    for (var _i4 in _board) {
                        scaled_mults[_i4] = this.details.context.multipliers_2[_i4].concat([0], this.details.context.multipliers[_i4])
                    }
                }
            }
            var curr_board = {};
            ...
            if (this.details.state === 'bonus' && this.details.context.bonus_mechanic.includes(3)) {
                if (this.details.context.bonus_mechanic.includes(2)) {
                    if (this.details.context.mult_win_2 != undefined) {
                        ...
                        for (var _j in _board) {
                            if (this.details.context.mult_win != undefined) {
                                mult_win_2.bs_v.push(this.details.context.mult_orig_bs_v_2[_j].concat([0], this.details.context.us_orig_bs_v[_j]))
                            } else {
                                mult_win_2.bs_v.push(this.details.context.mult_orig_bs_v_2[_j].concat([0], this.details.context.bs_v[_j].slice(-3)))
                            }
                        }
                        combs.push(mult_win_2)
                    }
                    if (this.details.context.mult_win != undefined) {
                        ...
                        for (var _i5 in this.details.context.mult_win.pos) {
                            var pos = this.details.context.mult_win.pos[_i5];
                            mult_win.positions.push(pos)
                        }
                        for (var _j2 in _board) {
                            if (this.details.context.mult_win_2 != undefined) {
                                mult_win.bs_v.push(this.details.context.mult_orig_bs_v_2[_j2].concat([0], this.details.context.us_orig_bs_v[_j2]))
                            } else {
                                var part_1 = this.details.context.bs_v[_j2].slice(0, 3);
                                mult_win.bs_v.push(part_1.concat([0], this.details.context.mult_orig_bs_v[_j2]))
                            }
                        }
                        combs.push(mult_win)
                    }
                ...
                if (rounds_left == 0) {
                    ...
                    if (this.details.context.bonus_mechanic.includes(2)) {
                        for (var _i6 in _board) {
                            e_m.bs_v[_i6] = this.details.context.mult_orig_bs_v_2[_i6].concat([0], this.details.context.mult_orig_bs_v[_i6]);
                            for (var _j3 in _board[_i6]) {
                                if (e_m.bs_v[_i6][_j3] > 1) {
                                    e_m.positions.push([_i6, _j3])
                                }
                            }
                        }
                    } else {
                    ...
                    for (var _i7 in _board) {
                        for (var _j4 in _board[_i7]) {
                            if (e_m.bs_v[_i7][_j4] > 1) {
                                e_m.positions.push([_i7, _j4])
                            }
                        }
                    }
                    combs.push(e_m)
                ...
                if (rounds_left == 0) {
                    ...
                    if (this.details.context.bonus_mechanic.includes(2)) {
                        for (var _i8 in _board) {
                            _e_m2.bs_v[_i8] = this.details.context.bs_v_2[_i8].concat([0], this.details.context.bs_v[_i8]);
                            for (var _j5 in _board[_i8]) {
                                if (_e_m2.bs_v[_i8][_j5] > 1) {
                                    _e_m2.positions.push([_i8, _j5])
                                }
                            }
                        }
                    } else {
                    ...
                    for (var _i9 in _board) {
                        for (var _j6 in _board[_i9]) {
                            if (_e_m2.bs_v[_i9][_j6] > 1) {
                                _e_m2.positions.push([_i9, _j6])
                            }
                        }
                    }
                    combs.push(_e_m2)
            ...
            var _loop = function _loop(_i10) {
                var _loop2 = function _loop2(_j7) {
                    ...
                    imageUrl = _this4.url(_board[_i10][_j7] + '.png');
                    var img = void 0;
                    if (_this4.details.state === 'bonus' && ![].concat(BONUS_SYMBOLS).includes(_board[_i10][_j7])) {
                        imageUrl = _this4.url('0.png');
                        if (_this4.details.context.bonus_mechanic.includes(3)) {
                            var m_v = _this4.details.context.multipliers[_i10][_j7];
                            if (_this4.details.state === 'bonus' && _this4.details.context.bonus_mechanic.includes(2)) {
                                if (_this4.details.context.bonus_mechanic.includes(3)) {
                                    m_v = scaled_mults[_i10][_j7]
                                }
                            }
                        ...
                        img = group.image(imageUrl, _this4.cellWidth * _i10, (_this4.cellHeight + _this4.cellOffsetY) * _j7, _this4.cellWidth, _this4.cellHeight)
                    } else {
                        var _extraOffset = (_this4.cellWidth - _this4.cellWidth / widthCoef) / 2;
                        img = group.image(imageUrl, (_this4.cellWidth + _this4.cellOffsetX) * _i10 + _extraOffset, (_this4.cellHeight + _this4.cellOffsetY) * _j7, _this4.cellWidth / widthCoef, _this4.cellHeight)
                    }
                    if (currentWinLine !== -1) {
                    ...
                    if (_this4.details.context.bs_v != undefined) {
                        value = _this4.details.context.bs_v[_i10][_j7];
                        if (_this4.details.state === 'bonus' && _this4.details.context.bonus_mechanic.includes(2)) {
                            value = scaled_bs_v[_i10][_j7]
                        }
                        if (currentWinLine !== -1 && combs[currentWinLine].bs_v != undefined) {
                            ...
                            if (isUS == true) {
                                value = combs[currentWinLine].bs_v[_i10][_j7]
                            }
                        }
                    } else if (_this4.details.context.bonus_symbols_v != undefined) {
                        value = _this4.details.context.bonus_symbols_v[_i10][_j7]
                    }
                    if (combs[currentWinLine] !== undefined) {
                    ...
                    if (_this4.details.context.multipliers) {
                        mult_value = _this4.details.context.multipliers[_i10][_j7]
                    }
                    if (_this4.details.state === 'bonus' && _this4.details.context.bonus_mechanic.includes(2)) {
                        if (_this4.details.context.bonus_mechanic.includes(3)) {
                            mult_value = scaled_mults[_i10][_j7]
                        }
                    }
                    if (mult_value && _this4.details.round_win === 0) {
                        var rect_x = (_this4.cellWidth + _this4.cellOffsetX) * _i10 + _this4.cellWidth / 1.77;
                        var rect_y = (_this4.cellHeight + _this4.cellOffsetY) * _j7 - _this4.cellOffsetY + 0.5;
                        var rect_width = _this4.cellWidth / 2.3 + 2 * _this4.cellOffsetX;
                        var text_x_x = rect_x + rect_width / 2;
                        var text_x_y = (_this4.cellHeight + _this4.cellOffsetY) * _j7 + _this4.cellOffsetY + _this4.cellHeight * 0.18;
                    ...
                    if (mult_value && _this4.details.round_win > 0 && combs[currentWinLine] !== undefined) {
                        if (combs[currentWinLine].trigger != 'mult_after') {
                            var _rect_x = (_this4.cellWidth + _this4.cellOffsetX) * _i10 + _this4.cellWidth / 1.77;
                            var _rect_y = (_this4.cellHeight + _this4.cellOffsetY) * _j7 - _this4.cellOffsetY + 0.5;
                            var _rect_width = _this4.cellWidth / 2.3 + 2 * _this4.cellOffsetX;
                            var _text_x_x = _rect_x + _rect_width / 2;
                            var _text_x_y = (_this4.cellHeight + _this4.cellOffsetY) * _j7 + _this4.cellOffsetY + _this4.cellHeight * 0.18;
                    ...
                    if (value != 0 && [10, 11, 12, 13].includes(_board[_i10][_j7])) {
                        var _rect_x2 = (_this4.cellWidth + _this4.cellOffsetX) * _i10 - _this4.cellOffsetX;
                        var _rect_y2 = (_this4.cellHeight + _this4.cellOffsetY) * _j7 + _this4.cellHeight / 2.7 - _this4.cellHeight * 0.04;
                        if (_this4.details.state === 'bonus' && _this4.details.context.bonus_mechanic.includes(2)) {
                            _rect_y2 = (_this4.cellHeight + _this4.cellOffsetY) * _j7 + _this4.cellHeight / 2.7 - _this4.cellHeight * 0.04
                        }
                        var _rect_width2 = _this4.cellWidth + 2 * _this4.cellOffsetX;
                        var text_x = _rect_x2 + _rect_width2 / 2;
                        var text_y = (_this4.cellHeight + _this4.cellOffsetY) * _j7 + _this4.cellHeight / 2;
                ...
                for (var _j7 in _board[_i10]) {
                    var _ret2 = _loop2(_j7);
        ...
        value: function board_in_bonus(snap, board) {
            ...
            if (this.details.state === 'bonus' && this.details.context.bonus_mechanic.includes(2)) {
                ...
                if (this.details.context.bonus_mechanic.includes(3)) {
                    for (var _i11 in board) {
                        scaled_mults[_i11] = this.details.context.multipliers_2[_i11].concat([0], this.details.context.multipliers[_i11])
                    }
                }
            }
            var curr_board = {};
                ...
                if (this.details.context.bonus_mechanic.includes(2)) {
                    if (this.details.context.mult_win_2 != undefined) {
                        ...
                        if (this.details.context.rounds_left === 0 && this.details.context.rounds_left_2 === 0) {
                            ...
                            for (var _j8 in board) {
                                mult_win_2.bs_v.push(this.details.context.bs_v_2[_j8].concat([0], this.details.context.bs_v[_j8]));
                                mult_win_2_orig.bs_v.push(this.details.context.bs_v_2[_j8].concat([0], this.details.context.bs_v[_j8]))
                            }
                        }
                    ...
                    if (this.details.context.mult_win != undefined) {
                        ...
                        mult_win.val = this.details.context.mult_win.mult;
                        if (this.details.context.rounds_left === 0 && this.details.context.rounds_left_2 === 0) {
                            for (var _j9 in board) {
                                mult_win.bs_v.push(this.details.context.mult_orig_bs_v_2[_j9].concat([0], this.details.context.mult_orig_bs_v[_j9]));
                                mult_win_orig.bs_v.push(this.details.context.mult_orig_bs_v_2[_j9].concat([0], this.details.context.mult_orig_bs_v[_j9]))
                            }
                        } else {
                            for (var _j10 in board) {
                                mult_win.bs_v.push(this.details.context.bs_v_2[_j10].concat([0], this.details.context.bs_v[_j10]));
                                mult_win_orig.bs_v.push(this.details.context.bs_v_2[_j10].concat([0], this.details.context.bs_v[_j10]))
                            }
                        }
                        for (var _i12 in this.details.context.mult_win.pos) {
                            var pos = this.details.context.mult_win.pos[_i12];
                            mult_win.positions.push(pos)
                        }
                        this.details.context.multipliers_2.forEach(function(arr, i) {
                            arr.forEach(function(mult, j) {
            ...
            if (this.details.state === 'bonus' && this.details.context.bonus_mechanic.includes(3)) {
                ...
                if (rounds_left == 0) {
                    ...
                    if (this.details.context.bonus_mechanic.includes(2)) {
                        for (var _i13 in board) {
                            e_m.bs_v[_i13] = this.details.context.mult_orig_bs_v_2[_i13].concat([0], this.details.context.mult_orig_bs_v[_i13]);
                            for (var _j11 in board[_i13]) {
                                if (e_m.bs_v[_i13][_j11]) {
                                    e_m.positions.push([_i13, _j11])
                                }
                            }
                        }
                    } else {
                    ...
                    for (var _i14 in board) {
                        for (var _j12 in board[_i14]) {
                            if (e_m.bs_v[_i14][_j12]) {
                                e_m.positions.push([_i14, _j12])
                            }
                        }
                    }
                    combs.push(e_m)
                ...
                if (rounds_left == 0) {
                    ...
                    if (this.details.context.bonus_mechanic.includes(2)) {
                        for (var _i15 in board) {
                            _e_m3.bs_v[_i15] = this.details.context.bs_v_2[_i15].concat([0], this.details.context.bs_v[_i15]);
                            for (var _j13 in board[_i15]) {
                                if (_e_m3.bs_v[_i15][_j13] > 1) {
                                    _e_m3.positions.push([_i15, _j13])
                                }
                            }
                        }
                    } else {
                    ...
                    for (var _i16 in board) {
                        for (var _j14 in board[_i16]) {
                            if (_e_m3.bs_v[_i16][_j14]) {
                                _e_m3.positions.push([_i16, _j14])
                            }
                        }
                    }
                    combs.push(_e_m3)
            ...
            var _loop3 = function _loop3(_i17) {
                var _loop4 = function _loop4(_j15) {
                    if (combs.length == 1 && _this5.details.state !== 'bonus') {
                        currentWinLine = 0
                    }
                    imageUrl = _this5.url(board[_i17][_j15] + '.png');
                    var img = void 0;
                    if (_this5.details.state === 'bonus' && ![].concat(BONUS_SYMBOLS).includes(board[_i17][_j15])) {
                        imageUrl = _this5.url('0.png')
                    }
                    var extraOffset = (_this5.cellWidth - _this5.cellWidth / widthCoef) / 2;
                    img = group.image(imageUrl, (_this5.cellWidth + _this5.cellOffsetX) * _i17 + extraOffset, (_this5.cellHeight + _this5.cellOffsetY) * _j15, _this5.cellWidth / widthCoef, _this5.cellHeight);
                    if (currentWinLine !== -1) {
                        if (!combs[currentWinLine]) return 'continue';
                    ...
                    if (combs[currentWinLine] !== undefined) {
                        if (combs[currentWinLine].trigger == 'mult_win' || combs[currentWinLine].trigger == 'mult_before' || combs[currentWinLine].trigger == 'mult_win_orig') {
                            value = combs[currentWinLine].bs_v[_i17][_j15]
                        }
                    ...
                    if (_this5.details.context.multipliers && _this5.details.context.multipliers.length) {
                        if (combs[currentWinLine] && (combs[currentWinLine].trigger == 'mult_win_orig' || combs[currentWinLine].trigger == 'mult_win_2_orig')) {
                            mult_value = combs[currentWinLine].orig_val[_i17][_j15]
                        } else if (combs[currentWinLine] && combs[currentWinLine].trigger == 'mult_win_2') {
                            mult_value = combs[currentWinLine].final_val[_i17][_j15]
                        } else {
                            mult_value = _this5.details.context.multipliers[_i17][_j15]
                        }
                    }
                    if (_this5.details.state === 'bonus' && _this5.details.context.bonus_mechanic.includes(2)) {
                        if (_this5.details.context.bonus_mechanic.includes(3) && (combs[currentWinLine] && (combs[currentWinLine].trigger === 'mult_win' || combs[currentWinLine].trigger === 'mult_before') || !combs[currentWinLine])) {
                            mult_value = scaled_mults[_i17][_j15]
                        }
                    }
                    if (mult_value > 1 && _this5.details.round_win === 0) {
                        var offsetX = -2;
                        var rect_x = (_this5.cellWidth + _this5.cellOffsetX) * _i17 + _this5.cellWidth / 1.77 - offsetX;
                        var rect_y = (_this5.cellHeight + _this5.cellOffsetY) * _j15 - _this5.cellOffsetY + 0.5;
                        var rect_width = _this5.cellWidth / 2.3 + 2 * offsetX;
                        var text_x_x = rect_x + rect_width / 2;
                        var text_x_y = (_this5.cellHeight + _this5.cellOffsetY) * _j15 + _this5.cellOffsetY + _this5.cellHeight * 0.17;
                    ...
                    if (mult_value > 1 && _this5.details.round_win > 0 && combs[currentWinLine] !== undefined) {
                        if (combs[currentWinLine].trigger != 'mult_after') {
                            var _offsetX = -2;
                            var _rect_x3 = (_this5.cellWidth + _this5.cellOffsetX) * _i17 + _this5.cellWidth / 1.8 - _offsetX;
                            var _rect_y3 = (_this5.cellHeight + _this5.cellOffsetY) * _j15 - _this5.cellOffsetY + 0.5;
                            var _rect_width3 = _this5.cellWidth / 2.3 + 2 * _offsetX;
                            var _text_x_x2 = _rect_x3 + _rect_width3 / 2;
                            var _text_x_y2 = (_this5.cellHeight + _this5.cellOffsetY) * _j15 + _this5.cellOffsetY + _this5.cellHeight * 0.18;
                            group.rect(_rect_x3, _rect_y3, _rect_width3, _this5.cellHeight / 3).attr({
                                'fill': 'white'
                            });
                            if (_this5.width > 200) {
                    ...
                    if (value != 0 && [10, 11, 12, 13].includes(board[_i17][_j15])) {
                        var _offsetX2 = -2;
                        var _rect_x4 = (_this5.cellWidth + _this5.cellOffsetX) * _i17 - _offsetX2;
                        var _rect_y4 = (_this5.cellHeight + _this5.cellOffsetY) * _j15 + _this5.cellHeight / 2.7 - _this5.cellHeight * 0.04;
                        if (_this5.details.state === 'bonus' && _this5.details.context.bonus_mechanic.includes(2)) {
                            _rect_y4 = (_this5.cellHeight + _this5.cellOffsetY) * _j15 + _this5.cellHeight / 2.7 - _this5.cellHeight * 0.04
                        }
                        var _rect_width4 = _this5.cellWidth + 2 * _offsetX2;
                        var text_x = _rect_x4 + _rect_width4 / 2;
                        var text_y = (_this5.cellHeight + _this5.cellOffsetY) * _j15 + _this5.cellHeight / 2;
                        group.rect(_rect_x4, _rect_y4, _rect_width4, _this5.cellHeight / 3 + 1).attr({
                            'fill': 'white'
                        });
                        if (value == 'mini') {
                            if (_this5.width > 200) {
                ...
                for (var _j15 in board[_i17]) {
                    var _ret4 = _loop4(_j15);
        ...
        value: function _combs(snap, combs, details) {
            ...
            var totalWin = details.round_win;
            var labelLeft = this.title(details) + ', Win:' + this.coins(totalWin);
            var labelRight = combs.length && !(combs.length === 1 && combs[0].trigger === 'bonus') ? 'all/' + combs.length : '';
            this._panel(group, labelLeft, labelRight);
            if (this.details.state !== 'bonus') {
                for (var i = 0; i < combs.length; ++i) {
                    this.drawe_border_win_symbols(group, combs[i]).transform('T' + this.boardMarginLeft + ',' + (this.panelHeight + 1))
            ...
            for (var _i18 = 0; _i18 < combs.length; ++_i18) {
                this.drawe_line_patern(group, combs[_i18]).transform('T' + this.boardMarginLeft + ',' + (this.panelHeight + 1))
            }
            return group
        }
    }, {
