        ...
        value: function board(snap, _board) {
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    var height = 0.6;
                    var up_height = 0.2;
                    if (_board[i][j] == 11 || _board[i][j] == 12 || _board[i][j] == 13) {
                        height = 1;
                        up_height = 0
                    }
                    var img = group.image(imageUrl, (_this3.cellWidth + _this3.cellOffsetX) * i, (_this3.cellHeight + _this3.cellOffsetY) * j + _this3.cellHeight * up_height, _this3.cellWidth, _this3.cellHeight * height);
                    var value = void 0;
