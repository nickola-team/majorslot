        ...
        value: function board(snap, _board) {
            ...
            var _loop = function _loop(_i2) {
                var _loop2 = function _loop2(_j) {
                    var isCollectorSymbol = _board[_i2][_j] === COLLECCTOR_ID;
                    ...
                    if (_board[_i2][_j] === JACKPOT_ID) {
                        imageUrl = _this4.url('11_' + _this4.details.context.bs_v[_i2][_j] + '.png')
                    }
                    if (newBonusBoard && _board[_i2][_j] != COLLECCTOR_ID) {
                        imageUrl = _this4.url('0.png')
                    }
