...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function is_extra_snap(details) {
            return details.state == 'bonus' && (details.context.pearls_count === 15 || details.context.bs_count === 15) || details.state == 'freespins' && details.context.winscatters.length > 0
        }
    }, {
        key: 'make_extra_snap',
        value: function make_extra_snap(details, combsGroup, margin, snap) {
            ...
            if (details.state == 'bonus' && (details.context.pearls_count === 15 || details.context.bs_count === 15)) {
                labelLeft = 'Jackpot!';
                if (this.width > 200) {
