...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function _background(snap, state) {
            ...
            } else if (this.details.context.pearls_count === 15) {
                snap.rect(0, 0, this.width, this.height).attr({
                    'fill': '#6B8E23'
                })
            } else {
        ...
        value: function is_extra_respins(details) {
            var bonus_symbols_v = details.context.bonus_symbols_v;
        ...
        value: function make_spins(details) {
            ...
            if (details.context.winlines === undefined) {
                details.context.winlines = []
            }
            if (details.context.winscatters === undefined) {
                details.context.winscatters = []
            }
            var combs = [].concat(details.context.winlines, details.context.winscatters);
        ...
        value: function board(snap, _board) {
            ...
            if (this.details.context.winlines === undefined) {
                this.details.context.winlines = []
            }
            if (this.details.context.winscatters === undefined) {
                this.details.context.winscatters = []
            }
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    if (_this3.details.state === 'freespins' && _board[i][j] == 9) {
