        ...
        value: function board(snap, _board) {
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    if (_this3.details.state === 'freespins' && _board[i][j] == 10) {
                        imageUrl = _this3.url('10x2.png')
                    }
                    if (_this3.details.state === 'bonus' && _board[i][j] != 12) {
                    ...
                    if (value != 0) {
                        ...
                        if (value == 'mini') {
                            ...
                            if (value < 100000) {
                                ...
                                if (_this3.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_34)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_18)
                                }
                            }
                        }
                    }
