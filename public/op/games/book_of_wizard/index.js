...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function make_extra_snap(details, combsGroup, margin, snap) {
            ...
            if (this.width > 200) {
                group.text('50%', '56%', '+' + roundsGranted + ' FreeSpins').attr(Drawer.FREESPINS_STYLE_TEXT_CENTER_BIG)
            } else {
        ...
        value: function board(snap, _board) {
            ...
            var extraSym = details.context.winscatters && details.context.winscatters.length ? details.context.winscatters[0].special_sym_id : [];
            var group = snap.group();
            var imageUrl = void 0;
