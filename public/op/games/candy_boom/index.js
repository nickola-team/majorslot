    ...
    _createClass(Drawer, [{
        ...
        value: function make_spins(details) {
            ...
            var raw_action_list = [{
                ...
                'mult': this.details.context.mult ? this.details.context.mult : 1,
            ...
            var raw_win = details.context.mult ? totalWin / details.context.mult : totalWin;
            action_list[action_list.length - 1].win = raw_win;
            if (details.last_action === 'respin') {
                action_list = [action_list[0]];
                action_list[0].win = totalWin
            }
            if (action_list.length > 1 && details.state == 'freespins' && this.details.context.mult > 1) {
                var mult_possitions = [];
                ...
                action_list = action_list.concat({
                    'action': false,
                    'win': raw_win,
                    'mult': this.details.context.mult,
            ...
            snap.click(function(e) {
                ...
                } else if (counter === action_list.length - 1 && details.state == 'freespins' && _this2.details.context.mult > 1) {
        ...
        value: function board(snap, one_action) {
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    if (_this3.details.state === 'freespins' && one_action.mult_values) {
        ...
        value: function _combs(snap, action_list, details) {
            ...
            this.bordered_cells = [];
            var text = '';
            if (details.state === 'freespins' && action_list[0].mult_values) {
                text = ',x' + this.get_mult_values(action_list[0].mult_values)
            }
        ...
        value: function _comb(snap, combs, comb, details) {
            ...
            var group = snap.group();
            var text = '';
            if (details.state === 'freespins' && comb.mult_values) {
                text = ',x' + this.get_mult_values(comb.mult_values)
            }
