            ...
            if (this.get_pearls_count(this.details) >= 6 && ['spin', 'freespin'].includes(this.details.last_action)) {
                ...
                for (var i in game_board) {
                    for (var j in game_board[i]) {
                        if ([12, 13].includes(game_board[i][j])) {
        ...
        value: function board(snap, _board) {
            ...
            var _loop = function _loop(_i2) {
                var _loop2 = function _loop2(_j) {
                    ...
                    if (_this3.details.state === 'bonus' && ![12, 13].includes(_board[_i2][_j])) {
                        imageUrl = _this3.url('0.png')
                    }
                    if (_this3.details.state === 'freespins' && _board[_i2][_j] === 10) {
                        imageUrl = _this3.url('10_sticky.png')
                    }
                    ...
                    if (value != 0 && _board[_i2][_j] === 12) {
                        ...
                        if (value == 'mini') {
                            ...
                            if (value < 100000) {
                                if (_this3.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_70)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_40)
                                }
                            } else {
                                if (_this3.width > 200) {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_48)
                                } else {
                                    group.text(text_x, text_y, value).attr(Drawer.BS_VALUE_27)
                                }
                            }
                        }
                    }
