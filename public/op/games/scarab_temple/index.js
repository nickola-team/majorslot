...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function _background(snap, state) {
            ...
            } else if (this.get_bs_count(this.details) === 15) {
                snap.rect(0, 0, this.width, this.height).attr({
                    'fill': '#6B8E23'
                })
            } else {
        ...
        value: function is_extra_snap(details) {
            return details.state == 'bonus' && this.get_bs_count(details) === 15 || details.state == 'freespins' && details.context.winscatters != undefined && details.context.winscatters.length > 0
        }
    }, {
        key: 'make_extra_snap',
        value: function make_extra_snap(details, combsGroup, margin, snap) {
            ...
            if (details.state == 'bonus' && this.get_bs_count(details) === 15) {
                labelLeft = 'Jackpot!';
                if (this.width > 200) {
        ...
        key: 'get_bs_count',
        value: function get_bs_count(details) {
            var count = 0;
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    if (value != 0) {
                        ...
                        if (value == 'mini') {
                            if (_this3.width > 200) {
                                group.text(text_x, text_y, value).attr(Drawer.BS_MINI_JACKPOT_70)
                            } else {
                                group.text(text_x, text_y, value).attr(Drawer.BS_MINI_JACKPOT_40)
                            }
                        } else if (value == 'major') {
                            if (_this3.width > 200) {
                                group.text(text_x, text_y, value).attr(Drawer.BS_MAJOR_JACKPOT_70)
                            } else {
                                group.text(text_x, text_y, value).attr(Drawer.BS_MAJOR_JACKPOT_40)
                            }
                        } else {
                            if (value < 100000) {
                                if (_this3.width > 200) {
