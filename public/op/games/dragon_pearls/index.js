...
var Drawer = function(_BaseDrawer) {
    ...
    _createClass(Drawer, [{
        ...
        value: function is_extra_snap(details) {
            return details.state == 'bonus' && (this.details.context.pearls_count === 15 || this.details.context.bs_count === 15) || details.state == 'freespins' && details.context.winscatters.length > 0
        }
    }, {
        key: 'make_extra_snap',
        value: function make_extra_snap(details, combsGroup, margin, snap) {
            ...
            if (details.state == 'bonus' && (this.details.context.pearls_count === 15 || this.details.context.bs_count === 15)) {
                labelLeft = 'Jackpot!';
                if (this.width > 200) {
            ...
            var _loop = function _loop(i) {
                var _loop2 = function _loop2(j) {
                    ...
                    if (_this3.details.context.bs_v != undefined) {
                        ...
                        value = _this3.details.context.pearls_v[i][j]
                    }
