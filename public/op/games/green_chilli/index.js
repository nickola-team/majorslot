    ...
    _createClass(Drawer, [{
        ...
        value: function board(snap, _board) {
            ...
            if (this.get_pearls_count(this.details) >= 6 && ['spin', 'freespin'].includes(this.details.last_action)) {
                ...
                for (var _i3 in mults) {
                    if (this.details.context.bs_v[mults[_i3][0]][mults[_i3][1]] != 0) {
                        win_mult_pos.push(mults[_i3])
                    }
                }
            }
            if (!combs) {
            ...
            var _loop = function _loop(_i4) {
                var _loop2 = function _loop2(_j) {
                    ...
                    if (_this3.details.state === 'freespins' && _board[_i4][_j] === 9) {
                    ...
                    if (_this3.details.context.mult_values === undefined) {
                        ...
                        mult_value = _this3.details.context.mult_values[_i4][_j]
                    }
                    if (mult_value !== 1 && (_this3.details.context.rounds_left != 0 || !win_mult_pos.includes((_i4, _j)))) {
                        var rect_x = (_this3.cellWidth + _this3.cellOffsetX) * _i4 + _this3.cellWidth / 1.8;
                    ...
                    if (value != 0) {
                        var _rect_x = (_this3.cellWidth + _this3.cellOffsetX) * _i4 - _this3.cellOffsetX;
