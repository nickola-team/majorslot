        ...
        4376: function(e, t, n) {
            ...
            var f = function(e) {
                ...
                const {
                    ...
                    bgt: v,
                    uniqueId: O
                } = t[0], y = t[t.length - 1], j = "".concat(E, ".bonus.").concat(v), w = "".concat(u.v).concat(_, "/bonus").concat(v, "/"), N = f("".concat(j, ".title")), S = f("".concat(j, ".subtitle")), h = f("".concat(j, ".stepTableTitle"));
                ...
                }, h), c.a.createElement("table", null, c.a.createElement("tbody", null, t.map((e, t) => !e.isHidden && c.a.createElement(d, i({}, m(e), {
                    key: t
                }))))))))
            };
            n(4611), t.a = f
            ...
            var p = function(e) {
                ...
                return t.map(e => {
                    const t = e[e.length - 1],
                        ...
                        x = "".concat(g, ".bonus.").concat(i),
                        I = f("".concat(x, ".title")),
                        B = f("".concat(x, ".subtitle")),
                        C = f("".concat(x, ".collect")),
                        k = f("".concat(x, ".respin")),
                        P = {
                            custom: [{
                                position: "bottom",
                                label: c.a.createElement(c.a.Fragment, null, v(f("".concat(x, ".result.win")), O), c.a.createElement("br", null), v(f("".concat(x, ".result.totalWin")), N))
                            }]
                        };
                    if ("1" === w) {
                        const e = Object(b.A)(h) * Object(b.A)(N);
                        P.totalWin = y, P.win = j, P.custom.push({
                            label: Object(o.h)(h, N, e)
                        })
                    }
                    const W = e => {
                        let {
        ...
        4535: function(e, t, n) {
            ...
            function o(e) {
                ...
                const {
                    ...
                    showMultiplayer: g,
                    showFsMore: f
                } = n(t), _ = Object(l.g)([d && Object(l.d)("".concat(u("free_spin.free_spin_progress"), ": x").concat(b)), g && Object(l.d)("".concat(u("free_spin.win_multiplier"), ": x").concat(i)), f && p && Object(l.d)("".concat(u("free_spin.free_spin_played_won"), ": ").concat(p))]);
            ...
            r.defaultProps = {
                ...
                toggleResultChunks: e => {
                    ...
                    return {
                        showMultiplayer: t > 1,
                        showProgress: !1,
                        showFsMore: !(null == n ? void 0 : n.limitExceeded)
                    }
                },
                className: "FreeSpin"
            }, t.b = o
        ...
        4549: function(e, t, n) {
            ...
            const m = "win",
                ...
                E = (e, t) => {
                    const {
                        translateSymbol: n
                    } = Object(a.useContext)(r.a), s = "".concat(n, ".bonus.").concat(e.bgt), l = Object(o.f)("".concat(t("free_spin.free_spin_played_won"), ": ").concat(e.fsWin), e.fsWin), u = f(e), i = Object(o.d)("".concat(t("".concat(s, ".result.text")), ": ").concat(t("".concat(s, ".").concat(u)))), m = Object(o.f)(c.a.createElement("span", {
                        className: "Action__ResultValue"
                    }, t("gamble.collect")), e.isCollect);
                    return Object(o.g)([l, i, m])
                },
                v = e => {
