    ...
    [2], {
        ...
        2528: function(e, t, n) {
            ...
            var m = function(e) {
                    ...
                    if (_) return null;
                    const y = "".concat(d, ".bonus.").concat(O),
                        j = "".concat(l.v).concat(p, "/bonus").concat(O),
                        N = f.map(e => {
                            const t = ["collect", "gamble"].includes(e) ? b("".concat(y, ".").concat(e)) : "";
                            return c.a.createElement(s.c, {
                                src: "".concat(j, "/").concat(n[e]),
                                alt: e,
                                text: t
                            })
                        });
                    ...
                    switch (g) {
                        case "collect":
                        case "win":
                            S = b("".concat(y, ".").concat(w[v]));
                            break;
                        default:
                            S = b("".concat(y, ".result.").concat(g))
                    }
                    const h = {
                        custom: {
                            label: "".concat(b("".concat(y, ".result.text")), ": ").concat(S)
                        }
                    };
                    return c.a.createElement(c.a.Fragment, null, c.a.createElement(r.b, {
                        title: b("".concat(y, ".title")),
                        subtitle: b("".concat(y, ".subtitle")),
                        result: h,
                        uniqueId: E
                    }, c.a.createElement("div", {
                        className: "Bonus35"
        ...
        2529: function(e, t, n) {
            ...
            var f = function(e) {
                ...
                const {
                    ...
                    bgt: v,
                    uniqueId: O
                } = t[0], w = t[t.length - 1], y = "".concat(E, ".bonus.").concat(v), j = "".concat(u.v).concat(_, "/bonus").concat(v, "/"), N = f("".concat(y, ".title")), S = f("".concat(y, ".subtitle")), h = f("".concat(y, ".stepTableTitle"));
                return c.a.createElement(s.b, {
                    ...
                    result: b(b({}, (e => {
                        ...
                        return t ? o = {
                            custom: {
                                label: f("".concat(y, ".result.win"))
                            }
                        } : n && (o = {
                            totalWin: c,
                            win: l,
                            custom: [{
                                label: "".concat(f("".concat(y, ".result.collect")), ": x").concat(a)
                            }, {
        ...
        2531: function(e, t, n) {
            ...
            var p = function(e) {
                ...
                return t.map(e => {
                    ...
                    if ("1" === j) {
                        const e = Object(b.w)(h) * Object(b.w)(N);
                        P.totalWin = w, P.win = y, P.custom.push({
                            label: Object(o.g)(h, N, e)
                        })
                    }
                    const W = e => {
                        let {
