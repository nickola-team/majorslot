...
namespace VanguardLTE\Http\Controllers\Web\GameProviders
{
    ...
    class BNNController extends \VanguardLTE\Http\Controllers\Controller
    {
        /*
        * UTILITY FUNCTION
        */
        ...
        public static function processGameRound()
        {
            ...
            if ($data && $data['ret'] == 1 && $data['total'] > 0)
            {
                ...
                foreach ($data['data'] as $round)
                {
                    ...
                    $category = \VanguardLTE\Category::where(['provider' => self::BNN_PROVIDER, 'shop_id' => 0, 'href' =>$round['gid']])->first();
                    if ($round['extra'] != null)
                    {
