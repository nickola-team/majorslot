...
namespace VanguardLTE\Http\Controllers\Web\GameProviders
{
    ...
    // SlotCity
    class SC4Controller extends \VanguardLTE\Http\Controllers\Controller
    {
        /*
        * UTILITY FUNCTION
        */
        ...
        */
        ...
        public static function processGameRound($frompoint=-1, $checkduplicate=false)
        {
            ...
            if ($frompoint == -1)
            {
                $tpoint = \VanguardLTE\Settings::where('key', self::SC4_PROVIDER . 'timepoint')->first();
                if ($tpoint)
                {
            ...
            if ($data == null)
            {
                if ($frompoint == -1)
                {
                    ...
                    {
                        \VanguardLTE\Settings::create(['key' => self::SC4_PROVIDER .'timepoint', 'value' => $newtimepoint]);
                    }
                }
            ...
            if ($frompoint == -1)
            {
                ...
                {
                    \VanguardLTE\Settings::create(['key' => self::SC4_PROVIDER .'timepoint', 'value' => $timepoint]);
                }
            }
