...
namespace VanguardLTE\Games\ColossalCashZonePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,25,100,500];
            $this->Paytable[3] = [0,0,0,25,100,500];
            $this->Paytable[4] = [0,0,0,20,40,200];
            $this->Paytable[5] = [0,0,0,15,30,150];
            $this->Paytable[6] = [0,0,0,10,20,100];
            $this->Paytable[7] = [0,0,0,5,10,50];
            $this->Paytable[8] = [0,0,0,3,8,30];
            $this->Paytable[9] = [0,0,0,3,8,30];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameColossalCashZoneStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
