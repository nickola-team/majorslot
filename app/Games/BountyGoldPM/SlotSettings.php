...
namespace VanguardLTE\Games\BountyGoldPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,10,50,200];
            $this->Paytable[4] = [0,0,0,5,30,150];
            $this->Paytable[5] = [0,0,0,5,25,125];
            $this->Paytable[6] = [0,0,0,5,25,75];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[8.00,20.00,30.00,40.00,50.00,80.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00]; 
        ...
        {
            // if($winType == 'bonus'){                
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBountyGoldStack::where('id', 396)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameBountyGoldStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
