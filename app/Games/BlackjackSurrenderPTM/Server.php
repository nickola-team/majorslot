        ...
        public function get($request, $game)
        {
            ...
            if( $_obf_0D08333E1D26032E03385B371A3631170E0B3C361B2601 ) 
            {
                ...
                for( $c = 0; $c <= 2000; $c++ ) 
                {
                    ...
                    for( $i = 0; $i <= 15; $i++ ) 
                    {
                        $_obf_0D3E2D04253B2E36262C5B19120C23052E3C0634182A11['cards'][] = $cardsArr[$cr];
                        $_obf_0D1E132D0F400E3709252C25070E3B3C3F251330052D22['cards'][] = $cardsArr[$cr];
                        $_obf_0D1E132D0F400E3709252C25070E3B3C3F251330052D22['cards'][] = $cardsArr[$cr + 1];
                        $_obf_0D25035C31183316381216122811401A1F2A17243E2B22[] = $cardsArr[$cr];
                        $cr++;
