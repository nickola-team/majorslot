<?php 
namespace VanguardLTE\Games\grabthegoldbng
{
    class Server
    {
            ...
            if($slotEvent['command'] == 'login'){
                ...
                $objRes = [
                    ...
                    'context' => [
                        ...
                        'spins' => [
                            'bet_per_line' => $bets[9],
                            'board' => [[11, 3, 5, 5], [12, 12, 12, 12], [9, 9, 9, 1], [12, 12, 12, 12], [6, 2, 11, 3]],
                ...
                $currentsac = $slotSettings->GetGameData($slotSettings->slotId . 'SAC') ?? [4, 0];
