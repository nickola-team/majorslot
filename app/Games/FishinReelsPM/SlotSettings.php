...
namespace VanguardLTE\Games\FishinReelsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,5,50,200,1000];
            $this->Paytable[4] = [0,0,0,25,150,500];
            $this->Paytable[5] = [0,0,0,20,125,400];
            $this->Paytable[6] = [0,0,0,15,100,300];
            $this->Paytable[7] = [0,0,0,10,50,200];
            $this->Paytable[8] = [0,0,0,10,50,200];
            $this->Paytable[9] = [0,0,0,5,20,150];
            $this->Paytable[10] = [0,0,0,5,20,150];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameFishinReelsStack::where('id', 3)->first();
