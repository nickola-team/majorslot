    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            // if($winType == 'bonus' && $ind == -1){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameReturnoftheDeadStack::where('id', 185711)->first();
            ...
            while(true){
                ...
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameReturnoftheDeadStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameReturnoftheDeadStack::where('spin_type', 0)->whereNotIn('id', $existIds);                    
                }
                if($winType == 'win'){
