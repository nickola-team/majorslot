...
namespace VanguardLTE\Games\BombBonanzaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBombBonanzaStack::where('id', 43)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBombBonanzaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBombBonanzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
