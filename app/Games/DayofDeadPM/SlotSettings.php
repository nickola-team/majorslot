...
namespace VanguardLTE\Games\DayofDeadPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,30,90,300];
            $this->Paytable[4] = [0,0,0,20,60,200];
            $this->Paytable[5] = [0,0,0,15,45,150];
            $this->Paytable[6] = [0,0,0,12,35,120];
            $this->Paytable[7] = [0,0,0,10,30,100];
            $this->Paytable[8] = [0,0,0,8,25,80];
            $this->Paytable[9] = [0,0,0,7,20,70];
            $this->Paytable[10] = [0,0,0,5,15,50];
            $this->Paytable[11] = [0,0,0,5,15,50];
            $this->Paytable[12] = [0,0,0,4,12,40];
            $this->Paytable[13] = [0,0,0,4,12,40];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameDayofDeadStack::where('id', 96)->first();
