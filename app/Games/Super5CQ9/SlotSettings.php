...
namespace VanguardLTE\Games\Super5CQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                    // $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameSuper5Stack::where('id', 59683)->first(); //33 : normal,211 : free
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSuper5Stack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSuper5Stack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
