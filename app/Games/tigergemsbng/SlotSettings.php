...
namespace VanguardLTE\Games\tigergemsbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameTigerGemsStack::where('id', 179)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($this->GetGameData($this->slotId . 'MoneyCount') >= 129){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameTigerGemsStack::where('spin_type',2);
                    }else{
