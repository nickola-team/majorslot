...
namespace VanguardLTE\Games\MadameDestinyPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,50,600,1000];
            $this->Paytable[4] = [0,0,0,25,400,800];
            $this->Paytable[5] = [0,0,0,20,200,500];
            $this->Paytable[6] = [0,0,0,15,100,400];
            $this->Paytable[7] = [0,0,0,15,90,300];
            $this->Paytable[8] = [0,0,0,12,80,200];
            $this->Paytable[9] = [0,0,0,10,70,150];
            $this->Paytable[10] = [0,0,0,8,60,100];
            $this->Paytable[11] = [0,0,0,5,50,60];
            $this->Paytable[12] = [0,0,0,4,40,50];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMadameDestinyStack::where('id', 128)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameMadameDestinyStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
