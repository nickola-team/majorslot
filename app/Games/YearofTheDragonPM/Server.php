    ...
    class Server
    {
        ...
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [3,7,5,5,6,4,6,3,2,8,5,9,8,4,9]);
                ...
                if(isset($stack)){
                    ...
                    if($str_trail != ''){
                        ...
                        for($k = 0; $k < count($arr_trails); $k++){
                            if(strpos($arr_trails[$k], 'dk_wins') !== false){
                                $arr_subtrails = explode('~', $arr_trails[$k]);
                                if(count($arr_subtrails) == 2){
                                    $arr_dkwins = explode(',', $arr_subtrails[1]);
                                    for($i = 0; $i < count($arr_dkwins); $i++){
                                        $arr_dkwins[$i] = str_replace(',', '', $arr_dkwins[$i]) / $original_bet * $bet;
                                    }
                                    $arr_trails[$k] = 'dk_wins~' . implode(',', $arr_dkwins);
                                }                            
                            }
                        }
                    ...
                    if($arr_g != null){
                        for($k = 0; $k <= 4; $k++){
                            if(isset($arr_g['reel_' . $k])){
                                $value = $arr_g['reel_' . $k];
                                for($i = 0; $i < 20; $i++){
                                    if(isset($value['l' . $i])){
                                        $arr_sub_lines = explode('~', $value['l' . $i]);
                                        $arr_sub_lines[1] = str_replace(',', '', $arr_sub_lines[1]) / $original_bet * $bet;
                                        $arr_g['reel_' . $k]['l' . $i] = implode('~', $arr_sub_lines);
                                    }else{
                                        break;
                                    }
                                }
                        ...
                        $strOtherResponse = $strOtherResponse .'&g={reel_0:{def_s:"10,11,16",def_sa:"10,11,16",def_sb:"10,11,16",s:"10,11,16",sa:"10,11,16",sb:"10,11,16",sh:"1",st:"rect",sw:"3"},reel_1:{def_s:"10,11,16",def_sa:"10,11,16",def_sb:"10,11,16",s:"10,11,16",sa:"10,11,16",sb:"10,11,16",sh:"1",st:"rect",sw:"3"},reel_2:{def_s:"10,11,16",def_sa:"10,11,16",def_sb:"10,11,16",s:"10,11,16",sa:"10,11,16",sb:"10,11,16",sh:"1",st:"rect",sw:"3"},reel_3:{def_s:"10,11,16",def_sa:"10,11,16",def_sb:"10,11,16",s:"10,11,16",sa:"10,11,16",sb:"10,11,16",sh:"1",st:"rect",sw:"3"},reel_4:{def_s:"10,11,16",def_sa:"10,11,16",def_sb:"10,11,16",s:"10,11,16",sa:"10,11,16",sb:"10,11,16",sh:"1",st:"rect",sw:"3"}}';
                    }
                    if($strWinLine != ''){
                    ...
                    foreach($arr_g as $index => $value){
                        for($i = 0; $i < 20; $i++){
                            if(isset($value['l' . $i])){
                                ...
                                $arr_sub_lines[1] = str_replace(',', '', $arr_sub_lines[1]) / $original_bet * $betline;
                                $totalWin = $totalWin + $arr_sub_lines[1];
                                $arr_g[$index]['l' . $i] = implode('~', $arr_sub_lines);
                            }else{
                                break;
                            }
                        }
                    ...
                    for($k = 0; $k < count($arr_trails); $k++){
                        if(strpos($arr_trails[$k], 'dk_wins') !== false){
                            ...
                            if(count($arr_subtrails) == 2){
                                $arr_dkwins = explode(',', $arr_subtrails[1]);
                                for($i = 0; $i < count($arr_dkwins); $i++){
                                    $arr_dkwins[$i] = str_replace(',', '', $arr_dkwins[$i]) / $original_bet * $betline;
                                }
                                $arr_trails[$k] = 'dk_wins~' . implode(',', $arr_dkwins);
                            }                            
                        }
