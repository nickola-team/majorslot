...
namespace VanguardLTE\Games\candyboombng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameCandyBoomStack::where('id', 232)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCandyBoomStack::where('spin_type',1);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCandyBoomStack::where('spin_type', 0);
                }
