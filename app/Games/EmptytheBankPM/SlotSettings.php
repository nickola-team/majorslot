...
namespace VanguardLTE\Games\EmptytheBankPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,5,50,100,400];
            $this->Paytable[4] = [0,0,0,40,100,200];
            $this->Paytable[5] = [0,0,0,40,80,100];
            $this->Paytable[6] = [0,0,0,20,60,100];
            $this->Paytable[7] = [0,0,0,20,60,80];
            $this->Paytable[8] = [0,0,0,10,20,60];
            $this->Paytable[9] = [0,0,0,10,20,60];
        ...
        {
            // if($winType == 'win'){                
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameEmptytheBankStack::where('id', 41)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameEmptytheBankStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
