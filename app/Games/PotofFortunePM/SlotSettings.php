...
namespace VanguardLTE\Games\PotofFortunePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePotofFortuneStack::where('id', 41209)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePotofFortuneStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePotofFortuneStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur > -1){
