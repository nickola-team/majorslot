...
namespace VanguardLTE\Games\ElementalGemsMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,50];
            $this->Paytable[3] = [0,0,0,30];
            $this->Paytable[4] = [0,0,0,20];
            $this->Paytable[5] = [0,0,0,12];
            $this->Paytable[6] = [0,0,0,5];
            $this->Paytable[7] = [0,0,0,4];
            $this->Paytable[8] = [0,0,0,2];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameElementalGemsMegawaysStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
