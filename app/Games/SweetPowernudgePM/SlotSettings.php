...
namespace VanguardLTE\Games\SweetPowernudgePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSweetPowernudgeStack::where('id', 28842)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetPowernudgeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetPowernudgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
