...
namespace VanguardLTE\Games\DragonKingdomEyesofFirePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2]  = [0,0,0,25];
            $this->Paytable[3]  = [0,0,0,20];
            $this->Paytable[4]  = [0,0,0,15];
            $this->Paytable[5]  = [0,0,0,10];
            $this->Paytable[6]  = [0,0,0,8];
            $this->Paytable[7]  = [0,0,0,5];
            $this->Paytable[8]  = [0,0,0,3];
            $this->Paytable[9]  = [0,0,0,2];
            $this->Paytable[10] = [0,0,0,0];
            $this->Paytable[11] = [0,0,0,0];
            $this->Paytable[12] = [0,0,0,0];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[40.00,80.00,100.00,120.00,200.00,300.00,400.00,1000.00,2000.00,4000.00,6000.00,8000.00,10000.00,20000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDragonKingdomEyesofFireStack::where('id', 8)->first();
