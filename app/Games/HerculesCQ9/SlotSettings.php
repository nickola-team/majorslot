...
namespace VanguardLTE\Games\HerculesCQ9
{
    class SlotSettings
    {
        ...
        {
            //if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameHerculesStack::where('id', 106890)->first();   //74814,105418,108209
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameHerculesStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameHerculesStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
