<?php 
namespace VanguardLTE\Games\BigBassFloatsmyBoatPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,9,4,3,11,6,10,3,6,8,5,8,4,4,12]);
