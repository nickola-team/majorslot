<?php 
namespace VanguardLTE\Games\moonsistersbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameMoonSistersStack::where('id', 64211)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMoonSistersStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMoonSistersStack::where('spin_type', 0);
                }
