...
namespace VanguardLTE\Games\HeistfortheGoldenNuggetsPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHeistfortheGoldenNuggetsStack::where('id', 24960)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHeistfortheGoldenNuggetsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHeistfortheGoldenNuggetsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
