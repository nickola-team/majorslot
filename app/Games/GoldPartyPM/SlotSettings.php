...
namespace VanguardLTE\Games\GoldPartyPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,5,20,40,100];
            $this->Paytable[4] = [0,0,0,15,25,50];
            $this->Paytable[5] = [0,0,0,10,20,30];
            $this->Paytable[6] = [0,0,0,5,15,30];
            $this->Paytable[7] = [0,0,0,5,15,30];
            $this->Paytable[8] = [0,0,0,5,15,25];
            $this->Paytable[9] = [0,0,0,5,15,25];
            $this->Paytable[10] = [0,0,0,5,10,20];
            $this->Paytable[11] = [0,0,0,5,10,20];
            $this->Paytable[12] = [0,0,0,5,10,15];
            $this->Paytable[13] = [0,0,0,5,10,15];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameGoldPartyStack::where('id', 5)->first();
            ...
            while(true){
                if($spintype == 0){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGoldPartyStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGoldPartyStack::where('spin_type', '>=' , $spintype)->whereNotIn('id', $existIds);
                }
