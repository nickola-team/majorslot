...
namespace VanguardLTE\Games\PirateGoldPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGamePirateGoldStack::where('id', 668)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGamePirateGoldStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
