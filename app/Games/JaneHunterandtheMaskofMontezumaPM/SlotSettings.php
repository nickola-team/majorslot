<?php 
namespace VanguardLTE\Games\JaneHunterandtheMaskofMontezumaPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameJaneHunterandtheMaskofMontezumaStack::where('id', 13186)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJaneHunterandtheMaskofMontezumaStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJaneHunterandtheMaskofMontezumaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
