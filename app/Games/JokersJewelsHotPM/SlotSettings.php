...
namespace VanguardLTE\Games\JokersJewelsHotPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameJokersJewelsHotStack::where('id', 53621)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameJokersJewelsHotStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
