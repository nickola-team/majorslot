...
namespace VanguardLTE\Games\CowboysGoldPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4] = [0,0,5,50,200,750];
            $this->Paytable[5] = [0,0,0,30,150,500];
            $this->Paytable[6] = [0,0,0,25,100,250];
            $this->Paytable[7] = [0,0,0,20,100,200];
            $this->Paytable[8] = [0,0,0,10,50,100];
            $this->Paytable[9] = [0,0,0,5,25,50];
            $this->Paytable[10] = [0,0,0,5,25,50];
            $this->Paytable[11] = [0,0,0,5,10,25];
            $this->Paytable[12] = [0,0,0,5,10,25];
            $this->Paytable[13] = [0,0,0,0,0,0];
            $this->Paytable[14] = [0,0,0,10,50,100];
            $this->Paytable[15] = [0,0,0,10,50,100];
            $this->Paytable[16] = [0,0,0,10,50,100];
            $this->Paytable[17] = [0,0,0,10,50,100];
            $this->Paytable[18] = [0,0,0,10,50,100];
            $this->Paytable[19] = [0,0,0,10,50,100];
            $this->Paytable[20] = [0,0,0,10,50,100];
            $this->Paytable[21] = [0,0,0,10,50,100];
            $this->Paytable[22] = [0,0,0,10,50,100];
            $this->Paytable[23] = [0,0,0,10,50,100];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCowboysGoldStack::where('id', 9)->first();
