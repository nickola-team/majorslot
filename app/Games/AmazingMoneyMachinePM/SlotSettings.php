...
namespace VanguardLTE\Games\AmazingMoneyMachinePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,50,200,1000];
            $this->Paytable[3] = [0,0,0,20,100,200];
            $this->Paytable[4] = [0,0,0,15,50,150];
            $this->Paytable[5] = [0,0,0,10,30,100];
            $this->Paytable[6] = [0,0,0,10,30,100];
            $this->Paytable[7] = [0,0,0,5,20,50];
            $this->Paytable[8] = [0,0,0,5,20,50];
            $this->Paytable[9] = [0,0,0,5,15,40];
            $this->Paytable[10] = [0,0,0,5,15,40];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameAmazingMoneyMachineStack::where('id', 33539)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameAmazingMoneyMachineStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
