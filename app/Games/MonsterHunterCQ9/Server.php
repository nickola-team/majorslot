<?php 
namespace VanguardLTE\Games\MonsterHunterCQ9
{
    class Server
    {
        public $demon = 10;
                ...
                if($paramData['req'] == 1){ // init
                    ...
                    for($i = 0; $i < count($gameDatas); $i++){
                        ...
                        if($packet_id == 11){
                            ...
                            $result_val['Tag'] = ["g" => "GB2","s" => "5.16.3.6","l" => "0.0.0.56","si" => "11"];
                        }else if($packet_id == 12){
                            $result_val['BGStripStartID'] = 0;
                            $result_val['FGStripStartID'] = -1;
                            $result_val['BGStripCount'] = 1;
                            $result_val['BGContext'] = [
                                ["VYC93P2xj1TGHELzPUf5xkWs5w7uBXzxZT7UERdkIjfr7EtkYVcpPNcnK5haOBWSDHpOP5TmPnCr2wWSjWEL920RhfYCa5rih0VbCvXoJbt9CHQx6bqKjhPgqj6G2n//WYuDky1DjAfSNF1ptQQ5sGJiIZpqsiubUaat8r9uXdL5LGyJfkOK66CwCyE=","ZzQjIsJV7sQRdjp6c2CbuNVeBIN3CpomOv3mAmyrQvEWyKajK1kYt1ofFzTAgf7Sa5xzTHIozn2WSJiWPgnZGMvruYVA+JssL6NzUmpTISqa/vCd/KWRzXLPMEtwnTo5nXqGpZgBXhf2rYCER66q551Cxn38F2R99TvqKQ==","tFQp3a9UGAhWTezIty6D72dnqpIcIK3TbGrxrImnAUrOrZSKfebrJp3jbmmdqdXC6HIU6KUR939KTgkeNqkDjagAd2FEqKWId/0xWR6lz1lXiViIquFFnPYoiUTIqkczxwTwqrxqWevRiPLyWkZbezJUCl8npRGvePKBoS8mafuNwFESDm2m0dAXbjg=","lMUjUiEKwGoYgrmtLYTDsJCyh5fKs8iwUkSwB6yUrbVWnSk37ilD+op0KWaudCkt7jvNWjnom7C+ILMuce/5k5TkbxhGx+Adqa+m1oDhWsk5T7ATJaT8MX8bme/4s6ruf73GWFWGjQTgxjlx8Jt6EI55uSp1R0GAe9Xbtw==","fZJoqplRM9p7FVXqB82LyXGBEdAJN1/cNdH9kbLoZN227+yMrcyuwr3m+YehaQy6ovYIcmMYC4TVZlh7ZPeaHsoOaFcv/muL5IFLs1OPol14CJzbgJHvC6lORz+FpHsfr+uPx4l9Bmvd0nRdPna1S2u1CG/4gY1mq2j1vtuB9i6A3A9KQH+EYhrq46M="]
                              ];
                            ...
                            if($packet_id == 42 && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0){
                                ...
                                $roundstr = '135' . substr($roundstr, 3, 7);
                            ...
                            //$slotSettings->SetGameData($slotSettings->slotId . 'FreespinAction', 'freespin');
                            $betline = $slotSettings->GetGameData($slotSettings->slotId . 'PlayBet');
                            $tumbAndFreeStacks = $slotSettings->GetGameData($slotSettings->slotId . 'TumbAndFreeStacks');
                            $stack = $tumbAndFreeStacks[$slotSettings->GetGameData($slotSettings->slotId . 'TotalSpinCount')];
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalSpinCount', $slotSettings->GetGameData($slotSettings->slotId . 'TotalSpinCount') + 1);
        ...
        public function generateResult($slotSettings, $result_val, $slotEvent, $betline, $lines, $originalbet){
            ...
            /*if(isset($stack['WinType']) && $stack['WinType'] > 3){
                //$slotEvent = 'freespin';
                $slotSettings->SetGameData($slotSettings->slotId . 'FreespinAction', 'freespin');
            }
            if($slotSettings->GetGameData('FreespinAction') == 'freespin'){
                $slotEvent = 'freespin';
            }*/
            $isState = true;
            $isTriggerFG =false;
