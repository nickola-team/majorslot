...
namespace VanguardLTE\Games\happyfishbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameHappyFishStack::where('id', 6)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHappyFishStack::where('spin_type',1);
                }else{
