...
namespace VanguardLTE\Games\SpartanKingPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,75,150];
            $this->Paytable[4] = [0,0,0,20,60,125];
            $this->Paytable[5] = [0,0,0,10,50,100];
            $this->Paytable[6] = [0,0,0,10,40,80];
            $this->Paytable[7] = [0,0,0,5,20,50];
            $this->Paytable[8] = [0,0,0,3,10,40];
            $this->Paytable[9] = [0,0,0,3,10,40];
            $this->Paytable[10] = [0,0,0,2,10,40];
            $this->Paytable[11] = [0,0,0,2,10,40];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSpartanKingStack::where('id', 140)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameSpartanKingStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
