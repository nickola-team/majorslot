...
namespace VanguardLTE\Games\TreesofTreasurePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTreesofTreasureStack::where('id', 229763)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTreesofTreasureStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTreesofTreasureStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
