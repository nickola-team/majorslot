...
namespace VanguardLTE\Games\GreatRhinoPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGreatRhinoStack::where('id', 83935)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGreatRhinoStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
