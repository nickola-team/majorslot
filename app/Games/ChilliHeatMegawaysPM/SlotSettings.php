...
namespace VanguardLTE\Games\ChilliHeatMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,10,20,40,100,200];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameChilliHeatMegawaysStack::where('id', 36)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameChilliHeatMegawaysStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
