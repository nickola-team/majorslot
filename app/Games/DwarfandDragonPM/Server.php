<?php 
namespace VanguardLTE\Games\DwarfandDragonPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [4,8,11,15,14,13,7,7,8,3,5,21,8,4,17,15,9,3,9,20]);
