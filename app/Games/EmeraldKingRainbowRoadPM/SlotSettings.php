...
namespace VanguardLTE\Games\EmeraldKingRainbowRoadPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,100,300,500];
            $this->Paytable[4] = [0,0,0,20,100,300];
            $this->Paytable[5] = [0,0,0,20,100,300];
            $this->Paytable[6] = [0,0,0,10,20,200];
            $this->Paytable[7] = [0,0,0,10,20,200];
            $this->Paytable[8] = [0,0,0,10,20,200];
            $this->Paytable[9] = [0,0,0,0,0,0];
            $this->Paytable[10] = [0,0,0,0,0,0];
            $this->Paytable[11] = [0,0,0,300,0,0];
            $this->Paytable[12] = [0,0,0,200,0,0];
            $this->Paytable[13] = [0,0,0,100,0,0];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameEmeraldKingRainbowRoadStack::where('id', 67872)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameEmeraldKingRainbowRoadStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
