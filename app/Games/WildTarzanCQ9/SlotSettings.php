...
namespace VanguardLTE\Games\WildTarzanCQ9
{
    class SlotSettings
    {
        ...
        {
            // // // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameWildTarzanStack::where('id', 12364)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWildTarzanStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWildTarzanStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
