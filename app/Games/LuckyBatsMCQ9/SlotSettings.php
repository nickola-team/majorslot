...
namespace VanguardLTE\Games\LuckyBatsMCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBatsMStack::where('id', 21766)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBatsMStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBatsMStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
