...
namespace VanguardLTE\Games\InfectiveWildPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameInfectiveWildStack::where('id', 11)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameInfectiveWildStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameInfectiveWildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
