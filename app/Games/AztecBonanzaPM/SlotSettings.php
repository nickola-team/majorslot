...
namespace VanguardLTE\Games\AztecBonanzaPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,15,30,75];
            $this->Paytable[4] = [0,0,0,10,15,30];
            $this->Paytable[5] = [0,0,0,10,15,30];
            $this->Paytable[6] = [0,0,0,5,8,15];
            $this->Paytable[7] = [0,0,0,5,8,15];
            $this->Paytable[8] = [0,0,0,3,5,10];
            $this->Paytable[9] = [0,0,0,3,5,10];
            $this->Paytable[10] = [0,0,0,3,5,10];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[10.00,20.00,30.00,40.00,70.00,100.00,140.00,170.00,200.00,240.00,300.00,400.00,700.00,1000.00,1500.00,2000.00,2500.00,3000.00,3300.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameAztecBonanzaStack::where('id', 279)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecBonanzaStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecBonanzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
