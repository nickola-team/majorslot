<?php 
namespace VanguardLTE\Games\FruitTreatsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFruitTreatsStack::where('id', 38339)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFruitTreatsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFruitTreatsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
