...
namespace VanguardLTE\Games\TheDogHouseMuttleyCrewPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $pur = -1)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseMuttleyCrewStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseMuttleyCrewStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
