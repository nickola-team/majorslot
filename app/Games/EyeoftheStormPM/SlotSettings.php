...
namespace VanguardLTE\Games\EyeoftheStormPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4]  = [0,0,0,50,200,400];
            $this->Paytable[5]  = [0,0,0,20,125,300];
            $this->Paytable[6]  = [0,0,0,20,100,250];
            $this->Paytable[7]  = [0,0,0,10,50,200];
            $this->Paytable[8]  = [0,0,0,10,50,200];
            $this->Paytable[9]  = [0,0,0,5,20,100];
            $this->Paytable[10] = [0,0,0,5,20,100];
