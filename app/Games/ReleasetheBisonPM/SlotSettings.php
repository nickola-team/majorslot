...
namespace VanguardLTE\Games\ReleasetheBisonPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameReleasetheBisonStack::where('id', 93)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameReleasetheBisonStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameReleasetheBisonStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
