...
namespace VanguardLTE\Games\PharaohsGoldCQ9
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $selState,$selIndex)
        {
            // if($winType == 'bonusspin'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GamePharaohsGoldStack::where('id', 47160)->first();
            ...
            while(true){
                if($winType == 'bonusspin'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GamePharaohsGoldStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GamePharaohsGoldStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
