<?php 
namespace VanguardLTE\Games\PompeiiMegareelsMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePompeiiMegareelsMegawaysStack::where('id', 4773)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePompeiiMegareelsMegawaysStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePompeiiMegareelsMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
