...
namespace VanguardLTE\Games\hitthegoldbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameHitTheGoldStack::where('id', 121)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 55){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitTheGoldStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitTheGoldStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitTheGoldStack::where('spin_type', 0);
                }
