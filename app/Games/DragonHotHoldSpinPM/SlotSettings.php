...
namespace VanguardLTE\Games\DragonHotHoldSpinPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDragonHotHoldSpinStack::where('id', 56603)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameDragonHotHoldSpinStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
