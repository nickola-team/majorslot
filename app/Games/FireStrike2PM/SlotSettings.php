...
namespace VanguardLTE\Games\FireStrike2PM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,150,300,1000];
            $this->Paytable[3] = [0,0,0,100,200,500];
            $this->Paytable[4] = [0,0,0,75,150,300];
            $this->Paytable[5] = [0,0,0,30,100,250];
            $this->Paytable[6] = [0,0,0,25,80,200];
            $this->Paytable[7] = [0,0,0,20,60,150];
            $this->Paytable[8] = [0,0,0,15,50,125];
            $this->Paytable[9] = [0,0,0,10,40,100];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,30.00,40.00,50.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00,5000.00,6000.00,7000.00,8000.00,9000.00,10000.00]; 
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireStrike2PMStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win'){
