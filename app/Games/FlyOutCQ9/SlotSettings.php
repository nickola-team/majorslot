    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable['1']  = [0,0,0,40,100,250];
            $this->Paytable['2']  = [0,0,0,30,80,200];
            $this->Paytable['3']  = [0,0,0,25,60,175];
            $this->Paytable['4']  = [0,0,0,20,50,150];
            $this->Paytable['11']  = [0,0,0,10,20,100];
            $this->Paytable['12']  = [0,0,0,8,15,90];
            $this->Paytable['13'] = [0,0,0,6,12,80];
            $this->Paytable['14'] = [0,0,0,5,10,70];
            $reel = new GameReel();
            foreach( [
                'reelStrip1', 
                'reelStrip2', 
