...
namespace VanguardLTE\Games\IceLobsterPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameIceLobsterStack::where('id', 20405)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameIceLobsterStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                        $stacks = $stacks->where('pur_level', $pur);
                    }
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameIceLobsterStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
