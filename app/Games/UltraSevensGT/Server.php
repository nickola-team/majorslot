    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('UltraSevensGTDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('UltraSevensGTDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                {
                    ...
                    $_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11 = $slotSettings->UpdateJackpots($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines']);
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D131A3C2E07352122130E5C3E02361237025C35222F11 = 0;
                    $lineWins = [];
                    $cWins = [
                        0, 
                        0, 
                    ...
                    if( isset($_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11) && $_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11['isJackPay'] ) 
                    {
                        ...
                        if( $_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11['isJackId'] == 1 ) 
                        {
                            $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01 = [
                                'P_2', 
                                'P_3'
                            ];
                            shuffle($_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01);
                        }
                        if( $_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11['isJackId'] == 2 ) 
                        {
                            $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01 = [
                                'P_4', 
                                'P_5', 
                        ...
                        for( $_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11 = 1; $_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11 <= 5; $_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11++ ) 
                        {
                            ...
                            if( $_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11['isJackId'] == 1 ) 
                            {
                                $_obf_0D3C16222603400110303E28280C3129292D3931103B32 = $slotSettings->PutBonusToLine($_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11, $linesId[$_obf_0D37130A2C2C241025221C3437223C310B0D1226133032][$_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11 - 1], $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01[0]);
                                $reels['reel' . $_obf_0D141E31211D2540361A2E225B0B1C01271C5B0B1F2F11] = [
                                    $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01[0], 
                                    $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01[0], 
                                    $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01[0], 
                                    $_obf_0D02403B2D191E3D100A0E1209290A253B1D362B273C01[0], 
                                    ''
                    ...
                    $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 = 0;
                    for( $k = 0; $k < $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines']; $k++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 = $_obf_0D011C142C3C37263F351C4012170A074027083F321132;
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                    ...
                    else
                    {
                        if( $i > 1500 ) 
                        {
                            $response = $winType . '|' . $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 . '|' . $totalWin . '{"responseEvent":"error","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":"Bad Reel Strip"}';
                            exit( $response );
                        }
                        if( $_obf_0D2B213913373B3B270F1A261533331D252F06302F2C32 >= 20 ) 
                        {
                            if( $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_7' || $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_6' || $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_5' || $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_4' ) 
                            {
                                $_obf_0D131A3C2E07352122130E5C3E02361237025C35222F11 = 2;
                            }
                            else if( $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_3' || $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_2' ) 
                            {
                                $_obf_0D131A3C2E07352122130E5C3E02361237025C35222F11 = 1;
                            }
                            else if( $_obf_0D07402C2F0B052E132A1F323C2E3D22111C1E3D250E01 == 'P_1' ) 
                            {
                                $_obf_0D131A3C2E07352122130E5C3E02361237025C35222F11 = 0;
                            }
                            break;
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('UltraSevensGTFreeGames') <= $slotSettings->GetGameData('UltraSevensGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('UltraSevensGTTotalWin') + $totalWin > 0 ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"$jackState":' . json_encode($_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11) . ',"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"slotJackpot":[' . implode(',', $slotSettings->slotJackpot) . '],"totalFreeGames":' . $slotSettings->GetGameData('UltraSevensGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('UltraSevensGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
