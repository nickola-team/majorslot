...
namespace VanguardLTE\Games\TemujinTreasuresPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,40,100];
            $this->Paytable[4] = [0,0,0,10,15,25];
            $this->Paytable[5] = [0,0,0,5,10,15];
            $this->Paytable[6] = [0,0,0,3,5,10];
            $this->Paytable[7] = [0,0,0,3,5,10];
            $this->Paytable[8] = [0,0,0,2,3,5];
            $this->Paytable[9] = [0,0,0,2,3,5];
            $this->Paytable[10] = [0,0,0,2,3,5];
            $this->Paytable[11] = [0,0,0,2,3,5];
            $this->Paytable[12] = [0,0,0,2,3,5];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameTemujinTreasuresStack::where('id', 3)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTemujinTreasuresStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTemujinTreasuresStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
