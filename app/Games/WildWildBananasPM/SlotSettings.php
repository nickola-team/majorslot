...
namespace VanguardLTE\Games\WildWildBananasPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildWildBananasStack::where('id', 133598)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameWildWildBananasStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
