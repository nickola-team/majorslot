...
namespace VanguardLTE\Games\LittleGemHoldandSpinPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,500];
            $this->Paytable[4] = [0,0,0,50];
            $this->Paytable[5] = [0,0,0,50];
            $this->Paytable[6] = [0,0,0,20];
            $this->Paytable[7] = [0,0,0,20];
            $this->Paytable[8] = [0,0,0,20];
            $this->Paytable[9] = [0,0,5,20];
            $this->Paytable[10] = [0,0,0,5];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameLittleGemHoldandSpinStack::where('id', 288)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameLittleGemHoldandSpinStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                $index = mt_rand(0, 29000);
                if($winType == 'win'){
                    $stacks = $stacks->where('odd', '>', 0);
                    $index = mt_rand(0, 195000);
                }
                if($isLowBank == true){
                    if($winType == 'bonus'){
