...
namespace VanguardLTE\Games\JackpotHunterPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameJackpotHunterStack::where('id', 4)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($pur >= 0)
                    {
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameJackpotHunterStack::where(['pur_level'=> $pur])->whereNotIn('id', $existIds);
                    }
                    else
                    {
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameJackpotHunterStack::where(['spin_type'=> 1])->whereNotIn('id', $existIds);
                    }
                }else{
