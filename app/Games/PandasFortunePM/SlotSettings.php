...
namespace VanguardLTE\Games\PandasFortunePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePandasFortuneStack::where('id', 583)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGamePandasFortuneStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
