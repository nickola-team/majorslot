<?php 
namespace VanguardLTE\Games\MonkeyMadnessPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $Balance = $slotSettings->GetBalance();
                $response = 'def_s=8,4,8,3,8,3,8,4,8&c_paytable=9~any~5,6,7~4,0,0~2&balance='. $Balance .'&cfgs=2238&reel1=5,8,7,8,4,8,3,8,3,8,2,8,5,8,5,8,7,8,7,8,7,8,6,8,4,8,2,8,6,8&ver=2&reel0=5,8,6,8,4,8,7,8,2,8,7,8,3,8,5,8,7,8,6,8,3,8,6,8,4,8,6,8,5,8,5,8,7,8&index=1&balance_cash='. $Balance .'&def_sb=8,7,8&def_sa=8,6,8&reel2=6,8,4,8,7,8,5,8,6,8,7,8,6,8,3,8,7,8,5,8,7,8,5,8,4,8,5,8,2,8,7,8,6,8&balance_bonus=0.00&na=s&scatters=1~0,0,0~0,0,0~1,1,1&gmb=0,0,0&rt=d&rid='. $slotSettings->GetGameData($slotSettings->slotId . 'RoundID') .'&stime='. floor(microtime(true) * 1000) .'&sa=8,6,8&sb=8,7,8&sc='. implode(',', $slotSettings->Bet) . '&defc=100.00&sh=3&wilds=2~1000,0,0~1,9,3&bonuses=0&fsbonus=&c='. $bet .'&sver=5&counter=2&paytable=0,0,0;0,0,0;0,0,0;50,0,0;30,0,0;20,0,0;12,0,0;8,0,0;0,0,0&l=9&s='.$lastReelStr;
            }
