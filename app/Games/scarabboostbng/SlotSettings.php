...
namespace VanguardLTE\Games\scarabboostbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameScarabBoostStack::where('id', 314)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameScarabBoostStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameScarabBoostStack::where('spin_type', 0);
                }
