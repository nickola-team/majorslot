...
namespace VanguardLTE\Games\HotChilliPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,100,1000];
            $this->Paytable[4] = [0,0,0,15,75,500];
            $this->Paytable[5] = [0,0,0,10,50,250];
            $this->Paytable[6] = [0,0,0,5,12,50];
            $this->Paytable[7] = [0,0,0,5,12,50];
            $this->Paytable[8] = [0,0,0,5,12,50];
            $this->Paytable[9] = [0,0,0,0,0,0];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,40.00,80.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,1500.00,3000.00,4000.00,5000.00,6000.00,7000.00,8000.00,9000.00,10000.00,11000.00]; 
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHotChilliStack::where('id', 6)->first();
