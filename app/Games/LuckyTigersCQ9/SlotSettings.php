...
namespace VanguardLTE\Games\LuckyTigersCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                    // $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyTigersStack::where('id', 170496)->first(); 
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyTigersStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyTigersStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
