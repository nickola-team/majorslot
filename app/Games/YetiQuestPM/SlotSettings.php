...
namespace VanguardLTE\Games\YetiQuestPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameYetiQuestStack::where('id', 5)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYetiQuestStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
