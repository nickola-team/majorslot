...
namespace VanguardLTE\Games\SafariKingPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[5.00,10.00,15.00,20.00,40.00,60.00,80.00,100.00,150.00,200.00,400.00,600.00,800.00,1000.00,1200.00,1400.00,1600.00,1800.00,2000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSafariKingStack::where('id', 366)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameSafariKingStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
