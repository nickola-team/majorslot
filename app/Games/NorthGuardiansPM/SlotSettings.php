...
namespace VanguardLTE\Games\NorthGuardiansPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,30,200,750];
            $this->Paytable[3] = [0,0,0,26,150,500];
            $this->Paytable[4] = [0,0,0,20,120,300];
            $this->Paytable[5] = [0,0,0,12,80,180];
            $this->Paytable[6] = [0,0,0,10,40,120];
            $this->Paytable[7] = [0,0,0,8,20,80];
            $this->Paytable[8] = [0,0,0,6,12,60];
            $this->Paytable[9] = [0,0,0,4,10,40];
            $this->Paytable[10] = [0,0,0,4,10,40];
            $this->Paytable[11] = [0,0,0,2,6,24];
            $this->Paytable[12] = [0,0,0,2,6,24];
            $this->Paytable[13] = [0,0,0,2,6,24];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameNorthGuardiansPMStack::where('id', 96)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameNorthGuardiansStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
