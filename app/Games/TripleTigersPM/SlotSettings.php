...
namespace VanguardLTE\Games\TripleTigersPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameTripleTigersStack::where('id', 83)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameTripleTigersStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
