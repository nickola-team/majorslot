...
namespace VanguardLTE\Games\SpellbindingMysteryPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSpellbindingMysteryStack::where('id', 33109)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSpellbindingMysteryStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSpellbindingMysteryStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
