...
namespace VanguardLTE\Games\MonsterSuperLanchePM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMonsterSuperLancheStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMonsterSuperLancheStack::where('spin_type', 0);
                }
