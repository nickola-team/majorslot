...
namespace VanguardLTE\Games\MonsterSuperLanchePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMonsterSuperLancheStack::where('id', 35101)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMonsterSuperLancheStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMonsterSuperLancheStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
