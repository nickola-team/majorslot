...
namespace VanguardLTE\Games\CoffeeWildPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCoffeeWildStack::where('id', 26)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCoffeeWildStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCoffeeWildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
