...
namespace VanguardLTE\Games\FloatingDragonPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFloatingDragonStack::where('id', 118742)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFloatingDragonStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
