...
namespace VanguardLTE\Games\MadameDestinyMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4] = [0,0,0,20,40,50,75];
            $this->Paytable[5] = [0,0,0,6,10,20,40];
            $this->Paytable[6] = [0,0,0,6,10,16,30];
            $this->Paytable[7] = [0,0,0,4,8,10,25];
            $this->Paytable[8] = [0,0,0,4,8,10,25];
            $this->Paytable[9] = [0,0,0,4,8,10,20];
