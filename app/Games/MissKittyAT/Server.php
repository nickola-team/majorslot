        ...
        public function get($request, $game)
        {
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gameInit' ) 
            {
                ...
                if( $lastEvent != 'NULL' ) 
                {
                    ...
                    $_obf_0D3E0B080B0F030B0909331A101C0E0F3C293D02021501 = $slotSettings->GetGameData('MissKittyATholdWildsStr');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $_obf_0D3E0B080B0F030B0909331A101C0E0F3C293D02021501 = $slotSettings->GetGameData('MissKittyATholdWildsArr');
                        if( !is_array($_obf_0D3E0B080B0F030B0909331A101C0E0F3C293D02021501) ) 
                        {
                            $_obf_0D3E0B080B0F030B0909331A101C0E0F3C293D02021501 = [];
                        }
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    $slotSettings->SetGameData('MissKittyATholdWildsArr', $_obf_0D225B3F13061F0D2831331E395B342A193E1838012601);
                    $slotSettings->SetGameData('MissKittyATholdWildsStr', $_obf_0D021538231719150A1B3C210F111B272E5B1E31300E11);
                ...
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('MissKittyATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('MissKittyATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('MissKittyATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":{},"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                $_obf_0D1D385C3B2E29221F233F3E3D09295B0F1B0D063B3222 = [];
                for( $i = 1; $i <= 5; $i++ ) 
                {
