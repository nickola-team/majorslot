...
namespace VanguardLTE\Games\TheDogHouseMultiholdPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseMultiholdStack::where('id', 12515)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseMultiholdStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseMultiholdStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
