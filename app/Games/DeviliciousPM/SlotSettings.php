<?php 
namespace VanguardLTE\Games\DeviliciousPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDeviliciousStack::where('id', 5)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameDeviliciousStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
