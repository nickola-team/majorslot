<?php 
namespace VanguardLTE\Games\WildWestGoldMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,10,12,15,20];
            $this->Paytable[4] = [0,0,0,8,10,12,15];
            $this->Paytable[5] = [0,0,0,6,8,10,12];
            $this->Paytable[6] = [0,0,0,5,6,8,10];
            $this->Paytable[7] = [0,0,0,3,4,6,8];
            $this->Paytable[8] = [0,0,0,3,4,6,8];
            $this->Paytable[9] = [0,0,0,2,3,4,6];
            $this->Paytable[10] = [0,0,0,2,3,4,6];
            $this->Paytable[11] = [0,0,0,1,2,3,5];
            $this->Paytable[12] = [0,0,0,1,2,3,5];
            $this->Paytable[13] = [0,0,0,1,2,3,5];
