...
namespace VanguardLTE\Games\StreetRacerPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,125,250,1000];
            $this->Paytable[4] = [0,0,0,75,175,750];
            $this->Paytable[5] = [0,0,0,60,125,500];
            $this->Paytable[6] = [0,0,0,50,100,375];
            $this->Paytable[7] = [0,0,0,35,75,250];
            $this->Paytable[8] = [0,0,0,25,50,200];
            $this->Paytable[9] = [0,0,0,15,35,150];
            $this->Paytable[10] = [0,0,0,12,25,100];
            $this->Paytable[11] = [0,0,0,10,20,75];
            $this->Paytable[12] = [0,0,0,7,15,50];
            $this->Paytable[13] = [0,0,0,5,10,25];
            $this->Paytable[14] = [0,0,0,5,10,25];
            $this->Paytable[15] = [0,0,0,3,5,12];
            $this->Paytable[16] = [0,0,0,3,5,12];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameStreetRacerStack::where('id', 83)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameStreetRacerStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($ind > -1){
