    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('GemQueenDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('GemQueenDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'slotGamble' ) 
            {
                ...
                $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), $_obf_0D33130E1F150A28331B2F322B291E402639242D2B2D22 * -1);
                $_obf_0D14303C231C032D241D0B0B3536181C110C0D0A2B1932 = $slotSettings->GetBalance();
                $_obf_0D300C2F21350336261622142A322E0C270C0A1F2F0422 = '{"bonusWin":' . $slotSettings->GetGameData('GemQueenBonusWin') . ',"dealerCard":"' . $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 . '","gambleState":"' . $_obf_0D0E2C2E373C171C3B0B2905400E372723283E18043511 . '","totalWin":' . $totalWin . ',"afterBalance":' . $_obf_0D14303C231C032D241D0B0B3536181C110C0D0A2B1932 . ',"Balance":' . $Balance . '}';
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'spin' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
            {
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
                {
                    ...
                    {
                        $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = $slotSettings->GetGameData('GemQueenFreeMpl');
                    }
                    else
                    {
                        $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = 1;
                ...
                $Balance = $slotSettings->GetBalance();
                $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01 = $slotSettings->GetGameData('GemQueenChangeMap');
                $_obf_0D2C235B0428363727080401172A3E0B0B1A282B2C1C11 = $slotSettings->GetGameData('GemQueenReelsMap');
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    {
                        $_obf_0D2C3832163F282A5C100B120D1405400B1F0A131C1201 = '"currentScene":"main","multiplier":1,"freeSpinsWin":' . $slotSettings->GetGameData('GemQueenBonusWin') . ',"freeSpinsCount":0,"initialFreeSpinWin":' . $slotSettings->GetGameData('GemQueenStartBonusWin') . ',"initialFreeSpinsCount":' . $slotSettings->slotFreeCount . ',"totalFreeSpinsCount":' . $slotSettings->GetGameData('GemQueenFreeGames');
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
                {
                    ...
                    {
                        $scene = 'freeSpins';
                        $_obf_0D1C231A0E031F31322210232613395C211818212F2122 = ',"freeSpinsCount":' . ($slotSettings->GetGameData('GemQueenFreeGames') - $slotSettings->GetGameData('GemQueenCurrentFreeGame')) . ',"freeSpinsWin":' . $slotSettings->GetGameData('GemQueenBonusWin') . ',"initialFreeSpinWin":' . $slotSettings->GetGameData('GemQueenStartBonusWin') . ',"initialFreeSpinsCount":' . $slotSettings->slotFreeCount . ',"totalFreeSpinsCount":' . $slotSettings->GetGameData('GemQueenFreeGames');
                        $roundEnded = 'false';
                    ...
                    $_obf_0D2C3832163F282A5C100B120D1405400B1F0A131C1201 = '"currentScene":"' . $scene . '","multiplier":' . $_obf_0D08093040090E063B5C26132F360D2F330E5C09261C22 . ',"collapsingCount": 0,"collapsingWin":' . $slotSettings->GetGameData('GemQueenTotalWin') . ',"isReSpin":false' . $_obf_0D1C231A0E031F31322210232613395C211818212F2122;
                    $_obf_0D041F24253F082C2819131524043726312E1536091F01 = '' . $_obf_0D18322F1D343B3D031D301B09113719372C0736301A11;
                    ...
                    if( $totalWin > 0 || $_obf_0D18322F1D343B3D031D301B09113719372C0736301A11 != '' ) 
                    {
                        ...
                        $_obf_0D2C3832163F282A5C100B120D1405400B1F0A131C1201 = '"currentScene":"' . $scene . '","multiplier":' . $_obf_0D08093040090E063B5C26132F360D2F330E5C09261C22 . ',"collapsingCount": ' . $slotSettings->GetGameData('GemQueenReSpinCount') . ',"collapsingWin":' . $slotSettings->GetGameData('GemQueenTotalWin') . ',"isReSpin":true' . $_obf_0D1C231A0E031F31322210232613395C211818212F2122;
                        $roundEnded = 'false';
                    }
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                {
                    ...
                    if( $totalWin > 0 || $_obf_0D18322F1D343B3D031D301B09113719372C0736301A11 != '' ) 
                    {
                        $slotSettings->SetGameData('GemQueenIsReSpin', 1);
                        $slotSettings->SetGameData('GemQueenReSpinCount', 1);
                        $_obf_0D2C3832163F282A5C100B120D1405400B1F0A131C1201 = '"currentScene":"main","multiplier":1,"collapsingCount": ' . $slotSettings->GetGameData('GemQueenReSpinCount') . ',"collapsingWin":' . $slotSettings->GetGameData('GemQueenTotalWin') . ',"isReSpin":true';
                        $roundEnded = 'false';
                    }
                }
                ...
                $_obf_0D265B3F1C3639042D1E30283727011A400E1626053832 = $slotSettings->GetGameData('GemQueenReelsMap');
                $slotSettings->SetGameData('GemQueenChangeMap', $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01);
                $slotSettings->SetGameData('GemQueenReelsMap', $_obf_0D3C090E192F3D26100429351F02123B310C3504040132);
