...
namespace VanguardLTE\Games\WildBisonChargePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildBisonChargeStack::where('id', 8346)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWildBisonChargeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWildBisonChargeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
