...
namespace VanguardLTE\Games\FloatingDragonHoldSpinMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,20,40,200,500,1000];
            $this->Paytable[3] = [0,0,0,20,40,50,100];
            $this->Paytable[4] = [0,0,0,6,10,20,50];
            $this->Paytable[5] = [0,0,0,6,10,16,40];
            $this->Paytable[6] = [0,0,0,4,8,12,30];
            $this->Paytable[7] = [0,0,0,4,8,12,30];
            $this->Paytable[8] = [0,0,0,4,8,12,30];
            $this->Paytable[9] = [0,0,0,2,4,8,20];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameFloatingDragonHoldSpinMegawaysStack::where('id', 62)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFloatingDragonHoldSpinMegawaysStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
