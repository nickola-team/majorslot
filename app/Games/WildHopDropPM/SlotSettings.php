<?php 
namespace VanguardLTE\Games\WildHopDropPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildHopDropStack::where('id', 51)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameWildHopDropStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
