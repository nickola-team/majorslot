...
namespace VanguardLTE\Games\GatesofValhallaPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,100,1500];
            $this->Paytable[4] = [0,0,0,10,50,400];
            $this->Paytable[5] = [0,0,0,10,25,200];
            $this->Paytable[6] = [0,0,0,6,20,100];
            $this->Paytable[7] = [0,0,0,4,10,70];
            $this->Paytable[8] = [0,0,0,4,10,50];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameGatesofValhallaStack::where('id', 9)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGatesofValhallaStack::where('spin_type', '>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGatesofValhallaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
