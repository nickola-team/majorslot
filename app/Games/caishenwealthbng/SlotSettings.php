...
namespace VanguardLTE\Games\caishenwealthbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameCaishenWealthStack::where('id', 836)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 90){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCaishenWealthStack::where('spin_type', 2);
                    }else{
