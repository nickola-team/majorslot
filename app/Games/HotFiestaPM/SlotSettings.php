...
namespace VanguardLTE\Games\HotFiestaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHotFiestaStack::where('id', 25751)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHotFiestaStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
