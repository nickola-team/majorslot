...
namespace VanguardLTE\Games\HottoBurnHoldandSpinPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHottoBurnHoldandSpinStack::where('id', 22385)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHottoBurnHoldandSpinStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                $index = mt_rand(0, 53000);
                if($winType == 'win'){
