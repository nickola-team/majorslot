...
namespace VanguardLTE\Games\MagicWorldCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameMagicWorldStack::where('id', 79378)->first();  //102155,67927,12777,24186
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMagicWorldStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMagicWorldStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
