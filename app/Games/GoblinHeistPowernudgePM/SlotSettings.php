<?php 
namespace VanguardLTE\Games\GoblinHeistPowernudgePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4] = [0,0,0,16,50,250];
            $this->Paytable[5] = [0,0,0,12,30,150];
            $this->Paytable[6] = [0,0,0,8,20,100];
            $this->Paytable[7] = [0,0,0,6,14,40];
            $this->Paytable[8] = [0,0,0,4,10,30];
            $this->Paytable[9] = [0,0,0,2,6,20];
