...
namespace VanguardLTE\Games\LeprechaunSongPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[10.00,20.00,30.00,40.00,50.00,100.00,150.00,200.00,350.00,500.00,1000.00,1500.00,2000.00,2500.00,3000.00,3500.00,4000.00,4500.00,5000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameLeprechaunCarolStack::where('id', 1230)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameLeprechaunCarolStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
