...
namespace VanguardLTE\Games\BookofTutMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBookofTutMegawaysStack::where('id', 17672)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($pur >= 0){
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameBookofTutMegawaysStack::where('spin_type', 1)->where('pur_level', $pur)->whereNotIn('id', $existIds);
                    }else{
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameBookofTutMegawaysStack::where('spin_type', 1)->where('pur_level', '<', 1)->whereNotIn('id', $existIds);
                    }
                    
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBookofTutMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
