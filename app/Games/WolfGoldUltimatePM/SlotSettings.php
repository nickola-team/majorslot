...
namespace VanguardLTE\Games\WolfGoldUltimatePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWolfGoldUltimateStack::where('id', 17448)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWolfGoldUltimateStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWolfGoldUltimateStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
