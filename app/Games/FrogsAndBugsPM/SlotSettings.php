...
namespace VanguardLTE\Games\FrogsAndBugsPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFrogsAndBugsStack::where('id', 33363)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFrogsAndBugsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFrogsAndBugsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
