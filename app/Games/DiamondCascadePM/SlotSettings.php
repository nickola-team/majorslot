<?php 
namespace VanguardLTE\Games\DiamondCascadePM
{
    class SlotSettings
    {
        ...
        if( $this->isBonusStart || $slotState == 'bonus' || $slotState == 'doBonus' || $slotState == 'freespin' || $slotState == 'doRespin' ) 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDiamondCascadeStack::where('id', 2)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($pur == 0){
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameDiamondCascadeStack::where('spin_type',1)->whereNotIn('id', $existIds);
                    }else{
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameDiamondCascadeStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                    }
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameDiamondCascadeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
