...
namespace VanguardLTE\Games\chinafestivalbng
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $selectedMod)
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameChinaFestivalStack::where('id', 87136)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    //     $stacks = \VanguardLTE\BNGGameStackModel\BNGGame3PotsofEgyptStack::where('spin_type', 2);
                    // }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameChinaFestivalStack::where(['spin_type' => 2,'pur_level' => $pur]);
                    // }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameChinaFestivalStack::where('spin_type', 0);
                }
