...
namespace VanguardLTE\Games\PirateGoldenAgePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePirateGoldenAgeStack::where('id', 9418)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePirateGoldenAgeStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePirateGoldenAgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
