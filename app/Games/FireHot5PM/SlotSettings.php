...
namespace VanguardLTE\Games\FireHot5PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFireHot5Stack::where('id', 410)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireHot5Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
