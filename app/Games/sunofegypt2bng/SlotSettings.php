...
namespace VanguardLTE\Games\sunofegypt2bng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt2Stack::where('id', 8274)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt2Stack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt2Stack::where('spin_type', 0);
                }
