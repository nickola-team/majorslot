        ...
        public function GetReelStrips($winType, $fsmax, $bet, $ind = -1)
        {
            ...
            while(true){
                if($fsmax > 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where('spin_type', 2);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where('spin_type', 0);
                }
