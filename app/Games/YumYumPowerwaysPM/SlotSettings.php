...
namespace VanguardLTE\Games\YumYumPowerwaysPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $fsmax, $bet, $ind = -1)
        {
            ...
            //         $id = 13692;
            //     }
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where([
            //         'fsmax' => $fsmax,
            //         'spin_type' => 1,
            //         'id' => $id
            //     ])->first();
            ...
            while(true){
                if($fsmax > 0){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where([
                        'fsmax' => $fsmax,
                        'spin_type' => 1
                    ]);
                }else if($fsmax == 0 && $winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where('spin_type', 2)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameYumYumPowerwaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
