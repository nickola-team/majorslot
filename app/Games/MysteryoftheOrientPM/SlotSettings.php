...
namespace VanguardLTE\Games\MysteryoftheOrientPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryoftheOrientStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryoftheOrientStack::where('spin_type', 0);
                }
