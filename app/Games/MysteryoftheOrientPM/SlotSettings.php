...
namespace VanguardLTE\Games\MysteryoftheOrientPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMysteryoftheOrientStack::where('id', 28989)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryoftheOrientStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryoftheOrientStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
