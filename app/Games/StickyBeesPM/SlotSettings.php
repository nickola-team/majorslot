<?php 
namespace VanguardLTE\Games\StickyBeesPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameStickyBeesStack::where('id', 811)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameStickyBeesStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameStickyBeesStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
