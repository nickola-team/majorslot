...
namespace VanguardLTE\Games\FunnyAlpacaCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFunnyAlpacaStack::where('id', 24545)->first();   //24545,920
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFunnyAlpacaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFunnyAlpacaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
