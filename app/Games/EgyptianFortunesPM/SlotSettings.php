...
namespace VanguardLTE\Games\EgyptianFortunesPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameEgyptianFortunesStack::where('id', 204)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameEgyptianFortunesStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
