<?php 
namespace VanguardLTE\Games\ExcaliburUnleashedPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameExcaliburUnleashedStack::where('id', 5651)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameExcaliburUnleashedStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameExcaliburUnleashedStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
