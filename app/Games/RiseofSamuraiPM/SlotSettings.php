...
namespace VanguardLTE\Games\RiseofSamuraiPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameRiseofSamuraiStack::where('id', 367)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameRiseofSamuraiStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($ind > -1){
