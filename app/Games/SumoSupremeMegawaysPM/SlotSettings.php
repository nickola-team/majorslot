<?php 
namespace VanguardLTE\Games\SumoSupremeMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSumoSupremeMegawaysStack::where('id', 41571)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSumoSupremeMegawaysStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSumoSupremeMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
