...
namespace VanguardLTE\Games\AladdinandtheSorcererPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,75,200,1000];
            $this->Paytable[3] = [0,0,0,75,200,1000];
            $this->Paytable[4] = [0,0,0,40,100,400];
            $this->Paytable[5] = [0,0,0,30,75,250];
            $this->Paytable[6] = [0,0,0,25,60,200];
            $this->Paytable[7] = [0,0,0,20,40,150];
            $this->Paytable[8] = [0,0,0,15,30,125];
            $this->Paytable[9] = [0,0,0,10,25,100];
            $this->Paytable[10] = [0,0,0,7,20,75];
            $this->Paytable[11] = [0,0,0,5,15,50];
            $this->Paytable[12] = [0,0,0,3,10,40];
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameAladdinandtheSorcererStack::where('id', 624)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameAladdinandtheSorcererStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
