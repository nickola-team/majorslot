...
namespace VanguardLTE\Games\SamuraiCodePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSamuraiCodeStack::where('id', 85)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSamuraiCodeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSamuraiCodeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
