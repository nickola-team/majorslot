...
namespace VanguardLTE\Games\MyeongRyangCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameMyeongRyangStack::where('id', 3020)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMyeongRyangStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMyeongRyangStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
