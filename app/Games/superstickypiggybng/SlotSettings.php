...
namespace VanguardLTE\Games\superstickypiggybng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameSuperStickyPiggyStack::where('id', 104652)->first();
            ...
            $isLowBank = false;
            while(true){
                $stacks = \VanguardLTE\BNGGameStackModel\BNGGameSuperStickyPiggyStack::where('pur_level', $spintype);
