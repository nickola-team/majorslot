...
namespace VanguardLTE\Games\crystalscarabsbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameCrystalScarabsStack::where('id', 1950)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 120){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCrystalScarabsStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCrystalScarabsStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameCrystalScarabsStack::where('spin_type', 0);
                }
