...
namespace VanguardLTE\Games\FruitRainbowPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[5] = [0,0,0,40,150,500];
            $this->Paytable[6] = [0,0,0,30,100,400];
            $this->Paytable[7] = [0,0,0,20,90,300];
            $this->Paytable[8] = [0,0,0,15,80,250];
            $this->Paytable[9] = [0,0,0,10,60,200];
            $this->Paytable[10] = [0,0,0,10,50,140];
            $this->Paytable[11] = [0,0,0,5,50,100];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFruitRainbowStack::where('id', 30)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFruitRainbowStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
