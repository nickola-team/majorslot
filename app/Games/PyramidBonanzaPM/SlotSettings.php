...
namespace VanguardLTE\Games\PyramidBonanzaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSweetBonanzaStack::where('id', 3)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetBonanzaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetBonanzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
