    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            // if($winType == 'bonus' && $ind == -1){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDancePartyStack::where('id', 421)->first();
            ...
            while(true){
                ...
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameDancePartyStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
