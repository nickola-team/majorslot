...
namespace VanguardLTE\Games\VikingForgePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameVikingForgeStack::where('id', 4)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameVikingForgeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameVikingForgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
