        ...
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                    {
                        ...
                        else
                        {
                            ...
                            $_obf_0D1B1910172D03132D040D301C2A39140C2F0A265C1532[40] = [
                                [
                                    0, 
                                    1, 
                                    2, 
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"xWin":[' . implode(',', $_obf_0D1429360F31270405361919301D27322535111C390B32) . '],"add":0,"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('JaguarMistATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('JaguarMistATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"xWin":[' . implode(',', $_obf_0D1429360F31270405361919301D27322535111C390B32) . '],"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . '';
                    }
                    else
                    {
                ...
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":{},"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                $_obf_0D1D385C3B2E29221F233F3E3D09295B0F1B0D063B3222 = [];
                for( $i = 1; $i <= 5; $i++ ) 
                {
