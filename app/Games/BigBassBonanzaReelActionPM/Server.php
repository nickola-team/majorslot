<?php 
namespace VanguardLTE\Games\BigBassBonanzaReelActionPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,9,3,4,12,6,11,8,6,8,5,12,9,5,9]);
