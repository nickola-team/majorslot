...
namespace VanguardLTE\Games\BigBassBonanzaKeepingitReelPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBigBassBonanzaKeepingitReelStack::where('id', 542)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassBonanzaKeepingitReelStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassBonanzaKeepingitReelStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
