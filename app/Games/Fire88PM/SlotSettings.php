...
namespace VanguardLTE\Games\Fire88PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFire88Stack::where('id', 721)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFire88Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
