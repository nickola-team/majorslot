...
namespace VanguardLTE\Games\WanbaoDinoCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameWanbaoDinoStack::where('id', 115771)->first(); //22650,115771
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWanbaoDinoStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWanbaoDinoStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
