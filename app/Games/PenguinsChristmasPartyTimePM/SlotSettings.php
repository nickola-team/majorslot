...
namespace VanguardLTE\Games\PenguinsChristmasPartyTimePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePenguinsChristmasPartyTimeStack::where('id', 5)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePenguinsChristmasPartyTimeStack::where(['spin_type'=> 1])->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePenguinsChristmasPartyTimeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
