...
namespace VanguardLTE\Games\SantaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSantaStack::where('id', 899)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameSantaStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
