...
namespace VanguardLTE\Games\MightyMunchingMelonsPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMightyMunchingMelonsStack::where('id', 24766)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMightyMunchingMelonsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMightyMunchingMelonsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
