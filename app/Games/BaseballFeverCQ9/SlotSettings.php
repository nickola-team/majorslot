    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable['1']  = [0,0,0,60,180,600];
            $this->Paytable['2']  = [0,0,0,50,120,400];
            $this->Paytable['3']  = [0,0,0,40,80,270];
            $this->Paytable['4']  = [0,0,0,30,60,180];
            $this->Paytable['11']  = [0,0,0,30,50,100];
            $this->Paytable['12']  = [0,0,0,25,40,100];
            $this->Paytable['13'] = [0,0,0,15,30,80];
            $this->Paytable['14'] = [0,0,0,15,25,60];
            $this->Paytable['15'] = [0,0,0,10,20,60];
            $reel = new GameReel();
            foreach( [
                'reelStrip1', 
                'reelStrip2', 
