...
namespace VanguardLTE\Games\WildGladiatorPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildGladiatorStack::where('id', 28)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameWildGladiatorStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
