...
namespace VanguardLTE\Games\FangtasticFreespinsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFangtasticFreespinsStack::where('id', 16944)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFangtasticFreespinsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFangtasticFreespinsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
