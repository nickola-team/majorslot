<?php 
namespace VanguardLTE\Games\FangtasticFreespinsPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [6,12,4,6,12,3,9,8,3,8,4,11,12,4,10]);
