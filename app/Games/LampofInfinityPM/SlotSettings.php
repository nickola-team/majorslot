...
namespace VanguardLTE\Games\LampofInfinityPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameLampofInfinityStack::where('id', 811)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLampofInfinityStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLampofInfinityStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
