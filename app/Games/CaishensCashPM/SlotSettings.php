    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            // if($winType == 'bonus' && $ind == -1){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCaishensCashStack::where('id', 459)->first();
            ...
            while(true){
                ...
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCaishensCashStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
