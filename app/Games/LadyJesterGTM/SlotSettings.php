...
namespace VanguardLTE\Games\LadyJesterGTM
{
    class SlotSettings
    {
        ...
        {
            $totalWin = 0;
            $_obf_0D0C16113E0F062A402F26030E1233075B0B2B1A275B32 = 0;
            $_obf_0D2F312D3B05072F401314011832220C0C2A1B31213D01 = true;
            for( $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 = 0; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 <= 5; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01++ ) 
            {
                $cWins = [
                    0, 
                    0, 
                ...
                for( $k = 0; $k < $lines; $k++ ) 
                {
                    for( $j = 0; $j < count($this->SymbolGame); $j++ ) 
                    {
                        ...
                        if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == $scatter || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_1' || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_2' || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_3' || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_4' ) 
                        {
                        }
                        else
                        {
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132][1] * $bet * $mpl;
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132][2] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                {
                                    $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132][3] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                {
                                    $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132][4] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                {
                                    $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132][5] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                {
                                    $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                }
                ...
                if( $totalWin < $_obf_0D0C16113E0F062A402F26030E1233075B0B2B1A275B32 ) 
                {
                    $_obf_0D0C16113E0F062A402F26030E1233075B0B2B1A275B32 = $totalWin;
                }
                if( $_obf_0D2F312D3B05072F401314011832220C0C2A1B31213D01 ) 
                {
                    $_obf_0D2F312D3B05072F401314011832220C0C2A1B31213D01 = false;
                    $_obf_0D0C16113E0F062A402F26030E1233075B0B2B1A275B32 = $totalWin;
                }
            }
            return $_obf_0D0C16113E0F062A402F26030E1233075B0B2B1A275B32;
        }
