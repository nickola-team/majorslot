<?php 
namespace VanguardLTE\Games\MuertosMultiplierMegawaysPM
{
    class SlotSettings
    {
        ...
        public function BonusWinChance($fsmax)
        {
            $fsChance = [0,0,0,0,0,64.43,68.37,72.05,75.39,78.27,80.80,82.99,84.83,86.41,0]; // [4, 6, 8, 10, 12]
            $percent = mt_rand(0, 10000);
            if($percent < $fsChance[$fsmax] * 70){
                return true;
            }else{
                return false;
            }
        ...
        public function GetReelStrips($winType, $fsmax, $bet, $ind = -1)
        {
            ...
            //         $id = 18;
            //     }
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameMuertosMultiplierMegawaysStack::where([
            //         'fsmax' => $fsmax,
            //         'spin_type' => 1,
            //         'id' => $id
            //     ])->first();
            ...
            while(true){
                ...
                if($fsmax > 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMuertosMultiplierMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($winType == 'win'){
