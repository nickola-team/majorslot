...
namespace VanguardLTE\Games\_15goldeneggsbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGame15GoldenEggsStack::where('id', 62077)->first();
            ...
            while(true){
                if($winType == 'bonus'){                    
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame15GoldenEggsStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame15GoldenEggsStack::where('spin_type', 0);
                }
