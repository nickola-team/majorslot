...
namespace VanguardLTE\Games\RainbowReelsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType='bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameRainbowReelsStack::where([
                //     'id' => 1
                // ])->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRainbowReelsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRainbowReelsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
