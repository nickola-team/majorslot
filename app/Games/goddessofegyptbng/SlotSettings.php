...
namespace VanguardLTE\Games\goddessofegyptbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameGoddessofEgyptStack::where('id', 232)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGoddessofEgyptStack::where('spin_type',1);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGoddessofEgyptStack::where('spin_type', 0);
                }
