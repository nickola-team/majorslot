...
namespace VanguardLTE\Games\GemstonePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGemstoneStack::where('id', 21303)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGemstoneStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
