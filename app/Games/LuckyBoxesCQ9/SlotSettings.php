...
namespace VanguardLTE\Games\LuckyBoxesCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBoxesStack::where('id', 43267)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBoxesStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLuckyBoxesStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
