...
namespace VanguardLTE\Games\FuFuFuPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,100];
            $this->Paytable[4] = [0,0,0,50];
            $this->Paytable[5] = [0,0,0,25];
            $this->Paytable[6] = [0,0,0,0];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[200.00,400.00,600.00,800.00,1000.00,2000.00,3000.00,4000.00,5000.00,7500.00,10000.00,20000.00,30000.00,40000.00,50000.00,60000.00,70000.00,80000.00,100000.00]; 
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFuFuFuStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
