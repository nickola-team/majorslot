...
namespace VanguardLTE\Games\DragoJewelsofFortunePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4] = [0,0,0,20,40,100];
            $this->Paytable[5] = [0,0,0,15,25,50];
            $this->Paytable[6] = [0,0,0,10,20,40];
            $this->Paytable[7] = [0,0,0,8,10,20];
            $this->Paytable[8] = [0,0,0,6,8,15];
            $this->Paytable[9] = [0,0,0,6,8,10];
            $this->Paytable[10] = [0,0,0,4,6,10];
            $this->Paytable[11] = [0,0,0,4,6,10];
            $this->Paytable[12] = [0,0,0,0,0,0];
            $this->Paytable[13] = [0,0,0,0,0,0];

            $this->DragonPaytable[0] = [0,0,0,0,0,10,25,50,75,100,250,250,500,500,500,750,750,750,750,750,5000,5000,5000];
            $this->DragonPaytable[1] = [0,0,0,0,0,5,10,20,40,60,80,80,100,100,100,250,250,250,250,250,500,500,500];
            $this->DragonPaytable[2] = [0,0,0,0,0,4,6,8,10,25,50,50,75,75,75,100,100,100,100,100,250,250,250];
            $this->DragonPaytable[3] = [0,0,0,0,0,2,3,5,10,20,30,30,40,40,40,50,50,50,50,50,100,100,100];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\DragoJewelsofFortuneStack::where('id', 4)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\DragoJewelsofFortuneStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\DragoJewelsofFortuneStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
