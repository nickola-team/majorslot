...
namespace VanguardLTE\Games\DragoJewelsofFortunePM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $pur = -1)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\DragoJewelsofFortuneStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\DragoJewelsofFortuneStack::where('spin_type', 0);
                }
