...
namespace VanguardLTE\Games\DragonKoiCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonKoiStack::where('id', 29661)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonKoiStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonKoiStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
