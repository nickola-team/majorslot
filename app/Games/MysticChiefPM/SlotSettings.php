...
namespace VanguardLTE\Games\MysticChiefPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMysticChiefStack::where('id', 213905)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameMysticChiefStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
