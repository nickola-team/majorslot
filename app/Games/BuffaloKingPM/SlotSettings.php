    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable[3] = [0,0,0,80,200,250,300];
            $this->Paytable[4] = [0,0,0,60,100,200,250];
            $this->Paytable[5] = [0,0,0,60,100,200,250];
            $this->Paytable[6] = [0,0,0,40,80,120,200];
            $this->Paytable[7] = [0,0,0,40,80,120,200];
            $this->Paytable[8] = [0,0,0,20,40,80,120];
            $this->Paytable[9] = [0,0,0,20,40,80,120];
            $this->Paytable[10] = [0,0,0,10,30,60,100];
            $this->Paytable[11] = [0,0,0,10,30,60,100];
            $this->Paytable[12] = [0,0,0,10,20,40,80];
            $this->Paytable[13] = [0,0,0,10,20,40,80];
            $this->freespinCount = [
                [0, 0, 0, 8, 15, 25, 100],
                [0, 0, 5, 8, 15, 25, 100]
            ];
