...
namespace VanguardLTE\Games\bookofsunmultichancebng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameBookofSunMultiChanceStack::where('id', 112189)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBookofSunMultiChanceStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBookofSunMultiChanceStack::where('spin_type', 0);
                }
