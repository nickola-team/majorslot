<?php 
namespace VanguardLTE\Games\LokisRichesPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameLokisRichesStack::where('id', 4)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLokisRichesStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLokisRichesStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
