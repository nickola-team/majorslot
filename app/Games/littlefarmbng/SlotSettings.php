        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] >= 6){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameLittleFarmStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameLittleFarmStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameLittleFarmStack::where('spin_type', 0);
                }
