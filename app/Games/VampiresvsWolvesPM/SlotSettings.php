...
namespace VanguardLTE\Games\VampiresvsWolvesPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,25,150,1000];
            $this->Paytable[3] = [0,0,0,25,125,800];
            $this->Paytable[4] = [0,0,0,25,125,800];
            $this->Paytable[5] = [0,0,0,15,75,300];
            $this->Paytable[6] = [0,0,0,15,75,300];
            $this->Paytable[7] = [0,0,0,10,50,180];
            $this->Paytable[8] = [0,0,0,10,50,180];
            $this->Paytable[9] = [0,0,0,8,30,100];
            $this->Paytable[10] = [0,0,0,6,20,60];
            $this->Paytable[11] = [0,0,0,5,15,50];
            $this->Paytable[12] = [0,0,0,5,12,30];
            $this->Paytable[13] = [0,0,0,0,0,0];
            $this->Paytable[14] = [0,0,0,0,0,0];
            $this->Paytable[15] = [0,0,0,0,0,0];
            $this->Paytable[16] = [0,0,0,25,150,1000];
            $this->Paytable[17] = [0,0,0,25,150,1000];
            $this->Paytable[18] = [0,0,0,25,150,1000];
            $this->Paytable[19] = [0,0,0,25,150,1000];
            $this->Paytable[20] = [0,0,0,25,150,1000];
            $this->Paytable[21] = [0,0,0,25,150,1000];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,40.00,60.00,80.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00,5000.00,6000.00,7000.00,8000.00,9000.00,10000.00]; 
        ...
        public function GetReelStrips($winType, $bet, $ind=-1)
        {
            ...
            //         $index = 201;
            //     }
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameVampiresvsWolvesStack::where('id', $index)->first();
            //     return json_decode($stack->spin_stack, true);
            // }else{
                // $stack = \VanguardLTE\PPGameStackModel\PPGameVampiresvsWolvesStack::where('id', 112)->first();
                // return json_decode($stack->spin_stack, true);
            // }
            $spintype = 0;
            if($winType == 'bonus'){
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameVampiresvsWolvesStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
