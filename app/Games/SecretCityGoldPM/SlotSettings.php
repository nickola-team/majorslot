<?php 
namespace VanguardLTE\Games\SecretCityGoldPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSecretCityGoldStack::where('id', 1820)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSecretCityGoldStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSecretCityGoldStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
