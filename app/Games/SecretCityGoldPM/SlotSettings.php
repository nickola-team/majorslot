...
namespace VanguardLTE\Games\SecretCityGoldPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSecretCityGoldStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSecretCityGoldStack::where('spin_type', 0);
                }
