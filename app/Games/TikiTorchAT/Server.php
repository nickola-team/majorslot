        ...
        public function get($request, $game)
        {
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gameInit' ) 
            {
                ...
                if( $lastEvent != 'NULL' ) 
                {
                    ...
                    $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54990161_20200215162832","current":' . $lastEvent->serverResponse->currentFreeGames . ',"add":0,"total":' . $lastEvent->serverResponse->totalFreeGames . ',"totalWin":' . ($lastEvent->serverResponse->totalWin * 100) . ',"multiplayer":' . $lastEvent->serverResponse->Mpl . '';
                ...
                $response = '{"status":"success","microtime":0.0077991485595703,"dateTime":"2020-02-13 13:16:03","error":"","content":{"cmd":"gameInit","balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"session":"54594109_4133a64673d3883d42cd003ee905ba3e","betInfo":{"denomination":0.01,"bet":' . $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[0] . ',"lines":25},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . '],"lines":[1,5,10,15,20,25]},"symbols":' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232 . ',"reels":{},"exitUrl":"\/","pingInterval":60000,"restore":' . $restore . ',"freeSpin":{' . $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 . '},"hash":"da0a5044aebc413b6da3a8e42dea0246"}}';
                $response = '{"status":"success","microtime":0.2377917766571,"dateTime":"2020-02-18 15:50:46","error":"","content":{"cmd":"gameInit","balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"session":"55520234_b64d5c8e3495d291120765ad7c95c322","betInfo":{"denomination":0.01,"bet":' . $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[0] . ',"lines":20},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . '],"lines":[1,5,10,15,20]},"symbols":' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232 . ',"reels":{"base":{"1":["' . implode('","', $slotSettings->reelStrip1) . '"],"2":["' . implode('","', $slotSettings->reelStrip2) . '"],"3":["' . implode('","', $slotSettings->reelStrip3) . '"],"4":["' . implode('","', $slotSettings->reelStrip4) . '"],"5":["' . implode('","', $slotSettings->reelStrip5) . '"]}},"exitUrl":"\/","freeSpin":{' . $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 . '},"pingInterval":60000,"restore":' . $restore . ',"hash":"159ede03c3e477340e5a1e305bf4f884"}}';
            }
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"line":' . ($k + 1) . ',"symbol":"' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '","count":1,"side":"left","elements":[[1,' . $_obf_0D060C2D0C080B3E17250940122B1F153D0F2A135B0811[$k][0] . ']],"xWin":' . ($mpl + $bonusMpl) . ',"win":' . ($cWins[$k] * 100) . '}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"line":' . ($k + 1) . ',"symbol":"' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '","count":2,"side":"left","elements":[[1,' . $_obf_0D060C2D0C080B3E17250940122B1F153D0F2A135B0811[$k][0] . '],[2,' . $_obf_0D060C2D0C080B3E17250940122B1F153D0F2A135B0811[$k][1] . ']],"xWin":' . ($mpl + $bonusMpl) . ',"win":' . ($cWins[$k] * 100) . '}';
                                    }
                                }
                    ...
                    {
                        $scattersStr = '{"line":"scatter","symbol":"' . $scatter . '","count":' . $scattersCount . ',"elements":[' . implode(',', $_obf_0D2F263812130A1D380B2F020E362127181D13063E2822) . '],"xWin":' . $bonusMpl . ',"freeSpinAdd":-1,"win":' . ($scattersWin * 100) . '}';
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    else
                    {
                        ...
                        $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('TikiTorchATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('TikiTorchATMpl') . ',"add":-1,"total":-1,"totalWin":' . ($slotSettings->GetGameData('TikiTorchATBonusWin') * 100) . '';
                    }
                }
                $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 = '' . json_encode($reels) . '';
                $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 = '' . json_encode($slotSettings->Jackpots) . '';
                $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 = implode(',', $lineWins);
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('TikiTorchATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('TikiTorchATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('TikiTorchATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":{},"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                $_obf_0D1D385C3B2E29221F233F3E3D09295B0F1B0D063B3222 = [];
                for( $i = 1; $i <= 5; $i++ ) 
                {
