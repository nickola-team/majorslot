...
namespace VanguardLTE\Games\FaCaiShenCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFaCaiShenMStack::where('id', 58027)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFaCaiShenMStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFaCaiShenMStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
