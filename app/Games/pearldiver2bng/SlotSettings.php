...
namespace VanguardLTE\Games\pearldiver2bng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGamePearlDiver2Stack::where('id', 15196)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGamePearlDiver2Stack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGamePearlDiver2Stack::where('spin_type', 0);
                }
