<?php 
namespace VanguardLTE\Games\BookofGoldenSandsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBookofGoldenSandsStack::where('id', 3)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameBookofGoldenSandsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
