...
namespace VanguardLTE\Games\HerculesandPegasusPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[4] = [0,0,0,40,140,300];
            $this->Paytable[5] = [0,0,0,20,100,200];
            $this->Paytable[6] = [0,0,0,20,100,200];
            $this->Paytable[7] = [0,0,0,8,20,100];
            $this->Paytable[8] = [0,0,0,8,20,100];
            $this->Paytable[9] = [0,0,0,4,10,50];
            $this->Paytable[10] = [0,0,0,4,10,50];
            $this->Paytable[11] = [0,0,0,4,10,50];
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHerculesandPegasusStack::where('id', 348)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHerculesandPegasusStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
