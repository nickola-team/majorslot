<?php 
namespace VanguardLTE\Games\_15dragonpearlsbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGame15DragonPearlsStack::where('id', 55005)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame15DragonPearlsStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame15DragonPearlsStack::where('spin_type', 0);
                }
