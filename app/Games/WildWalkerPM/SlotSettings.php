...
namespace VanguardLTE\Games\WildWalkerPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[6] = [0,0,0,15,50,200,500,1500,3000];
            $this->Paytable[7] = [0,0,0,10,30,120,300,900,2000];
            $this->Paytable[8] = [0,0,0,8,20,75,200,500,1500];
            $this->Paytable[9] = [0,0,0,4,10,30,90,200,500];
            $this->Paytable[10] = [0,0,0,4,10,30,90,200,500];
            $this->Paytable[11] = [0,0,0,4,10,30,90,200,500];
            $this->Paytable[12] = [0,0,0,4,10,30,90,200,500];
            $this->Paytable[13] = [0,0,0,0,0,0,0,0,0];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildWalkerStack::where('id', 587)->first();
