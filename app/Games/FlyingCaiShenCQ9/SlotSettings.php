...
namespace VanguardLTE\Games\FlyingCaiShenCQ9
{
    class SlotSettings
    {
        ...
        public function getRecommendList(){
            $data = [
                ...
                "hotRankingGameList" => [
                    ...
                    "maxScore"=>"1193620",
                    "maxMultiplier"=>865,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/wlUmyslm.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/RWIIRjvJ.jpg",
                    "difficulty"=>5],
                    ["type"=>2,
                    "gameCode"=>"202",
                    "maxScore"=>"553043",
        ...
        public function GetReelStrips($winType, $bet, $gameRound=1,$selId = -1)
        {
            // if($winType == 'bonus'){
                // if($gameRound == 1){
                //     $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFlyingCaiShenStack::where('id', 1280)->first(); //1280 :  Free,262 : symbol spin
