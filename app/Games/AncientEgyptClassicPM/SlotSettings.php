...
namespace VanguardLTE\Games\AncientEgyptClassicPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[5] = [0,0,5,25,100,750];
            $this->Paytable[6] = [0,0,5,25,100,750];
            $this->Paytable[7] = [0,0,0,5,40,150];
            $this->Paytable[8] = [0,0,0,5,40,150];
            $this->Paytable[9] = [0,0,0,5,40,150];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameAncientEgyptClassicStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win'){
