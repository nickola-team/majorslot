...
namespace VanguardLTE\Games\LuckyGraceCharmPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,10,250,2500,9000];
            $this->Paytable[3] = [0,0,2,25,125,750];
            $this->Paytable[4] = [0,0,2,25,125,750];
            $this->Paytable[5] = [0,0,0,15,75,250];
            $this->Paytable[6] = [0,0,0,15,75,250];
            $this->Paytable[7] = [0,0,0,20,100,400];
            $this->Paytable[8] = [0,0,0,10,50,125];
            ...
            $this->Paytable[13] = [0,0,2,5,25,100];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameLuckyGraceCharmStack::where('id', 756)->first();
            ...
            while(true){                
                ...
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLuckyGraceCharmStack::where('spin_type', '>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameLuckyGraceCharmStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($winType == 'win'){
