...
namespace VanguardLTE\Games\HimalayanWildPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHimalayanWildStack::where('id', 13191)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($pur >= 0){
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameHimalayanWildStack::where(['spin_type'=>1, 'pur_level'=>$pur])->whereNotIn('id', $existIds);
                    }else{                        
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameHimalayanWildStack::where('spin_type', 1)->where('pur_level','<=', 0)->whereNotIn('id', $existIds);
                    }
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHimalayanWildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
