...
namespace VanguardLTE\Games\ChickenDropPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,0,0,20,30,50,100,150,150,150,150,150,400,400,400,400,400,2000,2000,2000,2000,2000,2000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000];
            $this->Paytable[4] = [0,0,0,0,0,15,25,40,60,100,100,100,100,100,200,200,200,200,200,600,600,600,600,600,600,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000];
            $this->Paytable[5] = [0,0,0,0,0,10,15,25,50,75,75,75,75,75,150,150,150,150,150,400,400,400,400,400,400,750,750,750,750,750,750,750,750,750,750,750,750,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000];
            $this->Paytable[6] = [0,0,0,0,0,4,8,12,25,50,50,50,50,50,100,100,100,100,100,240,240,240,240,240,240,500,500,500,500,500,500,500,500,500,500,500,500,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000];
            $this->Paytable[7] = [0,0,0,0,0,4,8,12,25,50,50,50,50,50,100,100,100,100,100,240,240,240,240,240,240,500,500,500,500,500,500,500,500,500,500,500,500,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000,2000];
            $this->Paytable[8] = [0,0,0,0,0,3,4,6,15,25,25,25,25,25,50,50,50,50,50,120,120,120,120,120,120,250,250,250,250,250,250,250,250,250,250,250,250,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000];
            $this->Paytable[9] = [0,0,0,0,0,3,4,6,15,25,25,25,25,25,50,50,50,50,50,120,120,120,120,120,120,250,250,250,250,250,250,250,250,250,250,250,250,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameChickenDropStack::where('id', 2)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameChickenDropStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
