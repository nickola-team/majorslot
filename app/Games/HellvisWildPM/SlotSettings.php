...
namespace VanguardLTE\Games\HellvisWildPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHellvisWildStack::where('id', 300)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHellvisWildStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHellvisWildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
