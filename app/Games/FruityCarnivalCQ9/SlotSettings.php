<?php 
namespace VanguardLTE\Games\FruityCarnivalCQ9
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $gameRound=1)
        {
            // if($winType == 'bonus'){
                // if($gameRound == 1){
                    $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFruityCarnivalStack::where('id', 1904)->first(); //6039 :  Free,9472 : symbol spin
                    return json_decode($stack->spin_stack, true);                    
                // }else if($gameRound == 2){
                //     $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFruityCarnivalStack::where('id', 2560)->first();
                //     return json_decode($stack->spin_stack, true);
                // }else if($gameRound == 3){
                //     $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFruityCarnivalStack::where('id', 4608)->first();
                //     return json_decode($stack->spin_stack, true);
                //  }
