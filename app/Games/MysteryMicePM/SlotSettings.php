<?php 
namespace VanguardLTE\Games\MysteryMicePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMysteryMiceStack::where('id', 4)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryMiceStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMysteryMiceStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
