...
namespace VanguardLTE\Games\BiggerBassBlizzardPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBiggerBassBlizzardStack::where('id', 1)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBiggerBassBlizzardStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBiggerBassBlizzardStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
