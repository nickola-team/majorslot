    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable['1']  = [0,0,0,75,150,400];
            $this->Paytable['2']  = [0,0,0,50,150,300];
            $this->Paytable['3']  = [0,0,0,40,100,250];
            $this->Paytable['4']  = [0,0,0,30,100,200];
            $this->Paytable['11']  = [0,0,0,15,30,125];
            $this->Paytable['12']  = [0,0,0,15,30,125];
            $this->Paytable['13'] = [0,0,0,10,20,100];
            $this->Paytable['14'] = [0,0,0,10,20,100];
            $reel = new GameReel();
            foreach( [
                'reelStrip1', 
                'reelStrip2', 
        ...
        public function GetReelStrips($winType, $slotEvent, $defaultScatterCount = 0)
        {
            ...
            if($slotEvent=='freespin'){
                ...
                else
                {
                    ...
                    $scatterStripReelNumber = $this->GetRandomNumber(0, 6, $defaultScatterCount);
                ...
                else
                {
                    ...
                    $scatterStripReelNumber = $this->GetRandomNumber(0, 5, $defaultScatterCount);
