...
namespace VanguardLTE\Games\GoldRushPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGoldRushStack::where('id', 51)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGoldRushStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
