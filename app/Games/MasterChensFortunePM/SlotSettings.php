<?php 
namespace VanguardLTE\Games\MasterChensFortunePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2]  = [0,0,0,75];
            $this->Paytable[3]  = [0,0,0,25];
            $this->Paytable[4]  = [0,0,0,15];
            $this->Paytable[5]  = [0,0,0,10];
            $this->Paytable[6]  = [0,0,0,7];
            $this->Paytable[7]  = [0,0,0,6];
            $this->Paytable[8]  = [0,0,0,5];
            $this->Paytable[9]  = [0,0,0,3];
            $this->Paytable[10]  = [0,0,0,2];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,40.00,60.00,80.00,100.00,200.00,400.00,800.00,1000.00,2000.00,3000.00,4000.00,5000.00,6000.00,7000.00,8000.00,9000.00,10000.00,11000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMasterChensFortuneStack::where('id', 346)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameMasterChensFortuneStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
