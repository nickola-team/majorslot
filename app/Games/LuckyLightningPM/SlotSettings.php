...
namespace VanguardLTE\Games\LuckyLightningPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,125,250,0];
            $this->Paytable[4] = [0,0,0,20,50,150,0];
            $this->Paytable[5] = [0,0,0,10,25,100,0];
            $this->Paytable[6] = [0,0,0,10,25,50,0];
            $this->Paytable[7] = [0,0,0,10,25,50,0];
            $this->Paytable[8] = [0,0,0,5,10,25,0];
            $this->Paytable[9] = [0,0,0,5,10,25,0];
            $this->Paytable[10] = [0,0,0,5,10,25,0];
            $this->Paytable[11] = [0,0,0,5,10,25,0];
            $this->Paytable[12] = [0,0,0,5,10,25,0];
            $this->Paytable[13] = [0,0,0,0,0,0,0];
            $this->Paytable[14] = [0,0,0,0,0,0,0];
            $this->Paytable[15] = [0,0,0,0,0,0,0];
            $this->Paytable[16] = [0,0,0,0,0,0,0];
            $this->Paytable[17] = [0,0,0,0,0,0,0];
            $this->Paytable[18] = [0,0,0,0,0,0,0];
            $this->Paytable[19] = [0,0,0,0,0,0,0];
            $this->Paytable[20] = [0,0,0,0,0,0,0];
            $this->Paytable[21] = [0,0,0,0,0,0,0];
            $this->Paytable[22] = [0,0,0,0,0,0,0];
            $this->Paytable[23] = [0,0,0,0,0,0,0];
            $this->Paytable[24] = [0,0,0,0,0,0,0];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[10.00,20.00,40.00,60.00,80.00,100.00,200.00,400.00,800.00,1000.00,2000.00,3000.00,4000.00]; 
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameLuckyLightningStack::where('id', 110474)->first();
