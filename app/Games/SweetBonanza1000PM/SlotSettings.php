...
namespace VanguardLTE\Games\SweetBonanza1000PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSweetBonanza1000Stack::where('id', 17366)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetBonanza1000Stack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetBonanza1000Stack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
