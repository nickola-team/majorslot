...
namespace VanguardLTE\Games\BigBurgerLoaditupwithXTRACheesePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBigBurgerStack::where('id', 8)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBurgerStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBurgerStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
