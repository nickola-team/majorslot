...
namespace VanguardLTE\Games\BubblePopPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,150,300,1000];
            $this->Paytable[4] = [0,0,0,100,200,500];
            $this->Paytable[5] = [0,0,0,75,150,300];
            $this->Paytable[6] = [0,0,0,30,100,250];
            $this->Paytable[7] = [0,0,0,25,80,200];
            $this->Paytable[8] = [0,0,0,20,60,150];
            $this->Paytable[9] = [0,0,0,15,50,125];
            $this->Paytable[10] = [0,0,0,10,40,100];
            $this->Paytable[11] = [0,0,0,10,40,100];
            $this->Paytable[12] = [0,0,0,5,20,50];
            $this->Paytable[13] = [0,0,0,5,20,50];
            $this->Paytable[14] = [0,0,0,0,0,0];
            $this->Paytable[15] = [0,0,0,5,20,50];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,30.00,40.00,50.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00,5000.00,100000.00]; 
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireStrikeStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win' || $winType == 'bonus'){
                    $stacks = $stacks->where('odd', '>', 0);
                }
                if($isLowBank == true){
                    $index = mt_rand(0, 20000);
