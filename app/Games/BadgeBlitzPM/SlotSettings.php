...
namespace VanguardLTE\Games\BadgeBlitzPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBadgeBlitzStack::where('id', 17468)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBadgeBlitzStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBadgeBlitzStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
