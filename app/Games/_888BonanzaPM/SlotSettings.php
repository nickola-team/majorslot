...
namespace VanguardLTE\Games\_888BonanzaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGame888BonanzaStack::where('id', 70330)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGame888BonanzaStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
