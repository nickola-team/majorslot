...
namespace VanguardLTE\Games\RockVegasPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,15,150,300,750];
            $this->Paytable[4] = [0,0,0,100,200,500];
            $this->Paytable[5] = [0,0,0,100,200,500];
            $this->Paytable[6] = [0,0,0,50,100,250];
            $this->Paytable[7] = [0,0,0,25,50,125];
            $this->Paytable[8] = [0,0,0,25,50,125];
            $this->Paytable[9] = [0,0,0,15,25,75];
            $this->Paytable[10] = [0,0,0,15,25,75];
            $this->Paytable[11] = [0,0,0,15,25,75];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameRockVegasStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
