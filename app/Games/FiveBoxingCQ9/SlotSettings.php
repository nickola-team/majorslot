<?php 
namespace VanguardLTE\Games\FiveBoxingCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFiveBoxingStack::where('id', 10976)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFiveBoxingStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFiveBoxingStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
