...
namespace VanguardLTE\Games\TheAlterEqoPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTheAlterEqoStack::where('id', 2802)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheAlterEqoStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheAlterEqoStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
