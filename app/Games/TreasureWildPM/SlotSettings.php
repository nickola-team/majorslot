...
namespace VanguardLTE\Games\TreasureWildPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,0,0,300];
            $this->Paytable[3] = [0,0,0,40,100,300];
            $this->Paytable[4] = [0,0,0,25,50,150];
            $this->Paytable[5] = [0,0,0,20,40,120];
            $this->Paytable[6] = [0,0,0,15,30,90];
            $this->Paytable[7] = [0,0,0,10,20,60];
            $this->Paytable[8] = [0,0,0,6,12,36];
            $this->Paytable[9] = [0,0,0,6,12,36];
            $this->Paytable[10] = [0,0,0,5,10,30];
            $this->Paytable[11] = [0,0,0,5,10,30];
        ...
        {
            $purmuls = [2000, 2200, 2400, 2600, 2800, 3000, 3200, 3400, 3600, 3800, 4000, 3000];
            return $purmuls[$pur];
        }
        ...
        public function GetReelStrips($winType, $pur, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameTreasureWildStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
