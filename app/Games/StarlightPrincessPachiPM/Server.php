<?php 
namespace VanguardLTE\Games\StarlightPrincessPachiPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,6,7,6,4,11,4,5,8]);
                ...
                if(isset($stack)){
                    ...
                    if($arr_g != null){
                        ...
                        $strOtherResponse = $strOtherResponse . '&g={minigame_screen:{def_s:"0,0,0,0,0,0,0,0,0",def_sa:"0,0,0",def_sb:"0,0,0",s:"0,0,0,0,0,0,0,0,0",sa:"0,0,0",sb:"0,0,0",sh:"3",st:"rect",sw:"3"}}';
                    }
                    if($strWinLine != ''){
            ...
            else if( $slotEvent['slotEvent'] == 'doSpin' ) 
            {
                ...
                if($strLastReel != ''){
                    $strOtherResponse = $strOtherResponse . '&sh=3&sw=3&st=rect&s=' . $strLastReel;
                }
                if($str_sa != ''){
