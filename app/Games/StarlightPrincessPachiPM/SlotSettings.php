...
namespace VanguardLTE\Games\StarlightPrincessPachiPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType='bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameStarlightPrincessPachiStack::where([
                //     'id' => 21577
                // ])->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameStarlightPrincessPachiStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameStarlightPrincessPachiStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
