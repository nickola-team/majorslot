<?php 
namespace VanguardLTE\Games\MagiciansSecretsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,10,30,100,500];
            $this->Paytable[4] = [0,0,0,5,10,30,100];
            $this->Paytable[5] = [0,0,0,4,10,25,40];
            $this->Paytable[6] = [0,0,0,3,8,20,30];
            $this->Paytable[7] = [0,0,0,3,7,15,20];
            $this->Paytable[8] = [0,0,0,1,2,3,8];
            $this->Paytable[9] = [0,0,0,1,2,3,7];
            $this->Paytable[10] = [0,0,0,1,2,3,6];
            $this->Paytable[11] = [0,0,0,1,2,3,5];
            $this->Paytable[12] = [0,0,0,1,2,3,4];
        ...
        public function GetReelStrips($winType, $pur, $bet, $ind = -1)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameMagiciansSecretsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                $index = mt_rand(0, 67000);
                if($winType == 'win'){
