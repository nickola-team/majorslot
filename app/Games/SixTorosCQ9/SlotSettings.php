...
namespace VanguardLTE\Games\SixTorosCQ9
{
    class SlotSettings
    {
        ...
        {
            //if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameSixTorosStack::where('id', 572)->first();    //17660,195,1076,1336,1986,2113,2465
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSixTorosStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSixTorosStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
