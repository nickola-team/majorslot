...
namespace VanguardLTE\Games\SnakesandLaddersMegadicePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,100,250,500];
            $this->Paytable[4] = [0,0,0,100,250,500];
            $this->Paytable[5] = [0,0,0,50,100,200];
            $this->Paytable[6] = [0,0,0,50,100,200];
            $this->Paytable[7] = [0,0,0,30,75,150];
            $this->Paytable[8] = [0,0,0,15,40,100];
            $this->Paytable[9] = [0,0,0,15,40,100];
            $this->Paytable[10] = [0,0,0,5,15,50];
            $this->Paytable[11] = [0,0,0,5,15,50];
            $this->Paytable[12] = [0,0,0,5,15,50];
