...
namespace VanguardLTE\Games\TropicalTikiPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTropicalTikiStack::where('id', 1)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTropicalTikiStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTropicalTikiStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
