...
namespace VanguardLTE\Games\HotToBurnExtremePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHotToBurnExtremeStack::where('id', 42)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHotToBurnExtremeStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
