...
namespace VanguardLTE\Games\WildWestDuelsPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $pur_level = -1)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWildWestDuelsStack::where('spin_type', 1);
                    if($pur_level >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWildWestDuelsStack::where('spin_type', 0);
                }
