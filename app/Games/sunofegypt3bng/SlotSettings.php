<?php 
namespace VanguardLTE\Games\sunofegypt3bng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt3Stack::where('id', 263)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt3Stack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameSunofEgypt3Stack::where('spin_type', 0);
                }
