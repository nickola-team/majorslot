...
namespace VanguardLTE\Games\BookOfKingdomsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBookOfKingdomsStack::where('id', 395)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameBookOfKingdomsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
