...
namespace VanguardLTE\Games\MysteriousEgyptPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,30.00,40.00,50.00,100.00,200.00,300.00,400.00,500.00,1000.00,2000.00,3000.00,4000.00,5000.00,8000.00,10000.00]; 
        ...
        {
            // $stack = \VanguardLTE\PPGameStackModel\PPGameBookOfAztecKingStack::where('id', 51)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameBookOfAztecKingStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
