...
namespace VanguardLTE\Games\RunningAnimalsCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                    // $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameRunningAnimalsStack::where('id', 132619)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameRunningAnimalsStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameRunningAnimalsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
