...
namespace VanguardLTE\Games\FortunesofAztecPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType='bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFortunesofAztecStack::where([
                //     'id' => 22
                // ])->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFortunesofAztecStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
