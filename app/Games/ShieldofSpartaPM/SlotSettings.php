...
namespace VanguardLTE\Games\ShieldofSpartaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameShieldofSpartaStack::where('id', 68101)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameShieldofSpartaStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
