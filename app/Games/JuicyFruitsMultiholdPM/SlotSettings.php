<?php 
namespace VanguardLTE\Games\JuicyFruitsMultiholdPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameJuicyFruitsMultihildStack::where('id', 25115)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJuicyFruitsMultihildStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJuicyFruitsMultihildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
