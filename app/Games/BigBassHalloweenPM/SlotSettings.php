...
namespace VanguardLTE\Games\BigBassHalloweenPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBigBassHalloweenStack::where('id', 3)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassHalloweenStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassHalloweenStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
