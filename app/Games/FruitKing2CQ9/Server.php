<?php 
namespace VanguardLTE\Games\FruitKing2CQ9
{
    class Server
    {
        public $demon = 1;
                ...
                if($paramData['req'] == 1){ // init
                    ...
                    for($i = 0; $i < count($gameDatas); $i++){
                        ...
                        if($packet_id == 11){
                            ...
                            $result_val['BGContext'] = [["tcH5SU5uan9omus8FiBdOn8swStKTiInN8YpxiLpQ+lcCzKRwm+4PEE1ILJtnFrg2XDW/q70Nu+ybH8/FzDYZ/cxnZtlxRq2X6mSun16FhEJu3m1IwbwlrGueo3sQL7t8iW704kvigTVFarFWOiiKtk2UOUoh2fzxOu9W+riJS0OWfBksT4wA5ba3DE=","BvsqqpbmXVdwpPg1VlU5OfrvA1eYvMpX8OypBVM5Rv9798bNwKELb6UzNRd6B7lk4EHcTGWAv7DDsVENg6tCmS4lAY+CUuR7QyWUjP99J91bpkY0HnCREI78js2sC+dmQ+IwW+nr9maknPK/81/j4y6ZaUnobYfBzh4GBUDBeIRrpvLSG8e1I1PIGy0=","IZOqWSBzJyIg1E6QPJskR8qFu3YIdF9HywDMM/vDo6rWV+l8ME/v232hhybpNqb73d8xRDjYi+2UV3JhzIDuG60ctFNF1oY0s2TMINd40EgV1bmFCBBwKWex5GuWNBzjwdqaMbflrQPAgNzuk0VWwtx+g5KJxr8ND9FQJA==","cBq7nbEodevt2cxyJ3bGYLAa0JIAtwV+xCr4er8r+S+J+e69Mnhm/Kr5d3c7R7XzpbWC/hJQ3ODxWocP9RUsNIFLEJLEwKxc0gUFBJ/krmd+a5EiZveajoAcGYLRps662fYcJlRJ9lpssTifmyLUvoGUIXAgLo0AyXcyMEuG0DZfhaOcafI3+l+oc7C1tESApoiVAB0cVtp2tEgx","og36WyqRaSPXYuKud+YtuhkIKF8ot36P2pwAv+7wHlBUyt1/WpG69uuKyW32p8SyWlBLXaZrrvFIbRRSVvNmR+n2XzCu0UyyvK4YcC0aLo7HTyRC5QFZz1YLa+5kpzPoN2YVh7slVQewR9T6XiBs6YWQtYum4LfPGiMLutAKxwt8o4Fg4lcuF4bUQsY="]];
