...
namespace VanguardLTE\Games\CurseoftheWerewolfMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,5,10,25,50,100];
            $this->Paytable[4] = [0,0,0,5,10,25,50];
            $this->Paytable[5] = [0,0,0,3,5,10,25];
            $this->Paytable[6] = [0,0,0,3,4,8,20];
            $this->Paytable[7] = [0,0,0,2,3,6,15];
            $this->Paytable[8] = [0,0,0,2,3,5,10];
            $this->Paytable[9] = [0,0,0,2,3,5,10];
            $this->Paytable[10] = [0,0,0,1,2,3,5];
            $this->Paytable[11] = [0,0,0,1,2,3,5];
            $this->Paytable[12] = [0,0,0,1,2,3,5];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,40.00,60.00,80.00,100.00,200.00,300.00,400.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00,5000.00,10000.00]; 
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCurseoftheWerewolfMegawaysStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCurseoftheWerewolfMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
