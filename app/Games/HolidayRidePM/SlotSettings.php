...
namespace VanguardLTE\Games\HolidayRidePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHolidayRideStack::where('id', 33390)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHolidayRideStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHolidayRideStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
