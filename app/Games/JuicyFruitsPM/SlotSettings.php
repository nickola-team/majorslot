...
namespace VanguardLTE\Games\JuicyFruitsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,25,125,600];
            $this->Paytable[3] = [0,0,0,25,125,600];
            $this->Paytable[4] = [0,0,0,18,100,375];
            $this->Paytable[5] = [0,0,0,12,75,250];
            $this->Paytable[6] = [0,0,0,10,40,150];
            $this->Paytable[7] = [0,0,0,8,20,75];
            $this->Paytable[8] = [0,0,0,8,20,75];
            $this->Paytable[9] = [0,0,0,8,20,75];
            $this->Paytable[10] = [0,0,0,5,12,50];
            $this->Paytable[11] = [0,0,0,5,12,50];
            $this->Paytable[12] = [0,0,0,5,12,50];
            $this->Paytable[13] = [0,0,0,5,12,50];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameJuicyFruitsStack::where('id', 4)->first();
