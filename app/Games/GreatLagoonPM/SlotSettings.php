...
namespace VanguardLTE\Games\GreatLagoonPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGreatLagoonStack::where('id', 211188)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGreatLagoonStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGreatLagoonStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
