...
namespace VanguardLTE\Games\PyramidRaiderCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GamePyramidRaiderStack::where('id', 15652)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GamePyramidRaiderStack::where('spin_type', $spinType)->whereNotIn('id', $existIds);
                if($pur >= 0){
