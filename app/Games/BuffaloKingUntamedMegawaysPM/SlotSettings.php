...
namespace VanguardLTE\Games\BuffaloKingUntamedMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBuffaloKingUntamedMegawaysStack::where('id', 5)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBuffaloKingUntamedMegawaysStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBuffaloKingUntamedMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
