    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('FruitTumblingGTMDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('FruitTumblingGTMDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'slotGamble' ) 
            {
                ...
                $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), $_obf_0D33130E1F150A28331B2F322B291E402639242D2B2D22 * -1);
                $_obf_0D14303C231C032D241D0B0B3536181C110C0D0A2B1932 = $slotSettings->GetBalance();
                $_obf_0D300C2F21350336261622142A322E0C270C0A1F2F0422 = '{"bonusWin":' . $slotSettings->GetGameData('FruitTumblingGTMBonusWin') . ',"dealerCard":"' . $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 . '","gambleState":"' . $_obf_0D0E2C2E373C171C3B0B2905400E372723283E18043511 . '","totalWin":' . $totalWin . ',"afterBalance":' . $_obf_0D14303C231C032D241D0B0B3536181C110C0D0A2B1932 . ',"Balance":' . $Balance . '}';
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $wild = ['P_1'];
                    $scatter = 'SCAT';
                    $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01 = $slotSettings->GetGameData('FruitTumblingGTMChangeMap');
                    ...
                    $slotSettings->SetGameData('FruitTumblingGTMChangeMap', $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01);
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
                    {
                        ...
                        $_obf_0D1F2226390C3C293401183E1214361C06120B3C281432 = $slotSettings->GetGameData('FruitTumblingGTMReelsMap');
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] != -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] != -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r] = $_obf_0D1F2226390C3C293401183E1214361C06120B3C281432['reel' . $r];
                                    $reels['reel' . $r][2] = $reels['reel' . $r][1];
                                    $reels['reel' . $r][1] = $reels['reel' . $r][0];
                                    $reels['reel' . $r][0] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    if( $slotSettings->CheckDuplicateSym($reels['reel' . $r]) ) 
                                    {
                                        break;
                                    }
                                }
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                            }
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] != -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] != -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                            ...
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] != -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] != -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    $reels['reel' . $r] = $_obf_0D1F2226390C3C293401183E1214361C06120B3C281432['reel' . $r];
                            ...
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] != -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    ...
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][1] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][0] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    if( $slotSettings->CheckDuplicateSym($reels['reel' . $r]) ) 
                            ...
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] != -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    $reels['reel' . $r] = $_obf_0D1F2226390C3C293401183E1214361C06120B3C281432['reel' . $r];
                                    $reels['reel' . $r][2] = $reels['reel' . $r][2];
                                    $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][1] = $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611;
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][0] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    if( $slotSettings->CheckDuplicateSym($reels['reel' . $r]) ) 
                                    {
                                ...
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611;
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                            }
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] != -1 ) 
                            {
                            ...
                            else if( $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][0] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][2] == -1 && $_obf_0D1F37031733101102293B011A05321D26345C2E1A5C01[$r - 1][1] == -1 ) 
                            {
                                for( $rs = 0; $rs <= 100; $rs++ ) 
                                {
                                    $reels['reel' . $r] = $_obf_0D1F2226390C3C293401183E1214361C06120B3C281432['reel' . $r];
                                    $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][2] = $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611;
                                    $_obf_0D2C321D0211144008140602212B3D09255B4027123422 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][1] = $_obf_0D2C321D0211144008140602212B3D09255B4027123422;
                                    $_obf_0D38123733150206072504281A37243133310A062A2732 = $slotSettings->SymbolGame[rand(2, count($slotSettings->SymbolGame) - 1)];
                                    $reels['reel' . $r][0] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                                    if( $slotSettings->CheckDuplicateSym($reels['reel' . $r]) ) 
                                    {
                                ...
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D351A1F0A38170D2E190B062240113C091D350A2D3611;
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D2C321D0211144008140602212B3D09255B4027123422;
                                $_obf_0D37321A2B3F180F0E28173F375C093F0C320B29323011[$r][] = $_obf_0D38123733150206072504281A37243133310A062A2732;
                            }
                        }
                    }
                    for( $k = 0; $k < $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines']; $k++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == $scatter || !isset($slotSettings->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132]) || !isset($slotSettings->Paytable[$_obf_0D011C142C3C37263F351C4012170A074027083F321132]) ) 
                            {
                            }
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitTumblingGTMTotalWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[0][$linesId[$k][0] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[1][$linesId[$k][1] - 1] = -1;
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitTumblingGTMTotalWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[0][$linesId[$k][0] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[1][$linesId[$k][1] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[2][$linesId[$k][2] - 1] = -1;
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitTumblingGTMTotalWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[1][$linesId[$k][1] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[2][$linesId[$k][2] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[3][$linesId[$k][3] - 1] = -1;
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitTumblingGTMTotalWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[2][$linesId[$k][2] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[3][$linesId[$k][3] - 1] = -1;
                                        $_obf_0D3C3915080E3D0C3F07400E0F0B05302614072F380B01[4][$linesId[$k][4] - 1] = -1;
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitTumblingGTMTotalWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"ReelsMap":' . json_encode($slotSettings->GetGameData('FruitTumblingGTMReelsMap')) . ' ,"ChangeMap":' . json_encode($slotSettings->GetGameData('FruitTumblingGTMChangeMap')) . ',"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"bonusWin":' . $slotSettings->GetGameData('FruitTumblingGTMBonusWin') . ',"freeMpl":' . $slotSettings->GetGameData('FruitTumblingGTMFreeMpl') . ',"respinReels":' . $_obf_0D5B0C352E1F1E0317255C3C31103F3604031D091F3701 . ',"respinWin":' . $slotSettings->GetGameData('FruitTumblingGTMTotalWin') . ',"totalFreeGames":' . $slotSettings->GetGameData('FruitTumblingGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FruitTumblingGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FruitTumblingGTMBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
