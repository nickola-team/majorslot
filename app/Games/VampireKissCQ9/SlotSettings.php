...
namespace VanguardLTE\Games\VampireKissCQ9
{
    class SlotSettings
    {
        ...
        {
            // // // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameVampireKissStack::where('id', 12364)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameVampireKissStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameVampireKissStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
