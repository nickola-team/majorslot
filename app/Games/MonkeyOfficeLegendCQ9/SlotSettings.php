...
namespace VanguardLTE\Games\MonkeyOfficeLegendCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameMonkeyOfficeLegendStack::where('id', 86603)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMonkeyOfficeLegendStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameMonkeyOfficeLegendStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
