<?php 
namespace VanguardLTE\Games\KnightHotSpotzPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameKnightHotSpotzStack::where('id', 96421)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameKnightHotSpotzStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameKnightHotSpotzStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
