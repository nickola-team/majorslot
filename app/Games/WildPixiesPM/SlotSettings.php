...
namespace VanguardLTE\Games\WildPixiesPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,50,150,250];
            $this->Paytable[4] = [0,0,0,25,120,200];
            $this->Paytable[5] = [0,0,0,25,120,200];
            $this->Paytable[6] = [0,0,0,15,100,150];
            $this->Paytable[7] = [0,0,0,10,100,150];
            $this->Paytable[8] = [0,0,0,10,100,125];
            $this->Paytable[9] = [0,0,0,10,50,125];
            $this->Paytable[10] = [0,0,0,5,25,120];
            $this->Paytable[11] = [0,0,0,5,20,100];
            $this->Paytable[12] = [0,0,0,5,20,100];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWildPixiesStack::where('id', 1201)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameWildPixiesStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
