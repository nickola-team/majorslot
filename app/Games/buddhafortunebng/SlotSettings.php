...
namespace VanguardLTE\Games\buddhafortunebng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameBuddhaFortuneStack::where('id', 27902)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBuddhaFortuneStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBuddhaFortuneStack::where('spin_type', 0);
                }
