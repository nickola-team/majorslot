...
namespace VanguardLTE\Games\AztecTreasureHuntPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameAztecTreasureHuntStack::where('id', 21091)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecTreasureHuntStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecTreasureHuntStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
