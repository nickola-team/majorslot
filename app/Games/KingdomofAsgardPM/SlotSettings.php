...
namespace VanguardLTE\Games\KingdomofAsgardPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,75,250];
            $this->Paytable[4] = [0,0,0,10,50,125];
            $this->Paytable[5] = [0,0,0,10,30,100];
            $this->Paytable[6] = [0,0,0,10,25,75];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCloverGoldStack::where('id', 8518)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameCloverGoldStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win'){
