...
namespace VanguardLTE\Games\HandofMidas2PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHandofMidas2Stack::where('id', 33320)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHandofMidas2Stack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameHandofMidas2Stack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
