<?php 
namespace VanguardLTE\Games\AztecPowernudgePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameAztecPowernudgeStack::where('id', 23650)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecPowernudgeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecPowernudgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
