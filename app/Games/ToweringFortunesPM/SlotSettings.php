...
namespace VanguardLTE\Games\ToweringFortunesPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameToweringFortunesStack::where('id', 160)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameToweringFortunesStack::where('spin_type',1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameToweringFortunesStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
