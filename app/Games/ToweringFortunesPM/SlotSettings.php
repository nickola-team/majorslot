...
namespace VanguardLTE\Games\ToweringFortunesPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameToweringFortunesStack::where('spin_type',1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameToweringFortunesStack::where('spin_type', 0);
                }
