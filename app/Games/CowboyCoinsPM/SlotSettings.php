...
namespace VanguardLTE\Games\CowboyCoinsPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCowboyCoinsStack::where('id', 7554)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCowboyCoinsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCowboyCoinsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
