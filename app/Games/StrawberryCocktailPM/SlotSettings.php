...
namespace VanguardLTE\Games\StrawberryCocktailPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameStrawberryCocktailStack::where('id', 86012)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameStrawberryCocktailStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                    if($pur >= 0){
