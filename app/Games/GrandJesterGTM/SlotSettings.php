...
namespace VanguardLTE\Games\GrandJesterGTM
{
    class SlotSettings
    {
        ...
        public function CalculateSpin($bet, $lines, $linesId, $cReels)
        {
            ...
            for( $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 = 0; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 <= 100; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01++ ) 
            {
                $cWins = [
                    0, 
                    0, 
                ...
                for( $k = 0; $k < $lines; $k++ ) 
                {
                    for( $j = 0; $j < count($this->SymbolGame); $j++ ) 
                    {
                        ...
                        if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == $scatter || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_1' || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_2' || $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == 'P_1_3' ) 
                        {
                        }
                        else
                        {
