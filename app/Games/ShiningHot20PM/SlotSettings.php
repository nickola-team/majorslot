...
namespace VanguardLTE\Games\ShiningHot20PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameShiningHot20Stack::where('id', 117)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameShiningHot20Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
