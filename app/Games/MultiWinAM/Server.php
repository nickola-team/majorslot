        ...
        public function get($request, $game)
        {
            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u253':
                    ...
                    $response = '104010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . '10011f41388100209030804070506' . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '020' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '03000000001010151a26431f4';
                ...
                case 'A/u251':
                    ...
                    $response = '102010' . $balanceFormated . '1010001a33e810161a31071d1e3104' . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '010' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '000000000' . $_obf_0D342D5C29171D3B0A3934110F0F240F23342528193111 . '1010151a26431f4';
                    $_obf_0D313216211E285C27221305312C19242C223C11353901 = (object)[
                        'Bet' => $allbet, 
                        'CurrentCards' => $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01, 
                        'Cards' => $cardsArr, 
