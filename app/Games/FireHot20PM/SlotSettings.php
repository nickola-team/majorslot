...
namespace VanguardLTE\Games\FireHot20PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFireHot20Stack::where('id', 146)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireHot20Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
