...
namespace VanguardLTE\Games\TheGreatStickupPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,65,200,1000];
            $this->Paytable[4] = [0,0,0,50,150,700];
            $this->Paytable[5] = [0,0,0,30,100,500];
            $this->Paytable[6] = [0,0,0,20,60,300];
            $this->Paytable[7] = [0,0,0,12,35,200];
            $this->Paytable[8] = [0,0,0,7,15,100];
            $this->Paytable[9] = [0,0,0,5,10,60];
            $this->Paytable[10] = [0,0,0,4,9,40];
            $this->Paytable[11] = [0,0,0,3,7,30];
            $this->Paytable[12] = [0,0,0,2,6,25];
            $this->Paytable[13] = [0,0,0,1,5,20];
