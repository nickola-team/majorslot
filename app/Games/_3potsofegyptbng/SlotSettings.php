...
namespace VanguardLTE\Games\_3potsofegyptbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGame3PotsofEgyptStack::where('id', 196659)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    // }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGame3PotsofEgyptStack::where('spin_type','>', 0);
                    // }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame3PotsofEgyptStack::where('spin_type', 0);
                }
