<?php 
namespace VanguardLTE\Games\WheelOGoldPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameWheelOGoldStack::where('id', 32927)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWheelOGoldStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameWheelOGoldStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
