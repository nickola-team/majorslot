...
namespace VanguardLTE\Games\PiggyBankBillsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[1] = 0;
            $this->Paytable[2] = 0;
            $this->Paytable[3] = 20000;
            $this->Paytable[4] = 2000;
            $this->Paytable[5] = 1000;
            $this->Paytable[6] = 400;
            $this->Paytable[7] = 200;
            $this->Paytable[8] = 100;
            $this->Paytable[9] = 40;
        ...
        public function CheckBonusWin()
        {
            $ratioCount = 0;
            $totalPayRatio = 0;
            foreach( $this->Paytable as $payRatio ) 
            {
                if( $payRatio > 0 ) 
                {
                    $ratioCount++;
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGamePiggyBankBillsStack::where('id', 308)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGamePiggyBankBillsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
