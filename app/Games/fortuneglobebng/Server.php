<?php 
namespace VanguardLTE\Games\fortuneglobebng
{
    class Server
    {
                ...
                $objRes = [
                    ...
                    'context' => [
                        ...
                        'spins' => [
                            ...
                            'bs' => [['position' => 0,'reel' => 0, 'type' => 'regular', 'value' => 4 * $bets[9] * $LINES],['position' => 1,'reel' => 0,'type' => 'major','value' => 100 * $bets[9] * $LINES],['position' => 2,'reel' => 0,'type' => 'regular','value' => 5 * $bets[9] * $LINES],['position' => 3,'reel' => 0,'type' => 'regular','value' => 3 * $bets[9] * $LINES]],
                            'bs_count' => 4,
                            'lines' => 20,
                            'reelset_number' => 0,
                ...
                if($action['name'] == 'freespin_init' || $action['name'] == 'freespin_stop' || $action['name'] == 'bonus_init' || $action['name'] == 'bonus_spins_stop' || $action['name'] == 'bonus_freespins_stop'){
                                ...
                                if(isset($stack[$spin_type]['bs'])){
                                    for($i = 0; $i < count($stack[$spin_type]['bs']); $i++){
                                            if(is_numeric(str_replace(',', '', $stack[$spin_type]['bs'][$i]['value']))){
                                                $stack[$spin_type]['bs'][$i]['value'] = str_replace(',', '', $stack[$spin_type]['bs'][$i]['value']) * $betline * $DENOMINATOR;
                                            }
                                        }
                                }
                        ...
                        $objRes = [
                            ...
                            'context' => [
                                ...
                                'spins' => [
                                    ...
                                    'board' => [[11,11,11,11],[9,9,9,9],[1,10,2,2],[8,8,8,5],[6,7,7,7]],
                                    'bs' => [['position' => 0,'reel' => 0, 'type' => 'regular', 'value' => 4 * $betline * $LINES],['position' => 1,'reel' => 0,'type' => 'major','value' => 100 * $betline * $LINES],['position' => 2,'reel' => 0,'type' => 'regular','value' => 5 * $betline * $LINES],['position' => 3,'reel' => 0,'type' => 'regular','value' => 3 * $betline * $LINES]],
                                    'bs_count' => 4,
                                    'lines' => 20,
                                    'reelset_number' => 0,
                    ...
                    for($k = 0; $k < 3; $k++){
                        ...
                        if($stack[$spin_type] != ''){
                            ...
                            if($slotEvent['slotEvent'] != 'freespin' && $spin_types[$k] != 'bonus' && isset($stack[$spin_type]['board'])){
                                $moneyCount = 0;
                                if(isset($stack[$spin_type]['bs_count']) && $stack[$spin_type]['bs_count'] >0){
                                    $moneyCount = $stack[$spin_type]['bs_count'];
                                }
                            }
                    ...
                    if($moneyCount > 0){
                        ...
                        if($currentHill[0] < 10){
                            ...
                            if($currentHill[0] < 5){
                                $currentHill[1] += number_format(1 / ($currentHill[0] * 3 + 5), 3);
                            }else{
                                $currentHill[1] += number_format(1 / ($currentHill[0] * 4 + 1), 3);
                            }
                        }else if($currentHill[0] >= 10){
                            $currentHill[0] = 10;
                            $currentHill[1] = 1.0;
