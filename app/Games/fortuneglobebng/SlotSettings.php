...
namespace VanguardLTE\Games\fortuneglobebng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameFortuneGlobeStack::where('id', 30198)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameFortuneGlobeStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameFortuneGlobeStack::where('spin_type', 0);
                }
