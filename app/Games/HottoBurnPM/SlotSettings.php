...
namespace VanguardLTE\Games\HottoBurnPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[40.00,80.00,120.00,160.00,200.00,400.00,600.00,800.00,1000.00,1500.00,2000.00,4000.00,6000.00,8000.00,10000.00,12500.00,15000.00,17500.00,20000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHottoBurnStack::where('id', 490)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHottoBurnStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
