...
namespace VanguardLTE\Games\PhoenixForgePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,100,500];
            $this->Paytable[4] = [0,0,0,20,80,400];
            $this->Paytable[5] = [0,0,0,15,50,250];
            $this->Paytable[6] = [0,0,0,8,25,100];
            $this->Paytable[7] = [0,0,0,8,25,100];
            $this->Paytable[8] = [0,0,0,3,10,75];
            $this->Paytable[9] = [0,0,0,3,10,75];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGamePhoenixForgeStack::where('id', 44)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGamePhoenixForgeStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
