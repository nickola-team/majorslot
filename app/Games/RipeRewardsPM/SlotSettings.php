<?php 
namespace VanguardLTE\Games\RipeRewardsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameRipeRewardsStack::where('id', 21089)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRipeRewardsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRipeRewardsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
