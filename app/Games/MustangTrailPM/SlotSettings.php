...
namespace VanguardLTE\Games\MustangTrailPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMustangTrailStack::where('id', 448)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMustangTrailStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMustangTrailStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
