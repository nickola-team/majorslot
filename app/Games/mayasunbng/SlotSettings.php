...
namespace VanguardLTE\Games\mayasunbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameMayaSunStack::where('id', 83245)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 65){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMayaSunStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMayaSunStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMayaSunStack::where('spin_type', 0);
                }
