...
namespace VanguardLTE\Games\AfricanElephantPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameAfricanElephantStack::where('id', 20820)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAfricanElephantStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameAfricanElephantStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
