<?php 
namespace VanguardLTE\Games\WingChunCQ9
{
    class Server
    {
        public $winLines = [];
                ...
                if($paramData['req'] == 1){ // init
                    ...
                    for($i = 0; $i < count($gameDatas); $i++){
                        ...
                        if($packet_id == 11){
                            ...
                            $result_val['BGContext'] = [["DO5Sr9HkXIzv65I6bw2PAltmsl68mn840MSdEh8AREfRVWut5pTZg8C+LYG7rfmhGnJ3fLLcz5Vmksp4HcG6QR47Z/NGQsEd06dyygQ0nr15BbHzMJOOMJewT6ZhUIsLpVYbBVWHUlwGSf9gvvWe/4trn11Mu+8thm6iSp2ytDQmgYV7cOdg3vY/0xw=","kTwIQSmKWITwv2Y1b6gKNlT6Vble8BrP/tMi5gYrN4G4eDSGCBJGXj3t3ekOAIeLKXpS5mmDIhQyzHkl8gyqS3dFGRApCjp+8pZElFXpe+1K0DGrAnAbBE+YJOBDJXVQVDukmAgXmMTTIe2tfwQGk5IY9Cs8CUv7mikd/pI1f0IRce19AAQP3RfN22w=","3FhhUrbsasxcc4VgsRgvx/MHOdx14sQbQWq/IBBDZjQemAsTmH6t/GBaLYSbxAGXc+45dtn7LPbriG1pa+Wj+z9BcLd7HbrnoLIi+qzR/fPPNv6efqRiqQdPJBX1H8BIXSpBJ+fan32MD3oJgozSEdgWF9lKoE6kLbSGEA==","zVFvcxe9D7A4otpd+88DNweWV8V5kpQJuKXYJRGaYkOzDfOUy+57dGA+rX4nekr1leCWGpvcfP1PIHwwMI+vB4M0ak4he8PPuZzcGqw7cU/hBj39iYin4qf7nkzun1Gg1GrQV79k9LddBeP45oQW/8HHdCOG/QG/tIM4Cf/HTy77YuMQ2xnvGMKLLccQHAbqMYUMjgS1p1LO0eyK","63c2utZ6K7qapAUFHicErDIX2rQz1QUjLVRWdeTbXfVGWjdCJOid5BWfxIXNpGCsQ4ZQ0fAHaKBesRIERI+BMfCNL3bgD14Lwm0metnhA5uNX4s9RNeScQVdzhxAqyj9EJRnGBh35T8bFqblPLPxDvTdXlKYwdBuLKTVvgKXyDNVpULggxztr32Q/F8="]];
