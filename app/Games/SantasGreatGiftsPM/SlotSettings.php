<?php 
namespace VanguardLTE\Games\SantasGreatGiftsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSantasGreatGiftsStack::where('id', 763)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSantasGreatGiftsStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSantasGreatGiftsStack::where('spin_type', 0);
                }
                ...
                if($winType == 'bonus'){
                    if($pur >= 0){
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameSantasGreatGiftsStack::where('pur_level', $pur);
                    }else{
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameSantasGreatGiftsStack::where('pur_level','<=', 0);
                    }
                }
                if($isLowBank == true){
                    if($winType == 'bonus'){
