<?php 
namespace VanguardLTE\Games\MahjongWinsBonusPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            else if( $slotEvent['slotEvent'] == 'doSpin' ) 
            {
                ...
                $allBet = $betline * $lines;
                if(($slotEvent['slotEvent'] == 'freespin' || ($rs_p == -1 && $rs_t > 0)) && $isState == true && $slotSettings->GetGameData($slotSettings->slotId . 'BuyFreeSpin') >= 0){
                    $allBet = $allBet * $purMuls[$slotSettings->GetGameData($slotSettings->slotId . 'BuyFreeSpin')];
                }
                if($rs_p == -1 && $rs_t > 0 && $isState == true){
