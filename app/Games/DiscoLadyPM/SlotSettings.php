...
namespace VanguardLTE\Games\DiscoLadyPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,75,150,400];
            $this->Paytable[4] = [0,0,0,50,150,300];
            $this->Paytable[5] = [0,0,0,40,100,250];
            $this->Paytable[6] = [0,0,0,30,100,200];
            $this->Paytable[7] = [0,0,0,15,30,125];
            $this->Paytable[8] = [0,0,0,15,30,125];
            $this->Paytable[9] = [0,0,0,10,20,100];
            $this->Paytable[10] = [0,0,0,10,20,100];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameDiscoLadyStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
