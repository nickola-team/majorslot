...
namespace VanguardLTE\Games\TripleDragonsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[40.00,80.00,120.00,160.00,200.00,400.00,600.00,800.00,1000.00,1500.00,2000.00,4000.00,6000.00,8000.00,10000.00,12000.00,14000.00,16000.00,18000.00,20000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSuperJokerStack::where('id', 79764)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameTripleDragonsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
