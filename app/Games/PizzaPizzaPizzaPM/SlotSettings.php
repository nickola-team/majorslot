...
namespace VanguardLTE\Games\PizzaPizzaPizzaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGamePizzaPizzaPizzaStack::where('id', 4242)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePizzaPizzaPizzaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGamePizzaPizzaPizzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
