<?php 
namespace VanguardLTE\Games\FloatingDragonNYFUltraMegawaysHSPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFloatingDragonHoldSpinMegawaysStack::where('id', 20640)->first();
