...
namespace VanguardLTE\Games\kingofheroesbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameKingofHeroesStack::where('id', 400)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameKingofHeroesStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameKingofHeroesStack::where('spin_type', 0);
                }
