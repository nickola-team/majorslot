...
namespace VanguardLTE\Games\GreatRhinoDeluxePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGreatRhinoDeluxeStack::where('id', 256440)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGreatRhinoDeluxeStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
