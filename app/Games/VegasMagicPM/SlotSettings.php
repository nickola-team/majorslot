...
namespace VanguardLTE\Games\VegasMagicPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameVegasMagicStack::where('id', 79764)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameVegasMagicStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
