...
namespace VanguardLTE\Games\FireHot100PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFireHot100Stack::where('id', 284)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireHot100Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
