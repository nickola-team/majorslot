...
namespace VanguardLTE\Games\GatotKacasFuryPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTheHandofMidasStack::where('id', 542)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheHandofMidasStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                    if($pur >= 0){
