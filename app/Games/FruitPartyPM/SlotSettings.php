...
namespace VanguardLTE\Games\FruitPartyPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFrutiPartyStack::where('id', 4365)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFrutiPartyStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFrutiPartyStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
