...
namespace VanguardLTE\Games\SuperXPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,150,400];
            $this->Paytable[4] = [0,0,0,20,80,300];
            $this->Paytable[5] = [0,0,0,15,50,200];
            $this->Paytable[6] = [0,0,0,10,30,100];
            $this->Paytable[7] = [0,0,0,5,15,50];
            $this->Paytable[8] = [0,0,0,2,5,20];
            $this->Paytable[9] = [0,0,0,2,5,20];
            $this->Paytable[10] = [0,0,0,2,5,20];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameSuperXStack::where('id', 1581)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameSuperXStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win'){
                ...
                if($isLowBank == true){
                    ...
                    if($winType == 'bonus'){
                        ...
                        $stacks = $stacks->where('odd', '<=', $limitOdd)->where('pur_level', ($bl - 1))->inRandomOrder()->take(100)->get();
                    }
                }
