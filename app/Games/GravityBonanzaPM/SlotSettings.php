<?php 
namespace VanguardLTE\Games\GravityBonanzaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType='bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGravityBonanzaStack::where([
                //     'id' => 15
                // ])->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGravityBonanzaStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGravityBonanzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
