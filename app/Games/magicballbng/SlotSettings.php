<?php 
namespace VanguardLTE\Games\magicballbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameMagicBallStack::where('id', 29968)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMagicBallStack::where('spin_type',1);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameMagicBallStack::where('spin_type', 0);
                }
