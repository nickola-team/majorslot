...
namespace VanguardLTE\Games\DrillThatGoldPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[7] = [0,0,0,25,50,100];
            $this->Paytable[8] = [0,0,0,20,40,80];
            $this->Paytable[9] = [0,0,0,10,25,50];
            $this->Paytable[10] = [0,0,0,10,20,40];
            $this->Paytable[11] = [0,0,0,10,20,30];
            $this->Paytable[12] = [0,0,0,5,10,25];
            $this->Paytable[13] = [0,0,0,5,10,20];
        ...
        public function GetReelStrips($winType, $bet, $bl=0)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameDrillThatGoldStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                if($winType == 'win'){
