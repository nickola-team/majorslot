...
namespace VanguardLTE\Games\StarPiratesCodePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,60,150];
            $this->Paytable[4] = [0,0,0,12,30,80];
            $this->Paytable[5] = [0,0,0,6,12,30];
            $this->Paytable[6] = [0,0,0,4,10,24];
            $this->Paytable[7] = [0,0,0,2,4,20];
            $this->Paytable[8] = [0,0,0,1,2,12];
            $this->Paytable[9] = [0,0,0,1,2,12];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameStarPiratesCodeStack::where('id', 291)->first();
