...
function ReelGen($rg)
{
    $_obf_0D3B08361E271C090B3302333D04171B03073B0E1A2E11 = explode('reelStrip', file_get_contents(base_path() . '/app/Games/JohnHunterandtheTomboftheScarabQueenPM/reels.txt'));
