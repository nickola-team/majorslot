...
namespace VanguardLTE\Games\DaHongZhongCQ9
{
    class SlotSettings
    {
        ...
        public function getRecommendList(){
            $data = [
                ...
                "hotRankingGameList" => [
                    ...
                    "maxScore"=>"30678",
                    "maxMultiplier"=>222,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/EYSNJNc7.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/bdttzsyr.jpg",
                    "difficulty"=>1],
                    ["type"=>2,
                    "gameCode"=>"76",
                    "maxScore"=>"266768",
                    ...
                    "maxScore"=>"399318",
                    "maxMultiplier"=>400,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/CCUV6GQb.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/Seq2xci1.jpg",
                    "difficulty"=>4],
                    [
                        "type"=>2,
                        "gameCode"=>"127",
                    ...
                    "maxScore"=>"360970",
                    "maxMultiplier"=>248,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/bvDiSUot.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/H4pqiKiZ.jpg",
                    "difficulty"=>2],
                    ["type"=>2,
                    "gameCode"=>"140",
                    "maxScore"=>"399818",
                    ...
                    "maxScore"=>"1875045",
                    "maxMultiplier"=>714,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/ouxlCOaf.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/7hDjaiyn.jpg",
                    "difficulty"=>4]
                ]
            ];
            return $data;
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameDaHongZhongStack::where('id', 32521)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDaHongZhongStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDaHongZhongStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
