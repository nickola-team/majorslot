    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable['2']  = [0,0,0,60,120,600];
            $this->Paytable['3']  = [0,0,0,40,80,400];
            $this->Paytable['4']  = [0,0,0,20,40,200];
            $this->Paytable['5']  = [0,0,0,10,20,100];
            $this->Paytable['11']  = [0,0,0,8,16,80];
            $this->Paytable['12']  = [0,0,0,8,16,80];
            $this->Paytable['13'] = [0,0,0,5,10,50];
            $this->Paytable['14'] = [0,0,0,5,10,50];
            $this->Paytable['15'] = [0,0,0,5,10,50];
            $this->Paytable['16'] = [0,0,0,5,10,50];
            $reel = new GameReel();
            foreach( [
                'reelStrip1', 
                'reelStrip2', 
            ...
            $data = [
                "recommendGameList" => [
                    ...
                    [
                        ...
                        "maxScore"=> "17189863",
                        "maxMultiplier"=> 999,
                        "iconURL"=> "https://images.cq9web.com/cherry/icon/uMhLNEp6.png",
                        "backgroundURL"=> "https://images.cq9web.com/cherry/background/n1ioRev0.jpg"
                    ],
                    [
                        "type"=> 1,
                        "gameCode"=> "154",
                ...
                "hotRankingGameList" => [
                    ...
                    [
                        ...
                        "maxScore"=> "241591",
                        "maxMultiplier"=> 310,
                        "iconURL"=> "https://images.cq9web.com/cherry/icon/8zz928W9.png",
                        "backgroundURL"=> "https://images.cq9web.com/cherry/background/TGabac0s.jpg",
                        "difficulty"=> 5
                    ],
                    [
                        "type"=> 2,
                    ...
                    [
                        ...
                        "maxScore"=> "415157",
                        "maxMultiplier"=> 820,
                        "iconURL"=> "https://images.cq9web.com/cherry/icon/bIUsXGbx.png",
                        "backgroundURL"=> "https://images.cq9web.com/cherry/background/aP13N5fB.jpg",
                        "difficulty"=> 5
                    ],
                    [
                        "type"=> 2,
                        ...
                        "maxScore"=> "812475",
                        "maxMultiplier"=> 463,
                        "iconURL"=> "https://images.cq9web.com/cherry/icon/B7tBS1CK.png",
                        "backgroundURL"=> "https://images.cq9web.com/cherry/background/cbMHB181.jpg",
                        "difficulty"=> 2
                    ],
                    [
                        "type"=> 2,
                    ...
                    [
                        ...
                        "maxScore"=> "302781",
                        "maxMultiplier"=> 463,
                        "iconURL"=> "https://images.cq9web.com/cherry/icon/xaFUUr6v.png",
                        "backgroundURL"=> "https://images.cq9web.com/cherry/background/WWtn9Ml7.jpg",
                        "difficulty"=> 5
                    ]
                ]
            ];
