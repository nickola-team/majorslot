...
namespace VanguardLTE\Games\GreedyWolfPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $bl=0)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGreedyWolfStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGreedyWolfStack::where('spin_type', 0);
                }
