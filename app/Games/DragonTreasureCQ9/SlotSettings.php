...
namespace VanguardLTE\Games\DragonTreasureCQ9
{
    class SlotSettings
    {
        ...
        public function getRecommendList(){
            $data = [
                "recommendGameList" => [
                    ...
                    "maxScore"=>"6071306",
                    "maxMultiplier"=>671,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/wTXE7f95.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/M2YMGaXy.jpg"],
                    ["type"=>1,
                    "gameCode"=>"183",
                    "maxScore"=>"937856",
                    "maxMultiplier"=>1080,
                ...
                "hotRankingGameList" => [
                    ...
                    "maxScore"=>"653915",
                    "maxMultiplier"=>175,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/VGzJfXLS.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/beik3Nk3.jpg",
                    "difficulty"=>1],
                    ["type"=>2,
                    "gameCode"=>"173",
                    "maxScore"=>"6609177",
                    "maxMultiplier"=>735,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/R52AT7g9.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/W83Ldtqf.jpg",
                    "difficulty"=>3],
                    ["type"=>2,
                    "gameCode"=>"79",
                    "maxScore"=>"2240851",
                    ...
                    "maxScore"=>"282774",
                    "maxMultiplier"=>249,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/md8hnuwC.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/pfYFfy4d.jpg",
                    "difficulty"=>2],
                    ["type"=>2,
                    "gameCode"=>"8",
                    "maxScore"=>"3053659",
                    "maxMultiplier"=>804,
                    "iconURL"=>"https://images.cq9web.com/cherry/icon/l2pXvnE2.png",
                    "backgroundURL"=>"https://images.cq9web.com/cherry/background/EC8cj2jl.jpg",
                    "difficulty"=>4],
                    ["type"=>2,
                    "gameCode"=>"10",
                    "maxScore"=>"8723313",
        ...
        {
            // // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonTreasureStack::where('id', 54017)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonTreasureStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDragonTreasureStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
