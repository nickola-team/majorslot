...
namespace VanguardLTE\Games\goldexpressbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameGoldExpressStack::where('id', 214)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 90){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGoldExpressStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGoldExpressStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGoldExpressStack::where('spin_type', 0);
                }
