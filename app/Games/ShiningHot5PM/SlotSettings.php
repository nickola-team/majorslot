...
namespace VanguardLTE\Games\ShiningHot5PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameShiningHot5Stack::where('id', 117)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameShiningHot5Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
