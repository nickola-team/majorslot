    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable[3]  = [0,0,2,20,100,500];
            $this->Paytable[4]  = [0,0,2,20,100,500];
            $this->Paytable[5]  = [0,0,2,15,50,300];
            $this->Paytable[6]  = [0,0,2,15,50,300];
            $this->Paytable[7]  = [0,0,2,10,40,200];
            $this->Paytable[8]  = [0,0,2,10,40,200];
            $this->Paytable[9]  = [0,0,0,5,25,75];
            $this->Paytable[10] = [0,0,0,5,25,75];
        ...
        public function GetMoneyRise($value){
            if(rand(0, 100) < $this->base_money_chance){
                return 13;
            }else{
                return $value;
            }
