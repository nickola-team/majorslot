...
namespace VanguardLTE\Games\WonderLandCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                    // $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameWonderLandStack::where('id', 92416)->first(); 
            ...
            while(true){
                if($selId > -1){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWonderLandStack::where(['spin_type' => 1, 'free_count' => $selId])->whereNotIn('id', $existIds);
                }else if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWonderLandStack::where('spin_type',2)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameWonderLandStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
