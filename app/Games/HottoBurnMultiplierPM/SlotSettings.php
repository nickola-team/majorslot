...
namespace VanguardLTE\Games\HottoBurnMultiplierPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameHottoBrunMultiplierStack::where('id', 89619)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHottoBrunMultiplierStack::where(['spin_type' => $spintype, 'pur_level' => $pur])->whereNotIn('id', $existIds);
