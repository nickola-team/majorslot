...
namespace VanguardLTE\Games\Chicago2CQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameChicago2Stack::where('id', 127193)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameChicago2Stack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameChicago2Stack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
