...
namespace VanguardLTE\Games\VoodooMagicPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,25,100,250];
            $this->Paytable[3] = [0,0,0,20,50,200];
            $this->Paytable[4] = [0,0,0,10,40,100];
            $this->Paytable[5] = [0,0,0,10,30,75];
            $this->Paytable[6] = [0,0,0,10,30,75];
            $this->Paytable[7] = [0,0,0,4,20,50];
            $this->Paytable[8] = [0,0,0,4,20,50];
        ...
        public function GetWildPoses()
        {
            $wildCount = mt_rand(1, 5);
            $wildPoses = $this->GetRandomNumber(0, 19, $wildCount);
            return $wildPoses;
        }
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameVoodooMagicStack::where('id', 214)->first(); //41
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameVoodooMagicStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
