...
namespace VanguardLTE\Games\boomgoldbng
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBoomGoldStack::where('spin_type',1);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBoomGoldStack::where('spin_type', 0);
                }
