...
namespace VanguardLTE\Games\NightCityCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameNightCityStack::where('id', 54075)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameNightCityStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameNightCityStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($pur >= 0){
