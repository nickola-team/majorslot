<?php 
namespace VanguardLTE\Games\ExtraJuicyPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,6,7,8,6,5,6,7,8,6,9,3,4,6,5]);
                ...
                if($stack != null){
                    ...
                    if($str_fslim != ''){
                        $strOtherResponse = $strOtherResponse . '&fslim=' . $str_fslim;
                    }
                    if($gwm > 0){
