...
namespace VanguardLTE\Games\ExtraJuicyPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,40.00,60.00,80.00,100.00,200.00,300.00,500.00,750.00,1000.00,2000.00,3000.00,4000.00,5000.00,6000.00,7000.00,8000.00,9000.00,10000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameExtraJuicyStack::where('id', 864)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameExtraJuicyStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
