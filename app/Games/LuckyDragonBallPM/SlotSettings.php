...
namespace VanguardLTE\Games\LuckyDragonBallPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[6] = [0,0,0,5,10,15];
            $this->Paytable[7] = [0,0,0,4,8,12];
            $this->Paytable[8] = [0,0,0,2,5,10];
            $this->Paytable[9] = [0,0,0,1,3,8];
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameLuckyDragonBallStack::where('id', 63)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameLuckyDragonBallStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
