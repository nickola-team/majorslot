...
namespace VanguardLTE\Games\DiamondStrikePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[15.00,30.00,45.00,60.00,80.00,100.00,200.00,300.00,400.00,500.00,700.00,1000.00,2000.00,3000.00,4000.00,5000.00,6000.00,6500.00]; 
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDiamondStrikeStack::where('id', 328)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameDiamondStrikeStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
