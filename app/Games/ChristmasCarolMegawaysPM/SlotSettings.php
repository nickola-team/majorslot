<?php 
namespace VanguardLTE\Games\ChristmasCarolMegawaysPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $pur, $bet, $ind = -1)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGreatRhinoMegawaysStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
