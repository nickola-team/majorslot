...
namespace VanguardLTE\Games\SmugglersCovePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2] = [0,0,0,100,200,2000];
            $this->Paytable[3] = [0,0,0,100,200,2000];
            $this->Paytable[4] = [0,0,0,50,100,1000];
            $this->Paytable[5] = [0,0,0,20,50,500];
            $this->Paytable[6] = [0,0,0,10,40,200];
            $this->Paytable[7] = [0,0,0,8,20,50];
            $this->Paytable[8] = [0,0,0,8,20,50];
            $this->Paytable[9] = [0,0,0,8,20,50];
            $this->Paytable[10] = [0,0,0,8,20,50];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameSmugglersCoveStack::where('id', 24)->first();
            ...
            while(true){
                if($spintype == 0){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSmugglersCoveStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSmugglersCoveStack::where('spin_type', '>=' , $spintype)->whereNotIn('id', $existIds);
                }
