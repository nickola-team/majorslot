...
namespace VanguardLTE\Games\QueeniePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,100,250];
            $this->Paytable[4] = [0,0,0,15,30,100];
            $this->Paytable[5] = [0,0,0,10,20,75];
            $this->Paytable[6] = [0,0,0,5,15,50];
            $this->Paytable[7] = [0,0,0,5,15,50];
            $this->Paytable[8] = [0,0,0,2,10,25];
            $this->Paytable[9] = [0,0,0,2,10,25];
            $this->Paytable[10] = [0,0,0,2,10,25];
            $this->Paytable[11] = [0,0,0,2,10,25];
            $this->Paytable[12] = [0,0,0,2,10,25];
            $this->Paytable[13] = [0,0,0,2,10,25];
        ...
        public function GetReelStrips($winType, $pur, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenieStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
