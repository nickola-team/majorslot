...
namespace VanguardLTE\Games\CashBonanzaPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,50,100,200];
            $this->Paytable[4] = [0,0,0,6,10,20,50];
            $this->Paytable[5] = [0,0,0,6,10,20,50];
            $this->Paytable[6] = [0,0,0,6,8,16,40];
            $this->Paytable[7] = [0,0,0,4,6,12,20];
            $this->Paytable[8] = [0,0,0,2,4,6,10];
            $this->Paytable[9] = [0,0,0,2,4,6,10];
            $this->Paytable[10] = [0,0,0,1,2,4,8];
            $this->Paytable[11] = [0,0,0,1,2,4,8];
            $this->Paytable[12] = [0,0,0,1,2,4,8];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameCashBonanzaStack::where('id', 11370)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCashBonanzaStack::where('spin_type', '>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCashBonanzaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
