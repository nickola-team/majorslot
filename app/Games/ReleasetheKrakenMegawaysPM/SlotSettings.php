...
namespace VanguardLTE\Games\ReleasetheKrakenMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameReleasetheKrakenMegawaysStack::where('id', 37908)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    if($pur >= 0){
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameReleasetheKrakenMegawaysStack::where('spin_type',1)->where('pur_level',$pur)->whereNotIn('id', $existIds);
                    }else{
                        $stacks = \VanguardLTE\PPGameStackModel\PPGameReleasetheKrakenMegawaysStack::where('spin_type',1)->where('pur_level','<=', 0)->whereNotIn('id', $existIds);
                    }
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameReleasetheKrakenMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
