...
namespace VanguardLTE\Games\SweetKingdomPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSweetKingdomStack::where('id', 1)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSweetKingdomStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
