...
namespace VanguardLTE\Games\hitmoregoldbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameHitMoreGoldStack::where('id', 28453)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] >= 11){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitMoreGoldStack::where('spin_type', 2);
                        $limitBonusOdd = 25;
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitMoreGoldStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameHitMoreGoldStack::where('spin_type', 0);
                }
