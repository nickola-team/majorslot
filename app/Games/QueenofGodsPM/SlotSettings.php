...
namespace VanguardLTE\Games\QueenofGodsPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $ind=-1)
        {
            ...
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where('id', 121)->first();
            ...
            while(true){
                ...
                if($ind > -1){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where(['spin_type' => 1, 'pur_level' => $ind])->whereNotIn('id', $existIds);
                }else if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where('spin_type', 2)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                if($winType == 'win'){
