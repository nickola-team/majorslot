    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $ind=-1)
        {
            ...
            while(true){
                ...
                if($ind > -1){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where(['spin_type' => 1, 'pur_level' => $ind]);
                }else if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where('spin_type', 2);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameQueenofGodsStack::where('spin_type', 0);
                }
                if($winType == 'win'){
            ...
            return json_decode($stacks[$reel_index]->spin_stack, true);
        }
    }
}
