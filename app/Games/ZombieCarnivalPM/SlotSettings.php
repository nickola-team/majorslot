<?php 
namespace VanguardLTE\Games\ZombieCarnivalPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,40,60,100];
            $this->Paytable[4] = [0,0,0,12,20,30,60];
            $this->Paytable[5] = [0,0,0,10,16,24,40];
            $this->Paytable[6] = [0,0,0,8,12,20,30];
            $this->Paytable[7] = [0,0,0,4,6,10,14];
            $this->Paytable[8] = [0,0,0,4,6,10,14];
            $this->Paytable[9] = [0,0,0,4,6,10,14];
            $this->Paytable[10] = [0,0,0,4,6,10,14];
