    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('Sizzling6GTMDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('Sizzling6GTMDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D0934372523393C28340C3F3C3E24123B391333190601 = '';
                    $_obf_0D330428011D24231C3C2F02133007111715310A010B22 = 0;
                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                    {
                        ...
                        {
                            $_obf_0D370B3836012707400E365B061F373B33392B0A383811 = 0;
                            for( $r = 1; $r <= 6; $r++ ) 
                            {
                                $_obf_0D142B27032E0A370E5B1B373B2C27353B3801072F1932 = 0;
                                if( $reels['reel' . $r][0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 ) 
                                {
                                    $_obf_0D142B27032E0A370E5B1B373B2C27353B3801072F1932++;
                                }
                                if( $reels['reel' . $r][1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 ) 
                                {
                                    $_obf_0D142B27032E0A370E5B1B373B2C27353B3801072F1932++;
                                }
                                if( $reels['reel' . $r][2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 ) 
                                {
                                    $_obf_0D142B27032E0A370E5B1B373B2C27353B3801072F1932++;
                                }
                                if( $_obf_0D142B27032E0A370E5B1B373B2C27353B3801072F1932 >= 3 ) 
                                {
                                    $_obf_0D370B3836012707400E365B061F373B33392B0A383811++;
                                }
                            }
                            if( $_obf_0D370B3836012707400E365B061F373B33392B0A383811 == 4 ) 
                            {
                                $_obf_0D330428011D24231C3C2F02133007111715310A010B22 = 40 * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'];
                                $_obf_0D0934372523393C28340C3F3C3E24123B391333190601 = $_obf_0D011C142C3C37263F351C4012170A074027083F321132;
                            }
                            else if( $_obf_0D370B3836012707400E365B061F373B33392B0A383811 == 5 ) 
                            {
                                $_obf_0D330428011D24231C3C2F02133007111715310A010B22 = 100 * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'];
                                $_obf_0D0934372523393C28340C3F3C3E24123B391333190601 = $_obf_0D011C142C3C37263F351C4012170A074027083F321132;
                            }
                            else if( $_obf_0D370B3836012707400E365B061F373B33392B0A383811 == 6 ) 
                            {
                                $_obf_0D330428011D24231C3C2F02133007111715310A010B22 = 1000 * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'];
                                $_obf_0D0934372523393C28340C3F3C3E24123B391333190601 = $_obf_0D011C142C3C37263F351C4012170A074027083F321132;
                            }
                        }
                    }
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('Sizzling6GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"],"winReel6":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    else if( in_array($s[0], $wild) || in_array($s[1], $wild) ) 
                                    {
                                        ...
                                        for( $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522 = 0; $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522 < 2; $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522++ ) 
                                        {
                                            ...
                                            {
                                                $s[$_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522] = $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '_WILD';
                                            }
                                        }
                                    }
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('Sizzling6GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"],"winReel6":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('Sizzling6GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"],"winReel6":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('Sizzling6GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"],"winReel6":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) && ($s[5] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[5], $wild)) ) 
                                {
                                    ...
                                    {
                                        $mpl = $slotSettings->slotWildMpl;
                                        for( $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522 = 0; $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522 < 6; $_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522++ ) 
                                        {
                                            if( in_array($s[$_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522], $wild) ) 
                                            {
                                                $s[$_obf_0D0C021818145B101222043F3C051C231B1C5B231A3522] = $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '_WILD';
                    ...
                    $totalWin += $_obf_0D330428011D24231C3C2F02133007111715310A010B22;
                    if( $i > 1000 ) 
                    {
                        $winType = 'none';
                    }
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('Sizzling6GTMFreeGames') <= $slotSettings->GetGameData('Sizzling6GTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('Sizzling6GTMTotalWin') + $totalWin > 0 ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"symBonusRows":' . $_obf_0D370B3836012707400E365B061F373B33392B0A383811 . ',"symBonusId":"' . $_obf_0D0934372523393C28340C3F3C3E24123B391333190601 . '","totalFreeGames":' . $slotSettings->GetGameData('Sizzling6GTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Sizzling6GTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
