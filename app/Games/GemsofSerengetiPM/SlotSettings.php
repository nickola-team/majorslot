...
namespace VanguardLTE\Games\GemsofSerengetiPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGemsofSerengetiStack::where('id', 460)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGemsofSerengetiStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGemsofSerengetiStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
