<?php 
namespace VanguardLTE\Games\GemsofSerengetiPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,9,7,3,11,3,8,10,6,12,4,9,5,5,11,3,8,10,6,4]);
                ...
                if(isset($stack)){
                    ...
                    if($g != null){
                        ...
                        $strOtherResponse = $strOtherResponse . '&g={hr:{def_s:"13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13",def_sa:"13,13,13,13,13",def_sb:"13,13,13,13,13",s:"13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13,13",sa:"13,13,13,13,13",sb:"13,13,13,13,13",sh:"4",st:"rect",sw:"5"}}';
                    }
                    if($rs_p >= 0){
            ...
            else if( $slotEvent['slotEvent'] == 'doSpin' ) 
            {
                ...
                $response = 'tw='.$slotSettings->GetGameData($slotSettings->slotId . 'TotalWin') . $strOtherResponse  .'&balance='.$Balance. '&index='.$slotEvent['index'].'&balance_cash='.$Balance . '&reel_set='. $currentReelSet.'&balance_bonus=0.00&na='.$spinType .'&stime=' . floor(microtime(true) * 1000) .'&sa='.$strReelSa.'&sb='.$strReelSb.'&sh=4&st=rect&c='.$betline.'&sw=5&sver=5&counter='. ((int)$slotEvent['counter'] + 1) .'&l=20&w='.$totalWin.'&s=' . $strLastReel;
                ...
                if( $slotEvent['slotEvent'] != 'freespin' && $scatterCount >= 3 && $rs_p < 0) 
                {
                    $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $Balance);
                    $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', 0);
