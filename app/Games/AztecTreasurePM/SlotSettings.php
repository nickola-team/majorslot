...
namespace VanguardLTE\Games\AztecTreasurePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,15,30,80];
            $this->Paytable[4] = [0,0,0,12,25,50];
            $this->Paytable[5] = [0,0,0,10,15,30];
            $this->Paytable[6] = [0,0,0,8,12,20];
            $this->Paytable[7] = [0,0,0,8,12,20];
            $this->Paytable[8] = [0,0,0,5,10,15];
            $this->Paytable[9] = [0,0,0,5,8,10];
            $this->Paytable[10] = [0,0,0,5,8,10];
            $this->Paytable[11] = [0,0,0,4,6,8];
            $this->Paytable[12] = [0,0,0,4,6,8];
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameAztecTreasureStack::where('id', $index)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameAztecTreasureStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
