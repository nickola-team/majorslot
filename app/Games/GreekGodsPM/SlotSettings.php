...
namespace VanguardLTE\Games\GreekGodsPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,25,60,150];
            $this->Paytable[4] = [0,0,0,20,50,125];
            $this->Paytable[5] = [0,0,0,10,40,100];
            $this->Paytable[6] = [0,0,0,10,30,75];
            $this->Paytable[7] = [0,0,0,5,25,50];
        ...
        {
            // if($winType == 'win'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGreekGodsStack::where('id', 329)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameGreekGodsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
