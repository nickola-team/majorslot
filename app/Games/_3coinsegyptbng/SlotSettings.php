...
namespace VanguardLTE\Games\_3coinsegyptbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGame3CoinsEgyptStack::where('id', 730)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame3CoinsEgyptStack::where('spin_type','>', 0);
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGame3CoinsEgyptStack::where('spin_type', 0);
                }
