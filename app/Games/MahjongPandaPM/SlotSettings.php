...
namespace VanguardLTE\Games\MahjongPandaPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMahjongPandaStack::where('id', 367)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMahjongPandaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMahjongPandaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
