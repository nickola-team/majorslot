<?php 
namespace VanguardLTE\Games\MahjongPandaPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,6,8,4,8,4,7,9,5,6,5,7,3,4,10,5,6,8,4,8]);
                ...
                if(isset($stack)){
                    ...
                    if($arr_g != null){
                        ...
                        $strOtherResponse = $strOtherResponse . '&g={gp:{def_s:"12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12",def_sa:"12,12,12",def_sb:"12,12,12",s:"12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12",sa:"12,12,12",sb:"12,12,12",sh:"8",st:"rect",sw:"3"}}';
                    }
                    if($wmv > 0){
            ...
            else if( $slotEvent['slotEvent'] == 'doSpin' ) 
            {
                ...
                if( $slotEvent['slotEvent'] != 'freespin' && (($fsmax > 0 && $rs_t < 0) || $rs_p == 0)) 
                {
                    $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $Balance);
                    $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', 0);
