    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('BookOfRaDXGTMDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('BookOfRaDXGTMDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                            ...
                            else
                            {
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[3] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[3] == $wild) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[4] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        {
                            $_obf_0D3B25141A3707351101395B1401101E14350230245B32 += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$_obf_0D3B19361C2204101D1F22131632173F173F1F015B1232] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet']);
                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"lineWin":' . ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$_obf_0D3B19361C2204101D1F22131632173F173F1F015B1232] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet']) . ',"Count":' . $_obf_0D3B19361C2204101D1F22131632173F173F1F015B1232 . ',"Line":' . $_obf_0D1E340731210536212805021B3821390D091423131A22 . ',"Win":' . $_obf_0D3B25141A3707351101395B1401101E14350230245B32 . ',"stepWin":' . ($_obf_0D3B25141A3707351101395B1401101E14350230245B32 + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin'));
                            for( $e = 1; $e <= 5; $e++ ) 
                            {
                                if( $_obf_0D33353D1E1E1808210F2A400F0C1C09342A25070F1811[$e] ) 
                                {
                                    $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 .= (',"winReel' . $e . '":[' . ($linesId[$_obf_0D1E340731210536212805021B3821390D091423131A22][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') . '"]');
                                }
                                else
                                {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') <= $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfRaDXGTMTotalWin') + $totalWin > 0 ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',' . $_obf_0D2F0724252F0C3F2B162C3D2D2513193C2C2D35242122 . ',"expPay":' . $_obf_0D3B25141A3707351101395B1401101E14350230245B32 . ',' . $_obf_0D1637152133161D0336012D2801251019232D32283F11 . ',' . $expSymbol . '"totalFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
