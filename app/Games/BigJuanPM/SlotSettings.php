...
namespace VanguardLTE\Games\BigJuanPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameBigJuanStack::where('id', 241)->first();
