<?php 
namespace VanguardLTE\Games\bigheistbng
{
    class Server
    {
            ...
            if($slotEvent['command'] == 'login'){
                ...
                $objRes = [
                    ...
                    'context' => [
                        ...
                        'spins' => [
                            'bet_per_line' => $bets[5],
                            'board' => [[6, 3, 11], [8, 1, 6], [1, 11, 4], [11, 1, 7], [10, 2, 11]],
                            'bs_v' => [[3 * $bets[5] * $LINES, 0, 0], [0, 0, 4 * $bets[5] * $LINES], [0, 0, 0], [0, 0, 0], [0, 0, 0]],
                            'bs_values' => [[3, 0, 0], [0, 0, 4], [0, 0, 0], [0, 0, 0], [0, 0, 0]],
                            'lines' => $LINES,
                        ...
                        $objRes = [
                            ...
                            'context' => [
                                ...
                                'spins' => [
                                    ...
                                    'board' => [[6, 3, 11], [8, 1, 6], [1, 11, 4], [11, 1, 7], [10, 2, 11]],
                                    'bs_v' => [[3 * $betline * $DENOMINATOR * $LINES, 0, 0], [0, 0, 4 * $betline * $DENOMINATOR * $LINES], [0, 0, 0], [0, 0, 0], [0, 0, 0]],
                                    'bs_values' => [[3, 0, 0], [0, 0, 4], [0, 0, 0], [0, 0, 0], [0, 0, 0]],
                                    'lines' => $LINES,
