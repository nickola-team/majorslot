...
namespace VanguardLTE\Games\FireArcherPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFireArcherStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFireArcherStack::where('spin_type', 0);
                }
