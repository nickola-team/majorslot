...
namespace VanguardLTE\Games\JasmineDreamsPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameJasmineDreamsStack::where('id', 121497)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJasmineDreamsStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameJasmineDreamsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
