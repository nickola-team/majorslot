<?php 
namespace VanguardLTE\Games\JasmineDreamsPM
{
    class Server
    {
        public $winLines = [];
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            { 
                ...
                $slotSettings->setGameData($slotSettings->slotId . 'LastReel', [5,10,4,6,9,3,9,6,3,10,5,8,8,4,7]);
