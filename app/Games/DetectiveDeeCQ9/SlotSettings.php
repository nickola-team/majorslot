...
namespace VanguardLTE\Games\DetectiveDeeCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameDetectiveDeeStack::where('id', 57608)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDetectiveDeeStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameDetectiveDeeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                $index = 0;// mt_rand(0, 58000);
                if($winType == 'win'){
