...
namespace VanguardLTE\Games\greenchillibng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameGreenChilliStack::where('id', 21268)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    if($currentHill[0] * 10 + $currentHill[1] >= 55){
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGreenChilliStack::where('spin_type', 2);
                    }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGreenChilliStack::where('spin_type','>', 0);
                    }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameGreenChilliStack::where('spin_type', 0);
                }
