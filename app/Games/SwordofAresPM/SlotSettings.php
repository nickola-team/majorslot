...
namespace VanguardLTE\Games\SwordofAresPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSwordofAresStack::where('id', 31)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameSwordofAresStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
