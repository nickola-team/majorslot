...
namespace VanguardLTE\Games\VegasNightsPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameVegasNightsStack::where('id', 471)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameVegasNightsStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
