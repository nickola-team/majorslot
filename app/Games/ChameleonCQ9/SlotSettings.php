...
namespace VanguardLTE\Games\ChameleonCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameChameleonStack::where('id', 6144)->first(); //1852 : normal,19713 : free
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameChameleonStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameChameleonStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
