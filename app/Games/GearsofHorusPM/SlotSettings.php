<?php 
namespace VanguardLTE\Games\GearsofHorusPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameGearsofHorusStack::where('id', 27872)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGearsofHorusStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameGearsofHorusStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
