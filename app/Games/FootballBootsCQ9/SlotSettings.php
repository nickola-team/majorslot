...
namespace VanguardLTE\Games\FootballBootsCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameFootballBootsStack::where('id', 14760)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFootballBootsStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameFootballBootsStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
                $index = 0;
