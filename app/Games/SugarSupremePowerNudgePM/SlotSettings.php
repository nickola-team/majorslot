...
namespace VanguardLTE\Games\SugarSupremePowerNudgePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSugarSupremePowerNudgeStack::where('id', 22218)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSugarSupremePowerNudgeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSugarSupremePowerNudgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
