...
namespace VanguardLTE\Games\LordGaneshaCQ9
{
    class SlotSettings
    {
        ...
        {
            // // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameLordGaneshaStack::where('id', 119120)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLordGaneshaStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameLordGaneshaStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
