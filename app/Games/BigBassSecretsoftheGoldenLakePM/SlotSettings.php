...
namespace VanguardLTE\Games\BigBassSecretsoftheGoldenLakePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameBigBassSecretsoftheGoldenLakeStack::where('id', 13100)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassSecretsoftheGoldenLakeStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                    if($pur >= 0){
