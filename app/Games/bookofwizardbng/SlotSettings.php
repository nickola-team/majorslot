...
namespace VanguardLTE\Games\bookofwizardbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameBookofWizardStack::where('id', 15196)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameBookofWizardStack::where('spin_type',1);
                }else{
