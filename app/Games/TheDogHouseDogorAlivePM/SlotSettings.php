...
namespace VanguardLTE\Games\TheDogHouseDogorAlivePM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseDogorAliveStack::where('id', 13425)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseDogorAliveStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheDogHouseDogorAliveStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
