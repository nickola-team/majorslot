...
namespace VanguardLTE\Games\TreasureHorsePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[10.00,20.00,30.00,40.00,50.00,100.00,150.00,200.00,250.00,400.00,500.00,750.00,1500.00,2500.00,4250.00,6000.00]; 
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTreasureHorseStack::where('id', 432)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameTreasureHorseStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
