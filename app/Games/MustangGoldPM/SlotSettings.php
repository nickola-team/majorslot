    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            // if($winType == 'bonus' && $ind == -1){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameMustangGoldStack::where('id', 186802)->first();
            ...
            while(true){
                ...
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameMustangGoldStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
