    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->Paytable[3]  = [0,0,0,10,50,500];
            $this->Paytable[4]  = [0,0,0,10,50,300];
            $this->Paytable[5]  = [0,0,0,10,25,250];
            $this->Paytable[6]  = [0,0,0,10,25,250];
            $this->Paytable[7]  = [0,0,0,5,15,100];
            $this->Paytable[8]  = [0,0,0,5,15,100];
            $this->Paytable[9]  = [0,0,0,5,15,100];
            $this->Paytable[10] = [0,0,0,5,15,100];
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState, $isState = true)
        {
            ...
            {
                $_obf_slotstate = $this->slotId . ' Jackpot';
            }
            $game = $this->game;
