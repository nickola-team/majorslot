...
namespace VanguardLTE\Games\BigBassBonanzaMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,40,100,200,500,1000];
            $this->Paytable[4] = [0,0,0,20,40,50,150];
            $this->Paytable[5] = [0,0,0,5,20,30,40];
            $this->Paytable[6] = [0,0,0,5,10,15,40];
            $this->Paytable[7] = [0,0,0,4,8,12,35];
            $this->Paytable[8] = [0,0,0,4,8,12,35];
            $this->Paytable[9] = [0,0,0,4,5,12,20];
            $this->Paytable[10] = [0,0,0,3,5,10,20];
            $this->Paytable[11] = [0,0,0,3,5,10,18];
            $this->Paytable[12] = [0,0,0,2,4,8,16];
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassBonanzaMegawaysStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameBigBassBonanzaMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
