...
namespace VanguardLTE\Games\FuryofOdinMegawaysPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet)
        {
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFuryofOdinMegawaysStack::where('spin_type', 1);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameFuryofOdinMegawaysStack::where('spin_type', 0);
                }
