<?php 
namespace VanguardLTE\Games\TheMoneyMenMegawaysPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameTheMoneyMenMegawaysStack::where('id', 44)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheMoneyMenMegawaysStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameTheMoneyMenMegawaysStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
