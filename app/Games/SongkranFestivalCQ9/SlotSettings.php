...
namespace VanguardLTE\Games\SongkranFestivalCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //   $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameSongkranFestivalStack::where('id', 49559)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSongkranFestivalStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameSongkranFestivalStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
