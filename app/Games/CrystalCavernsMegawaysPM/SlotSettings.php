<?php 
namespace VanguardLTE\Games\CrystalCavernsMegawaysPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,20,40,100,500];
            $this->Paytable[4] = [0,0,0,14,24,50,100];
            $this->Paytable[5] = [0,0,0,12,16,30,50];
            $this->Paytable[6] = [0,0,0,10,14,24,40];
            $this->Paytable[7] = [0,0,0,8,12,20,30];
            $this->Paytable[8] = [0,0,0,6,10,14,20];
            $this->Paytable[9] = [0,0,0,6,8,12,18];
            $this->Paytable[10] = [0,0,0,6,8,10,16];
            $this->Paytable[11] = [0,0,0,4,6,8,12];
            $this->Paytable[12] = [0,0,0,4,6,8,10];
        ...
        public function GetReelStrips($winType, $pur, $bet)
        {
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameCrystalCavernsMegawaysStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
