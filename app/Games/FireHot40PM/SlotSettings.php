...
namespace VanguardLTE\Games\FireHot40PM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameFireHot40Stack::where('id', 429)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameFireHot40Stack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
