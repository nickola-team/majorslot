...
namespace VanguardLTE\Games\DuoFuDuoCaiDancingDrum
{
    class SlotSettings
    {
        ...
        public function getFreeSpinStack($freeSpinType, $freeSpinOdd){
            $freeStacks = \VanguardLTE\GameFreeSpinDD::where([
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if($slotEvent=='freespin'){
                ...
                else
                {
                    ...
                    $scattercount = 5;// $this->GenerateFreeSpinCount($slotEvent);
