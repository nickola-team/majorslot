...
namespace VanguardLTE\Games\DragonHeroPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameDragonHeroStack::where('id', 110)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameDragonHeroStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
