        ...
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('SilkRoadATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('SilkRoadATMpl') . ',"xWin":[' . implode(',', $_obf_0D1429360F31270405361919301D27322535111C390B32) . '],"add":0,"total":' . $slotSettings->GetGameData('SilkRoadATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('SilkRoadATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('SilkRoadATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('SilkRoadATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('SilkRoadATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('SilkRoadATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('SilkRoadATFreeGames') . ',"xWin":[' . implode(',', $_obf_0D1429360F31270405361919301D27322535111C390B32) . '],"totalWin":' . ($slotSettings->GetGameData('SilkRoadATBonusWin') * 100) . '';
                    }
                    else
                    {
                ...
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('SilkRoadATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('SilkRoadATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('SilkRoadATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":{},"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                $_obf_0D1D385C3B2E29221F233F3E3D09295B0F1B0D063B3222 = [];
                for( $i = 1; $i <= 5; $i++ ) 
                {
