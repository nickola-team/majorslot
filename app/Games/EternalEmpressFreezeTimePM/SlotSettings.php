<?php 
namespace VanguardLTE\Games\EternalEmpressFreezeTimePM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameEternalEmpressFreezeTimeStack::where('id', 12892)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameEternalEmpressFreezeTimeStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                    if($pur >= 0){
                    ...
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameEternalEmpressFreezeTimeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
