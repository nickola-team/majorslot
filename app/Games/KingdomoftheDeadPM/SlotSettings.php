...
namespace VanguardLTE\Games\KingdomoftheDeadPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameKingdomoftheDeadStack::where('id', 13186)->first();
            ...
            while(true){
                if($ind >= 0){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameKingdomoftheDeadStack::where('spin_type', 1)->where('pur_level', $ind)->whereNotIn('id', $existIds);
                }else if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameKingdomoftheDeadStack::where('spin_type', 2)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameKingdomoftheDeadStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
