...
namespace VanguardLTE\Games\RiseofGizaPowerNudgePM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[3] = [0,0,0,10,40,120];
            $this->Paytable[4] = [0,0,0,9,30,100];
            $this->Paytable[5] = [0,0,0,6,20,70];
            $this->Paytable[6] = [0,0,0,5,15,50];
            $this->Paytable[7] = [0,0,0,3,8,25];
            $this->Paytable[8] = [0,0,0,2,5,15];
            $this->Paytable[9] = [0,0,0,1,3,10];
            ...
            $this->Line = [1];
            $this->Bet = explode(',', $game->bet); //[20.00,30.00,50.00,100.00,150.00,200.00,500.00,1000.00,2000.00,4000.00,5000.00,6000.00,8000.00,9000.00,10000.00]; 
        ...
        {
            // if($winType == 'bonus'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameRiseofGizaPowerNudgeStack::where('id', 20907)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRiseofGizaPowerNudgeStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameRiseofGizaPowerNudgeStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
