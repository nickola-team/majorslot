...
namespace VanguardLTE\Games\ReelBanksPM
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameReelBanksStack::where('id', 4)->first();
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameReelBanksStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
