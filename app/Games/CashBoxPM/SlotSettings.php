...
namespace VanguardLTE\Games\CashBoxPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameCashBoxStack::where('id', 3)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameCashBoxStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
