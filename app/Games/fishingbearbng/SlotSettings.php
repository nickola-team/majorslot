...
namespace VanguardLTE\Games\fishingbearbng
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                // $stack = \VanguardLTE\BNGGameStackModel\BNGGameFishingBearStack::where('id', 10046)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    ...
                    //     $stacks = \VanguardLTE\BNGGameStackModel\BNGGameFishingBearStack::where('spin_type', 2);
                    // }else{
                        $stacks = \VanguardLTE\BNGGameStackModel\BNGGameFishingBearStack::where('spin_type','>', 0)->where('pur_level', $pur);
                    // }
                }else{
                    $stacks = \VanguardLTE\BNGGameStackModel\BNGGameFishingBearStack::where('spin_type', 0);
                }
