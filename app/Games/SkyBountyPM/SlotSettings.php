<?php 
namespace VanguardLTE\Games\SkyBountyPM
{
    class SlotSettings
    {
        ...
        {
            // if($fsmax > 0){
                // $stack = \VanguardLTE\PPGameStackModel\PPGameSkyBountyStack::where('id', 33390)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\PPGameStackModel\PPGameSkyBountyStack::where('spin_type', 1)->whereNotIn('id', $existIds);
                }else{
