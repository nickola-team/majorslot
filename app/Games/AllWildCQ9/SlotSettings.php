...
namespace VanguardLTE\Games\AllWildCQ9
{
    class SlotSettings
    {
        ...
        {
            // if($winType == 'bonus'){
                //  $stack = \VanguardLTE\CQ9GameStackModel\CQ9GameAllWildStack::where('id', 133908)->first();
            ...
            while(true){
                if($winType == 'bonus'){
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameAllWildStack::where('spin_type','>', 0)->whereNotIn('id', $existIds);
                }else{
                    $stacks = \VanguardLTE\CQ9GameStackModel\CQ9GameAllWildStack::where('spin_type', 0)->whereNotIn('id', $existIds);
                }
