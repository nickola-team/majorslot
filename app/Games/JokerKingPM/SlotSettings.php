...
namespace VanguardLTE\Games\JokerKingPM
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->Paytable[2]  = [0,0,0,10,15,40,125];
            $this->Paytable[3]  = [0,0,0,10,15,40,125];
            $this->Paytable[4]  = [0,0,0,8,15,40,125];
            $this->Paytable[5]  = [0,0,0,6,12,25,50];
            $this->Paytable[6]  = [0,0,0,5,10,15,40];
            $this->Paytable[7]  = [0,0,0,4,8,12,30];
            $this->Paytable[8]  = [0,0,0,3,5,10,25];
            $this->Paytable[9]  = [0,0,0,0,0,0,0];
            $this->Paytable[10] = [0,0,0,0,0,0,0];
            $this->Paytable[11] = [0,0,0,0,0,0,0];
        ...
        {
            // if($winType == 'win'){
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameJokerKingStack::where('id', 145)->first();
            ...
            while(true){
                ...
                $stacks = \VanguardLTE\PPGameStackModel\PPGameJokerKingStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
