        ...
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D5C3831071A3610163227012704053C131A110B2E3122 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigBenATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigBenATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('BigBenATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigBenATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('BigBenATTotalWin', $totalWin);
