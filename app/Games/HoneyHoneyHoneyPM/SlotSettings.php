...
namespace VanguardLTE\Games\HoneyHoneyHoneyPM
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $bet, $ind=-1)
        {
            ...
            //         $index = 325;
            //     }
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameHoneyHoneyHoneyStack::where('id', $index)->first();
            //     return json_decode($stack->spin_stack, true);
            // }else{
            //     $stack = \VanguardLTE\PPGameStackModel\PPGameHoneyHoneyHoneyStack::where('id', 489)->first();
            //     return json_decode($stack->spin_stack, true);
            // }
            $spintype = 0;
            if($winType == 'bonus'){
            ...
            while(true){
                $stacks = \VanguardLTE\PPGameStackModel\PPGameHoneyHoneyHoneyStack::where('spin_type', $spintype)->whereNotIn('id', $existIds);
